...
//** Debut select de la production
    $sql = "SELECT * FROM `fichecranteuseq1` ORDER BY `idfichecranteuseq1` DESC";
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($cranteuseq1['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                    ...
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($cranteuseq1['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $cranteuseq1['machine'] ?>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($cranteuseq1['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $cranteuseq1['user'] ?>
