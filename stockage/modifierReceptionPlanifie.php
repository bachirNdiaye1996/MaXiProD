...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['modifierReception'])){
            ...
            if($dateplanifie == ""){
                $sql = "UPDATE `matiereplanifie` SET `referenceusine` = '$referenceusine',`epaisseur` = '$epaisseur',`lieutransfert` = '$lieutransfert',`poidsdeclare` = '$poidsdeclare'
                ...
                $sql = "UPDATE `matiereplanifie` SET `referenceusine` = '$referenceusine',`epaisseur` = '$epaisseur',`lieutransfert` = '$lieutransfert',`poidsdeclare` = '$poidsdeclare'
                , `idbobine` = '$idbobine', `nbbobine` = '$nbbobine', `dateplanifie`= '$dateplanifie' WHERE `idmatiereplanifie` = ?;";
                //$result = $db->query($sql); 
                $sth = $db->prepare($sql);    
                $sth->execute(array($id));
            }
