                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="col-lg-12 mr-5">
                        <ul class="row list-group-horizontal mt-4 ml-5">
                            <li class="list-group mr-4"><a href="productivite.php" class="list-group-item list-group-item-action active" aria-current="true">CRANTEUSE</a></li>
                            <li class="list-group mr-4"><a href="tempsArrets.php" class="list-group-item list-group-item-action">DRESSEUSE</a></li>
                            <li class="list-group mr-4"><a href="tempsArrets.php" class="list-group-item list-group-item-action">TREFILAGE</a></li>
                        </ul>
                    </div>
