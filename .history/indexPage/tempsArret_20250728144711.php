                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3 mb-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){ ?>Temps d'arret de la machine <code><?= $FichesMachine['machine'] ?></code>  du <?= $FichesMachine['dateCreation'] ?> enregistré par <?= $FichesMachine['user'] ?> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                            <div class="row m-2">
