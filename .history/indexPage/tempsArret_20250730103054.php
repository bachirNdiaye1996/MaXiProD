                        ...
                        <?php  if($FichesMachineID[1]){ ?>
                            <div class="card position-relative mt-5">
                                ...
                                <div class="card-footer py-3 mt-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Temps d'arret total =  <code class="h4"><?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?></code> fait par les opérateurs : <span class="h4"><?= $FichesMachineDetails[1]['controleur1'] ?></span> et <span class="h4"><?= $FichesMachine['controleur2'] ?></span> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                                </div>
                            </div>
                        <?php  } ?>
                    </div>
