<?php
    ...
    if(isset($_POST['CreerUtilisateur'])){
        ...
        if(!empty($_POST['username']) && !empty($_POST['email']) && !empty($_POST['nomcomplet']) && !empty($_POST['niveau']) && !empty($_POST['matricule']) && !empty($_POST['section'])){
            ...
            //$messageD=$_SESSION['nomcomplet']." vient de creer votre compte pour l'application de gestion des demandes de piéces avec comme nom d'utilisateur : $matricule et mot de passe : $_POST[password] ".' Merci! <a href="http://10.10.10.127:8082/GestionDemandePiece">Cliquez ici pour y acceder.</a>';
            $messageD = "
            <html>
            <head>
            ...
            <body>
                <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                    <p align='center'>
                        ...
                        <h3 align='center' style='margin-top:20px'>METAL AFRIQUE</h3>
                    
                        <p align='center'>$_SESSION[nomcomplet] a créé votre compte pour l'application de gestion de production de Metal Afrique :</p>
                        <p align='center'>Nom d'utilisateur : <strong> $username </strong></p>
                        <p align='center'>Mot de passe : <strong>Passer@123</strong></p>
                        <p align='center'>Nous vous conseillons de les modifier aprés votre premiére connexion.</p>
                        <p align='center'><a href='http://10.10.10.127:8082/GestionProduction'>Cliquez ici pour y acceder.</a></p>
                    </p>
                    <br>
                </div>
            </body>
            ...
            envoie_mail($nomcomplet,$email,'Nouveau compte',$messageD);
                //}
            //}
