            ...
            <body>
                <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                    <p align='center'>
                        ...
                        <p align='center'>$_SESSION[nomcomplet] a créé votre compte pour l'application de gestion des demandes de piéces avec comme :</p>
                        <p align='center'>Nom d'utilisateur : <strong> $matricule </strong></p>
                        <p align='center'>Mot de passe : <strong>$_POST[password]</strong></p>
                        <p align='center'>Vous pouvez les modifier apres votre premiere connexion.</p>
