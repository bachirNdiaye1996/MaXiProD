            ...
            <body>
                <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                    <p align='center'>
                        ...
                        <h3 align='center' style='margin-top:20px; color:white'>METAL AFRIQUE</h3>
                        ...
                        <p align='center' style='color:white'>Nous vous conseillons de les modifier aprés votre premiére connexion.</p>
                        <p align='center' style='color:white'><a href='http://10.10.10.127:8082/GestionProduction'>Cliquez ici pour y acceder.</a></p>
                    </p>
                    <br>
                </div>
            </body>
