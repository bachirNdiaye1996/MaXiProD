                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                            <div class="modal-content">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body">
                                        <img src="../image/avatar.jpg" class="img-fluid mx-auto d-block" alt="" style="border-radius: 45%; margin-top:-3%; opacity: 0.9;" width="150">
                                        <h5 class="card-title mt-2 mb-5"><?php echo $_SESSION['nomcomplet']; ?></h5>
                                        
                                        <p class="card-text"><i class="fas fa-mail-bulk mr-5"></i><?php echo $_SESSION['email']; ?></p>
