<?php   
    ...
    //Recherche une fiche
        ...
        //** Debut select des production (Poids,...)
            $sql = "SELECT SUM(prodpoids) as prodpoids, idfichecranteuseq1 as idfichecranteuseq1 FROM `dresseuseproduction` WHERE `actif`=1 AND MONTH(`dateCreation`)='$dtm' GROUP BY `idfichecranteuseq1`;";          
