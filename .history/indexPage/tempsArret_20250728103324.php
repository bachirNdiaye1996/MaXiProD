<?php   
    ...
    if($_SERVER["REQUEST_METHOD"]=='POST'){
        ...
        if(isset($_POST['ChercheTempsArret'])){
            ...
            $dateFicheR = explode("-", $dateFiche);
            $dtm = $dateFicheR[1]; // On extrait le mois courant.

            //** Debut select des temps
                $sql = "SELECT * FROM `$machine` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dtm;";          // On tire les fiches du mois courant
        ...
        $dt = time();
        $dtm = date( "y:m:d", $dt );  // On extrait le mois courant.
                                    ...
                                    <div class="col-md-2 mt-3">
                                        <div class="mb-1 text-start">
                                            <select class="form-control" name="machine">
                                                <option value="cranteuseq1arret">Cranteuse</option>
                                                <option value="dresseusearret">Dresseuse</option>
                                            </select>                                                
                                        </div>
                                    </div>
