                ...
                <li class="nav-item <?php if($_SESSION['niveau'] == 'chefquart'){ echo 'active'; }?>">
                    ...
                    <div id="collapseUtilities" class="collapse <?php if($_SESSION['niveau'] == 'chefquart'){ echo 'show'; }?>" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item <?php if(isset($activeQ)){echo $activeQ;} ?>" href="../Production/Cranteuse/ficheCranteuse.php">Fiches Productions</a>
                            <a class="collapse-item <?php if(isset($activeEtatProduction)){echo $activeEtatProduction;} ?>" href="../Production/Cranteuse/etatProduction.php">Etats Productions</a>
                            <a class="collapse-item <?php if(isset($historique)){echo $historique;} ?>" href="../Production/Cranteuse/historiqueCranteuse.php">Historiques</a>
                        </div>
                    </div>
                </li>
