                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3 mb-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){ ?>Temps d'arret de la machine <code class="h4"><?= $FichesMachine['machine'] ?></code>  du <code class="h4"><?= date_format($FichesMachine['dateCreation'], 'd-m-Y') ?></code> enregistré par <?= $FichesMachine['user'] ?> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                            <div class="row m-2">
                            ...
                            <div class="card-footer py-3 mt-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){?>Temps d'arret total =  <code class="h4"><?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?></code> fait par <?= $FichesMachine['controleur1'] ?> et <?= $FichesMachine['controleur2'] ?> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                        </div>
