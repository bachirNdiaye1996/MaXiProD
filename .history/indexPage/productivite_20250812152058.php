    ...
    //Recherche une fiche
        if(isset($_POST['ChercheTempsArret'])){
            ...
            //** Debut select des temps d'arret (duree,...)
                $sql = "SELECT SUM(duree) as duree, idfichecranteuseq1 as idfichecranteuseq1 FROM `cranteuseq1arret` WHERE `actif`=1 AND MONTH(`dateCreation`)='$dateFiche' GROUP BY `idfichecranteuseq1`;";          
        ...
        //** Debut select des temps d'arret (duree,...)
            $sql = "SELECT SUM(duree) as duree, idfichecranteuseq1 as idfichecranteuseq1 FROM `cranteuseq1arret` WHERE `actif`=1 AND MONTH(`dateCreation`)='$dtm' GROUP BY `idfichecranteuseq1`;";          
