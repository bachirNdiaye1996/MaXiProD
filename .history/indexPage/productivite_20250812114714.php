        ...
        foreach($idFichesCranteuses as $idFichesCranteuse){
            ...
            foreach($CrantTempsArret as $crantTempsArret){
                if($crantTempsArret['idfichecranteuseq1'] == $idFichesCranteuse){
                    $tempTempsArretParControleur += $crantTempsArret['prodpoids'];
                }
            }
        }
        $ProductionParControleur[$key]["poids"][$i] = $tempProductionParControleur;
        $ProductionParControleur[$key]["tempsarret"][$i] = $tempTempsArretParControleur;
        $i++;
    }
