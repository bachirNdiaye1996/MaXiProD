        ...
        if(isset($_POST['ChercheTempsArret'])){
            ...
            if($machine == "Cranteuse"){
                //** Debut select des temps
                    $sql = "SELECT * FROM `cranteuseq1arret` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dateFiche;";          // On tire les fiches du mois courant
                ...
                //** Debut select des temps
                    $sql = "SELECT * FROM `$dresseusearret` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dateFiche;";          // On tire les fiches du mois courant
                ...
                //** Debut select des fiches
                    $sql = "SELECT * FROM `$machine` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dateFiche;";          // On tire les fiches du mois courant
