<?php   
    ...
    // Pour les graphes
        ...
        //** Debut select des dechet cranteuse
            $sql = "SELECT  SUM(duree) as duree, DAY(`dateCreation`) as jour FROM `dresseusearret` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dtm;";          // On tire les fiches du mois courant
        ...
        if(isset($_POST['ChercheTempsArret'])){
            ...
            if($machine == "Cranteuse 1" || $machine == "Cranteuse 2"){
                //** Debut select des fiches
                    $sql = "SELECT * FROM `fichecranteuseq1` WHERE `actif`=1 AND `dateCreation`='$dateFiche' AND `machine`='$machine' AND `quart`='$quart';";          // On tire les fiches du mois courant
                        ...
                        <!-- RECHERCHE -->
                            <div class="mb-4">
                                <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                    ...
                                    <div class="col-md-2 mt-3 mr-5">
                                        <div class="mb-1 text-start">
                                            <select class="form-control" name="quart">
                                                <option value="1">Qaurt 1</option>
                                                <option value="2">Qaurt 2</option>
                                                <option value="3">Qaurt 3</option>
                                            </select>                                                
                                        </div>
                                    </div>
                                    <div class="mt-3">                           
                    ...
                    <script type="text/javascript">
                        ...
                        for (let i = 0; i < 30; i++) {
                            ...
                            if(arretCrant[i] === undefined){
                                ...
                                ArretCrant[j] = Number(arretCrant[i]['duree']);
                                console.log(ArretCrant);
                            }
                        }
