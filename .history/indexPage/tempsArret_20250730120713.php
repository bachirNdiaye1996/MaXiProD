                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <?php  if($FichesMachineID[1]){ ?>
                            <div class="card position-relative mt-5">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Temps d'arret de la machine <code class="h4"><?= $FichesMachineDetails[1]['machine'] ?></code> <code class="h4">( QUART <?= $FichesMachineDetails[1]['machine'] ?> )</code> du <code class="h4"><?= implode('-',array_reverse  (explode('-',$FichesMachineDetails[1]['dateCreation']))); ?></code> enregistré par <sapn class="h4"><?= $FichesMachineDetails[1]['user'] ?></span></h6>
                                </div>
                                <div class="row m-2">
                        ...
                        <?php  if($FichesMachineID[1]){ ?>
                            <div class="card position-relative mt-5">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Temps d'arret de la machine <code class="h4"><?= $FichesMachineDetails[2]['machine'] ?></code>  du <code class="h4"><?= implode('-',array_reverse  (explode('-',$FichesMachineDetails[2]['dateCreation']))); ?></code> enregistré par <sapn class="h4"><?= $FichesMachineDetails[2]['user'] ?></span></h6>
                                </div>
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php  if($FichesMachineID[3]){ ?>
                            <div class="card position-relative mt-5">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Temps d'arret de la machine <code class="h4"><?= $FichesMachineDetails[3]['machine'] ?></code>  du <code class="h4"><?= implode('-',array_reverse  (explode('-',$FichesMachineDetails[3]['dateCreation']))); ?></code> enregistré par <sapn class="h4"><?= $FichesMachineDetails[3]['user'] ?></span></h6>
                                </div>
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
