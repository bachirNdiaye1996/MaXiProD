            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <script type="text/javascript">
                        ...
                        const ProductDress = document.getElementById('ProductDechet');
                        let html = "<span text-primary> Total = "+TotalProduitDress+"</span>";
                        ProductDechet.insertAdjacentHTML("afterend", html);

                        const TotalDechetDress = Dechet.reduce(
                        (accumulator, currentValue) => accumulator + currentValue,
                        );
                        const DechetDress = document.getElementById('ProductDechet');
                        let html = "<span text-primary> Total = "+TotalDechetDress+".</span>";
                        ProductDechet.insertAdjacentHTML("afterend", html);
