                        ...
                        <?php  if($ProductionParControleur){ ?>
                            ...
                            <div class="card position-relative mt-4">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary">Voici la productivité des opérateurs dans la période du <code class="h4"><?= implode('-',array_reverse  (explode('-',$Periode))); ?></code> à la machine cranteuse.</h6>
                                </div>
                                <div class="row m-2">
