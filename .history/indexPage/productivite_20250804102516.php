<?php   
    ...
    $controleur1 = print_r(array_unique(array_column($FichesCranteuse,'controleur2')));
    $controleur2 = print_r(array_unique(array_column($FichesCranteuse,'controleur2')));

    //print_r($FichesCranteuse);
    foreach($FichesCranteuse as $fichesCranteuse){
        //printf($fichesCranteuse['controleur1'].' ');
    }
