<?php   
    ...
    //** Debut select des receptions
        $sql = "SELECT SUM(`prodpoids`) as prodpoids, DAY(`dateCreation`) as jour FROM `cranteuseq1production` WHERE `actif`=1 AND MONTH(`dateCreation`)=19 
                        ...
                        new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    borderColor: "#4e73df",
                                    data: [4215, 5312, 6251, 7841, 9821, 14984,4215, 5312, 6251, 7841, 9821, 14984,4215, 5312, 6251, 7841, 9821, 14984,4215, 5000, 6251, 7841, 9821, 14984,4215, 5312, 6251, 7841, 9821, 14984, 14984],
                                    borderWidth: 1
                                }]
                            },
                            options: {
