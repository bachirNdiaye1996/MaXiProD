<?php   
    ...
    //** Debut select des production (Poids,...)
        $sql = "SELECT SUM(prodpoids) as prodpoids FROM `cranteuseq1production` WHERE `actif`=1 AND MONTH(`dateCreation`)='07' GROUP BY `idfichecranteuseq1`;";          // On tire les fiches du mois courant
