                            ...
                            <div class="modal-content">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><i class="fas fa-mail-bulk mr-3"></i><?php echo $_SESSION['email']; ?></p>
                                        <p class="card-text"><h6>Section :</h6> <?php echo $_SESSION['section']; ?></p>
                                        <p class="card-text"><h6>Matricule :</h6> <?php echo $_SESSION['matricule']; ?></p>
                                        <p class="card-text"><h6>Nom d'utilisateur :</h6> <?php echo $_SESSION['username']; ?></p>
                                        <p class="card-text"><h6 class="d-inline mr-5">Numéro téléphone :</h6> <?php echo $_SESSION['numTelephone']; ?></p>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        <canvas id="myAreaChart1" height="65"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        <canvas id="myAreaChart2" height="65"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Section 3</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        <canvas id="myAreaChart3" height="65"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
