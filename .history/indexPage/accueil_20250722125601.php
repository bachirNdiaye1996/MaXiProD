            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    Production <span id="ProductDress" class="text-primary"></span>  et Dechet <span id="DechetDress" class="text-primary"></span>
                    ...
                    <script type="text/javascript">
                        ...
                        let htmlPD = "<span> Total = "+TotalProduitDress+" KG</span>";
                        ...
                        let htmlDD = "<span> Total = "+TotalDechetDress+" KG</span>";
