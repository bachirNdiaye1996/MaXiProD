<?php   
    ...
    //** Debut select des temps d'arret (duree,...)
        $sql = "SELECT SUM(duree) as duree, idfichecranteuseq1 as idfichecranteuseq1 FROM `cranteuseq1arret` WHERE `actif`=1 AND MONTH(`dateCreation`)='07' GROUP BY `idfichecranteuseq1`;";          // On tire les fiches du mois courant
