<?php   
    ...
    //** Debut select des production (Poids,...)
        $sql = "SELECT * FROM `cranteuseq1production` WHERE `actif`=1 AND MONTH(`dateCreation`)='07';";          // On tire les fiches du mois courant
    ...
    $ArrayFichesParControleur = array('nom' => 'Hamon',array());
    ...
    foreach($unions as $union){
        foreach($FichesCranteuse as $fichesCranteuse){
            if($fichesCranteuse['controleur1']=="$union" || $fichesCranteuse['controleur2']=="$union"){
                $ArrayFichesParControleur['nom' => "$union"][] = $fichesCranteuse;
    ...
    foreach($CompteurFichesCranteuse as $compteurFichesCranteuse){
        foreach($CrantProduction as $crantProduction){
            if($crantProduction['idfichecranteuseq1'] == $compteurFichesCranteuse){
                $ProductionParControleur["$compteurFichesCranteuse['']"][] = $fichesCranteuse;
            }
        }
    }*/
    ...
    print_r($CompteurFichesCranteuse[1]);
