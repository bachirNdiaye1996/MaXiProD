    ...
    // Pour les graphes
        ...
        // Calcul du temps d'arret
            foreach($ArretCranteuse as $arretCranteuse){
                ...
                $TempsArretTotal[$i] = explode(":",date("H:i",$TotalHeureTravaille - $TotalArretH) ); echo ($TotalHeureTravaillerelle[0]-1)." H ".$TotalHeureTravaillerelle[1]." min";          //Calcul du temps d'arret
                $i++;
            }
