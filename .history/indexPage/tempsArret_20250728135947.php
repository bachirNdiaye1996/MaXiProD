<?php   
    ...
    if($_SERVER["REQUEST_METHOD"]=='POST'){
        ...
        if(isset($_POST['ChercheTempsArret'])){
            ...
            if($machine == "Cranteuse"){
                //** Debut select des fiches
                    $sql = "SELECT * FROM `fichecranteuseq1` WHERE `actif`=1 AND `dateCreation`='$dateFiche' AND `dateCreation`='$dateFiche';";          // On tire les fiches du mois courant
                ...
                //** Debut select des temps
                    $sql = "SELECT * FROM `cranteuseq1arret` WHERE `actif`=1 AND `dateCreation`='$dateFiche';";          // On tire les fiches du mois courant
            ...
            }elseif($machine == "Dresseuse"){
                //** Debut select des temps
                    $sql = "SELECT * FROM `dresseusearret` WHERE `actif`=1 AND `dateCreation`='$dateFiche';";          // On tire les fiches du mois courant
                ...
                //** Debut select des fiches
                    $sql = "SELECT * FROM `fichedresseuse` WHERE `actif`=1 AND `dateCreation`='$dateFiche';";          // On tire les fiches du mois courant
        ...
        //** Debut select des temps
            $sql = "SELECT * FROM `cranteuseq1arret` WHERE `actif`=1 AND `dateCreation`='$dtm';";          // On tire les fiches du mois courant
        ...
        //** Debut select des fiches
            $sql = "SELECT * FROM `fichecranteuseq1` WHERE `actif`=1 AND `dateCreation`='$dtm';";          // On tire les fiches du mois courant
                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3 mb-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){ ?>Temps d'arret de la machine <?= $FichesMachine['machine'] ?> du <?= $FichesMachine['dateCreation'] ?> enregistré par <?= $FichesMachine['user'] ?> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                            <div class="row m-2">
                            ...
                            <div class="card-footer py-3 mt-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){?>Temps d'arret total =  <?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?> fait par <?= $FichesMachine['controleur1'] ?> et <?= $FichesMachine['controleur2'] ?> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                        </div>
