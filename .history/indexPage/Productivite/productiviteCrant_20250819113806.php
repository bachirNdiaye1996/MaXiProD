<?php   
    ...
    //Recherche une fiche
        if(isset($_POST['ChercheTempsArret'])){
            ...
            $moisSansGetPourPDF = $moisAvecGetPDF;
        }
    }else{
        $dt = time();
                    ...
                    <!-- RECHERCHE -->
                        <div class="mt-5 mr-3">
                            <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                ...
                                <?php  }else{ ?>
                                    <a href="pdfProductiviteCrant.php,mois=<?=  $moisAvecGetPDF; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fas fa-download fa-sm text-white-60"></i> Génerer en PDF</a>
                                <?php  } ?>
                            </form> 
                        </div>
