                        ...
                        <?php  if($ProductionParControleur){ ?>
                            ...
                            <div class="card position-relative mt-4">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary"><span class="h4">La productivité</span> des opérateurs dans la période du <code class="h4"><?= $PeriodeReel; ?></code> à la machine <span class="h4">cranteuse</span>.</h6>
                                </div>
                                <div class="row m-2">
