                    ...
                    <!-- RECHERCHE -->
                        <div class="mt-5 mr-3">
                            <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                ...
                                <hr/>
                                <a href="pdfProductiviteCrant.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        ...
                        <?php  if($ProductionParControleur){ ?>
                            ...
                            <div class="card position-relative mt-4">
                                <div class="card-header py-3 mb-4">
                                    <h6 class="m-0 font-weight-bold text-primary"><span class="h4">La productivité</span> des opérateurs dans le mois de <code class="h4"><?= $PeriodeReel; ?></code> à la machine <span class="h4">cranteuse</span>.</h6>
                                </div>
                                <div class="row m-2">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>      
                                                    ...
                                                    <th>Temps arret par opérateur</th> 
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
