                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <div class="card position-relative">
                            ...
                            <div class="card-footer py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Temps d'arret total =  <?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?></h6>
                            </div>
                        </div>
