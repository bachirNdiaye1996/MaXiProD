                    ...
                    <div class="mb-4 mt-5 col-lg-12">
                        ...
                        <div class="card position-relative">
                            ...
                            <div class="card-footer py-3 mt-4">
                                <h6 class="m-0 font-weight-bold text-primary"><?php if($FichesMachine != null){?>Temps d'arret total =  <code class="h4"><?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?></code> fait par <h4><?= $FichesMachine['controleur1'] ?></h4> et <h4><?= $FichesMachine['controleur2'] ?></h4> <?php }else{echo "Pas de temps d'arret";} ?></h6>
                            </div>
                        </div>
