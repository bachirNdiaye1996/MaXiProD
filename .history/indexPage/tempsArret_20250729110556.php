<?php   
    ...
    // Pour les graphes
        ...
        //** Debut select des production cranteuse
            $sql = "SELECT duree, DAY(`dateCreation`) as jour FROM `cranteuseq1arret` WHERE `actif`=1 AND MONTH(`dateCreation`)=$dtm GROUP BY `jour`;";          // On tire les fiches du mois courant
