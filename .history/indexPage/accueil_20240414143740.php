                            ...
                            <div class="modal-content">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><i class="fas fa-mail-bulk mr-3"></i><?php echo $_SESSION['section']; ?></p>
                                        <p class="card-text"><i class="fas fa-mail-bulk mr-3"></i><?php echo $_SESSION['matricule']; ?></p>
