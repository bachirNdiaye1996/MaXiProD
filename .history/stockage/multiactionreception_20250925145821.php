...
// Pour la demande d'approbation details reception en groupe approbation 
                    ...
                    <body>
                        <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                            <p align='center' style='margin-top:20px;'>
                                ...
                                <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou de supprimer des receptions de code de reception : <strong>REC00-$idreceptionDemandeRectifier </strong></p>
            ...
            $messageD = "
                ...
                <body>
                    <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                        <p align='center' style='margin-top:20px;'>
                            <h2 align='center' style='color:white'>METAL * * * AFRIQUE</h2>
                            <p align='center' style='color:white'>$user a approuvé la demande d'autorisation de modifier ou de supprimer une réception de code de réception : <strong>REC00-$idRecep </strong></p>
                            <p align='center'><a href=$HOST style='color:white'>Cliquez ici pour y acceder.</a></p>
                        </p>
                        <br><br>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($reception['actifapprouvreception'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                            <td class="text-center d-print-none"><span>
                                                                ...
                                                                value="<?= $reception['idmatiere'] ?>&&<?= $_GET['idreception'] ?>&&<?= $reception['epaisseur'] ?>&&<?= $reception['nbbobine'] ?>&&<?= $reception['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                </span>
                                                            </td>
                                                        <?php }?>
