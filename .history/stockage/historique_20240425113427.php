                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    ...
                                    <a href="../stockage/transfert/historiqueExploitation.php" class="btn w-lg bouton"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCover">Historique bobines exportées</h4></a>
                                </div>
                                <div class="row m-2">
