    ...
    // Pour insertion une nouvelle reception planifiée
        if(isset($_GET['creerReceptionPlanifie'])){
            ...
            foreach($UserMails as $user => $item){
                envoie_mail("Gestion de production nouvelle réception",$item['email'],"Demande de réctification pour la réception de code de réception REC00-$_GET[idexportationDemandeAccepter]",$messageD);
            }
