                                                ...
                                                ?>
                                                    <tr>
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="form-check-inline">
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox"  class="form-check-input" name="" id="cocherPontBascule">
                                                                        </label>
                                                                    </div>
                                                                </div>                                                             
                                                            <?php }?>
                                                        ...
                                                        <td class="text-center d-print-none"><span>
                                                            <input type="checkbox" class="multi_checkbox checkall" style="width: 15px; height: 15px;" id="id_rows_to_delete0_left" name="rows_to_delete[0]" value="`matiere`.`idmatiere` = 1">
                                                            </span>
                                                        </td>
                                                    </tr>
