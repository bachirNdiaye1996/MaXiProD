   ...
   <li class="nav-item active">
       ...
       <div id="collapseReception" class="collapse show" aria-labelledby="headingUtilities"
           ...
           <div class="bg-white py-2 collapse-inner rounded">
               ...
               <a class="collapse-item <?php if(!isset($active)){ echo 'active'; } ?>" href="../stockage/grapheMetal1.php">Graphe Metal 1</a>
               <a class="collapse-item <?php if(!isset($active)){ echo 'active'; } ?>" href="../stockage/grapheMetalMbao.php">Graphe Metal Mbao</a>
           </div>
       </div>
   </li>
<?php } ?>
   ...
   <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilitiesTrefilage" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Les informations :</h6>
                <a class="collapse-item" href="../../Production/Trefilage/ficheTrefilage.php">Fiches Productions</a>
