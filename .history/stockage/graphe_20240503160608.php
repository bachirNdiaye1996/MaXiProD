...
$sqlepaisseur = "SELECT sum(nbbobineactuel),epaisseur FROM `matiere` where `nbbobineactuel`>0 and `lieutransfert`='Niambour' GROUP BY epaisseur;";
...
<head>
    ...
    <script>
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            title: {
                text: "La composition des stocks de bobines dans les differents dépots de Metal Afrique"
            },
            data: [{
                type: "doughnut",
                indexLabel: "{symbol} - {y}",
