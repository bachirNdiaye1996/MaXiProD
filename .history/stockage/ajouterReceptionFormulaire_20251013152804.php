                       ...
                       /* //Rechercher le nombre de piéces sur le lieu d'arrive 
                        ...
                        /*if($resultMatiereArrive){
                            ...
                            // Ajouter le nombre de bobine dans le lieu de reception
                                $insertUser=$db->prepare("INSERT INTO `matiere` (`idmatiere`, `epaisseur`, `poidsdeclare`, `poidspese`, `dateajout`, `user`,`nbbobine`,`lieutransfert`, `idreception`, `etatbobine`,`nbbobineactuel`,`entetedf`) 
                                VALUES (NULL, ?, ?, ?, current_timestamp(), ?, ?, ?, ?, ?, ?, ?);");
                                $insertUser->execute(array($epaisseur,$poidsdeclare, $poidspese, $user,$nbbobine,$lieutransfert,$idreception, $etatbobine, $nbbobine, $entetedf));
