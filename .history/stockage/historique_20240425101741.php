                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <a href="ajouterReceptionFormulaire.php?" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i><h6 class="m-0 font-weight-bold text-primary">Liste des bobines réceptionnées</h6></a>
                                </div>
                                <div class="row m-2">
