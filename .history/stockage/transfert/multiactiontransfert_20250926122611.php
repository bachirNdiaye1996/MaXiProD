                                                        ...
                                                        <td >
                                                            <?php if($transfert['actifapprouvtransfert'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                                <td class="text-center d-print-none"><span>
                                                                    ...
                                                                    value="<?= $transfert['idtransfert'] ?>&&<?= $_GET['idtransfert'] ?>&&<?= $transfert['epaisseur'] ?>&&<?= $transfert['nbbobine'] ?>&&<?= $transfert['idmatierearrive'] ?>&&<?= $transfert['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                    </span>
                                                                </td>
                                                            <?php }?>
