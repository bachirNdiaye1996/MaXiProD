<?php
    ...
    if(isset($_POST['CreerTransfert'])){
        ...
        $last_names = array_unique($Epaisseurs['epaisseur']);
        ...
        for ($i = 0; $i < count($_POST['epaisseur']); $i++){
            ...
            foreach($last_names as $contenu)
            {     
                if($epaisseur === $contenu){
                    $tempValeursParEpaisseur += $nbbobine;
                }
            }
            $ValeursParEpaisseur["$epaisseur"] = $ValeursParEpaisseur["$epaisseur"] + $tempValeursParEpaisseur;
            //printf($ValeursParEpaisseur[$epaisseur]);
        }

        print_r($ValeursParEpaisseur);
