                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <a href="" class="btn  w-lg bouton mr-5"><i class=""></i><h4 class="m-0 font-weight-bold text-primary">Historique bobines réceptionnées</h4></a>
                                    <a href="../stockage/transfert/historiqueTransfert.php" class="btn-success btn w-lg bouton"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCover">Historique bobines transférées</h4></a>
                                </div>
                                <div class="row m-2">
