            ...
            for ($i = 0; $i < count($_POST['epaisseur']); $i++){
                ...
                */
                ...
                // Enlever le nombre de bobine dans le lieu de depart
                    $req ="UPDATE matiere SET `nbbobineactuel` = `nbbobineactuel` - ? where `numbobine`='$numbobine';";
                                                                ...
                                                                <tr class="rowClass">
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="">
                                                                            <div class="mb-1 text-start">
                                                                                <select class="form-control" name="numbobine[]" id="numerofinProd">
                                                                                    <option><?php echo $_POST['numbobine'][$i]; ?></option> 
                                                                                    <?php
                                                                                        foreach($stockCranteuseTrefilage as $stock){
                                                                                    ?>      
                                                                                        <option value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur'].'/'.$stock['poidsdeclare'].'/'.$stock['poidspese'].'/'.$stock['lieutransfert']; ?>"> <?php echo $stock['numbobine']; ?></option>                                                                                     
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control designa" type="number" step="0.01" name="poidspese[]" id="poidspese" value="<?php echo $_POST['poidspese'][$i]; ?>">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control designa" id="poidsdeclare" type="number" step="0.01" name="poidsdeclare[]" value="<?php echo $_POST['poidsdeclare'][$i]; ?>" required>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
