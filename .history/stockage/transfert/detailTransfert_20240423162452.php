    ...
    if(isset($_POST['approuveTransfertRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            if($resultMatiereArrive){
                ...
                <body>
                    <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier le transfert <strong>TRAN00-$idtransfert </strong></p>
                ...
                //** Fin select 
                foreach($UserMails as $article){
                    envoie_mail("METAL AFRIQUE",$email,"Réctification du transfert de TRAN00-$idtransfert",$messageD);
                }
