                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <?php if($[''] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                            ...
                                                            <?php if($transfert['actifapprouvtransfert'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                                <td class="text-center d-print-none"><span>
                                                                    ...
                                                                    value="<?= $transfert['idmatiere'] ?>&&<?= $_GET['idtransfert'] ?>&&<?= $reception['epaisseur'] ?>&&<?= $transfert['nbbobine'] ?>&&<?= $reception['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                    </span>
                                                                </td>
                                                            <?php }?>
