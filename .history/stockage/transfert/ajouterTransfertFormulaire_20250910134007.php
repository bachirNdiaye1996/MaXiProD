        ...
        if(count(array_unique($_POST['numbobine'])) != count($_POST['numbobine'])){
            ...
            for ($i = 0; $i < count($_POST['epaisseur']); $i++){
                ...
                foreach($ResultEpaisseur as $resultEpaisseur){
                    if($resultEpaisseur['lieutransfert'] == $pointdepart && $resultEpaisseur['lieutransfert'] == $pointdepart && $resultEpaisseur['lieutransfert'] == $pointdepart && $resultEpaisseur['lieutransfert'] == $pointdepart){
