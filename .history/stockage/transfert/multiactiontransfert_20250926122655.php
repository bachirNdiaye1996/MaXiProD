                                                        ...
                                                        <td >
                                                            <?php if($transfert['actifapprouvtransfert'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                                <td class="text-center d-print-none"><span>
                                                                    ...
                                                                    value="<?= $transfert['idtransfert'] ?>&&<?= $_GET['idtransfert'] ?>&&<?= $transfert['epaisseur'] ?>&&<?= $transfert['nbbobine'] ?>&&<?= $transfert['idmatierearrive'] ?>&&<?= $transfert['pointarrive'] ?>&&<?= $transfert['pointdepart'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                    </span>
                                                                </td>
                                                            <?php }?>
                                                            <?php if(($transfert['acceptereceptionmodif'] == 0) && ($transfert['actifapprouvtransfert'] == 1) && ($_SESSION['niveau']=='pontbascule')){?>
                                                                <td class="text-center d-print-none"><span>
                                                                    ...
                                                                    value="<?= $transfert['idmatiere'] ?>&&<?= $_GET['idtransfert'] ?>&&<?= $transfert['epaisseur'] ?>&&<?= $transfert['nbbobine'] ?>&&<?= $transfert['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                    </span>
                                                                </td>
                                                            <?php }?>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                        <input class="" type="text" value="<?= $_GET[''] ?>" name="idtransfert">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                        <input class="" type="text" value="<?= $transfert[''] ?>" name="idmatierearrive">
                                                                                    </div>
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                ...
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                        <input class="" type="text" value="<?= $transfert[''] ?>" name="pointarrive">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                        <input class="" type="text" value="<?= $transfert[''] ?>" name="pointdepart">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
                                                                                    <div class="">
                                            ...
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="multiactiontransfert.php?idtransfert=<?= $_GET['idtransfert']?>" class="btn btn-primary w-lg bouton mr-3 ml-3">Multi-Action<i class="fa fa-angle-double-right ml-2"></i></a>
                                                </div>
                                            </div>
                                        <?php
                                            //}
