            ...
            $messageD = "
                ...
                <body>
                    <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                        <p align='center' style='margin-top:20px;'>
                            <h2 align='center' style='color:white'>METAL * * * AFRIQUE</h2>
                            <p align='center' style='color:white'>$user a approuvé la demande d'autorisation de modifier ou de supprimer des transferts de code de transfert : <strong>TRAN00-$_GET[idtransfert] </strong></p>
                            <p align='center'><a href=$HOST style='color:white'>Cliquez ici pour y acceder.</a></p>
                        </p>
                        <br><br>
                    </div>
