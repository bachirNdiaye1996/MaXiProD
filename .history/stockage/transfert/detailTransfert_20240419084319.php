    ...
    if(isset($_POST['approuveTransfertRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            //Rechercher le nombre de piéces sur le lieu d'arrive
                $sqlEpaisseur = "SELECT * FROM `matiere` where `lieutransfert`='$pointarrive' and `poidsdeclare`='$poidsdeclare' and `epaisseur`='$epaisseur' and `nbbobineactuel` != 0 and `nbbobineactuel`>=$nombrebobine LIMIT 1;";
