                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        ...
                                                        <?php if($ProblemeNumeroBobine == "erreurProblemeNumeroBobine"){ ?> 
                                                            <script>    
                                                                Swal.fire({
                                                                    text: 'Veiller renseigner le numéro de fil machine en corrigeant la ligne <?php echo $ligneErreurBobine; ?>',
                                                                    icon: 'error',
                                                                    timer: 5500,
                                                                    showConfirmButton: false,
                                                                },
                                                        ...
                                                        <?php if($ProblemeLieu == "erreurProblemeLieu"){ ?> 
                                                            <script>    
                                                                Swal.fire({
                                                                    text: 'Le lieu de départ doit étre différent du lieu d arrivé à la ligne <?php echo $ligneErreurLieu; ?> svp!',
                                                                    icon: 'error',
                                                                    timer: 5500,
                                                                    showConfirmButton: false,
                                                                },
