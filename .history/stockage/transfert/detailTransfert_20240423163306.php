        ...
        if(!empty($_POST['motifRectifier'])){
            ...
            if($resultMatiereArrive){
                ...
                <body>
                    <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier le transfert de code : <strong>TRAN00-$idtransfert </strong></p>
                            <p align='center' style='color:white'>Avec comme motif :<strong>TRAN00-$idtransfert </strong></p>
                ...
                foreach($UserMails as $user){
                    envoie_mail("METAL AFRIQUE",$user['email'],"Réctification du transfert de code TRAN00-$idtransfert",$messageD);
                }
