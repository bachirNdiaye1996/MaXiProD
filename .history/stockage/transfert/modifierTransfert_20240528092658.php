                ...
                if($resultEpaisseur){
                    ...
                    /*if($resultMatiereArrive){
                        ...
                        // Ajouter le nombre de bobine dans le lieu d'arrive
                            $insertUser=$db->prepare("INSERT INTO `matiere` (`idmatiere`, `epaisseur`, `poidsdeclare`, `poidspese`, `dateajout`,`nbbobine`,`lieutransfert`, `etatbobine`,`nbbobineactuel`,`numbobine`) 
                            VALUES (NULL, ?, ?, ?, current_timestamp(), ?, ?, ?, ?, ?);");
                            $insertUser->execute(array($epaisseur,$poidsdeclare, $poidspese,$nbbobine,$pointarrive, $etatbobine, $nbbobine, $numbobine)); 
