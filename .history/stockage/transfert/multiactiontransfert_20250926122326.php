                                                        ...
                                                        <td >
                                                            <?php if($transfert['actifapprouvtransfert'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                                <td class="text-center d-print-none"><span>
                                                                    ...
                                                                    value="<?= $transfert['idtransfert'] ?>&&<?= $transfert['epaisseur'] ?>&&<?= $transfert['nbbobine'] ?>&&<?= $transfert['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                    </span>
                                                                </td>
                                                            <?php }?>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="invisible">
                                                                                    <div class="">
                                                                                        <input class="" type="text" value="<?= $transfert[''] ?>" name="idmatiereDemandeRectifier">
                                                                                    </div>
                                                                                </div> 
                                                                                <div class="invisible">
                                                                                    <div class="">
