    ...
    if(isset($_POST['demandeApprobation'])){
        if(isset($_POST['check'])){
            for ($i = 0; $i < count($_POST['check']); $i++){
                $check=$_POST['check'][$i];
                $checks = explode("&&", $check);
                $idtransfertDemandeRectifier = $checks[0];            // idmatiere
                $idmatiereDemandeRectifier = $checks[1];            // .
                $epaisseur = $checks[2];              // .
                ...
                <body>
                    <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou supprimer des transferts de code de transfert : <strong>TRAN00-$idmatiereDemandeRectifier </strong></p>
