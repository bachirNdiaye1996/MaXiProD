                                                            ...
                                                            ?>
                                                                <tr class="rowClass">
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control" value="<?php echo $_POST['numbobinedebut'][$i]; ?>" id="validationDefault04" type="number" name="nbbobine[]">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control" value="<?php echo $_POST['numbobinefin'][$i]; ?>" id="validationDefault04" type="number" name="numbobine[]">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
