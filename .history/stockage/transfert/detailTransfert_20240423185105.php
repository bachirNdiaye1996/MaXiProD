                ...
                <body>
                    <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou supprimer un transfert de code : <strong>TRAN00-$idtransfert </strong></p>
