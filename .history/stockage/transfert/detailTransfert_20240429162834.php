                                                                        ...
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="motifRectifier" placeholder="Mettez en quelques mots le motif de la rectification qui sera recu par le DSI comme courrier MAIL svp."></textarea>
                                                                                </div>
                                                                                <div class="invisible">
                                                                                    <div class="">
