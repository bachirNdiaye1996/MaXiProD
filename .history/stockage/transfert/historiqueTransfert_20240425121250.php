...
<body id="page-top">
                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    ...
                                    <a href="" class="btn-warning btn w-lg bouton mr-5"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCoverTransfert">Historique bobines transférées</h4></a>
    ...
    <script>
        $(".historiqueCoverTransfert").mouseenter(function(event){
            event.target.style.backgroundColor = "#E13115";
        });  
        
        $(".historiqueCoverTransfert").mouseleave(function(event){
            event.target.style.backgroundColor = "#FFFFFF";
        });
    </script>
