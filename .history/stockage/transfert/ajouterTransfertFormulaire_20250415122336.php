<?php
    ...
    if(isset($_POST['CreerTransfert'])){
        ...
        if(count(array_unique($_POST['numbobine'])) != count($_POST['numbobine'])) {
            print(array_unique((int) ($_POST['numbobine'])));
        } else {
            print(array_unique($_POST['numbobine']));
        }
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        ...
                                                        <?php if($ProblemeUnicite == "erreurProblemeUnicite"){ ?> 
                                                            <script>    
                                                                Swal.fire({
                                                                    text: 'Vérifier le numéro de FM doit etre unique à la ligne <?php echo $ligneErreurProblemeUnicite; ?>',
                                                                    icon: 'error',
                                                                    timer: 5500,
                                                                    showConfirmButton: false,
                                                                },
