            ...
            // |--> Pour le update des nombres de bobines dans matiere
                ...
                if($resultEpaisseur){
                    ...
                    // |--> Pour update transfert
                        ...
                        , `poidspese` = '$poidspese', `etatbobine` = '$etatbobine', `nbbobine` = '$nbbobine', `couleurhistorique`=2, `idmatieredepart` = '$Iddepart', `idmatierearrive` = '$Idarrive' WHERE `idtransfertdetail` = ?;";
                        //$result = $db->query($sql); 
                        $sth = $db->prepare($sql);    
