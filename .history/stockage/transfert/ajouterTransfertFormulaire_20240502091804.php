                                            ...
                                            <div class="row">
                                                ...
                                                <?php }else{  // Lorsqu'il y'a erreur ?>
                                                    ...
                                                    <div class="col-md-2 ml-5 mt-3">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Transporteur</label>
                                                            <input class="form-control" id="validationDefault02" type="text" name="transporteur" value="<?php echo $_POST['transporteur']; ?><?= $row[''] ?>" placeholder="Mettez le nom complet du transporteur" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 ml-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Date du transfert</label>
                                                            <input class="form-control" id="validationDefault03" type="date" name="datetransfert" value="<?php echo $_POST['datetransfert']; ?><?= $row[''] ?>" required>
                                                        </div>
                                                    </div>
                                                    <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                        <thead>
