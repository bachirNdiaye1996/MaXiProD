                                            ...
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="ajouterTransfertFormulaireComplexe.php?idtransfert=<?= $_GET['idtransfert']?>&NombreLigne=0" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter transfert rapide</a>
                                                        <a href="ajouterTransfertFormulaireInverse.php?idtransfert=<?= $_GET['idtransfert']?>&NombreLigne=0" class="btn btn-primary w-lg bouton mr-3"><i class="fa fa-plus me-1"></i> Ajouter transfert</a>
                                                    <?php
                                                            //} 
                                                        }
                                                    ?>
