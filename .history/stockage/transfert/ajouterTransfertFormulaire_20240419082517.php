    ...
    if(isset($_POST['CreerTransfert'])){
        ...
        if(!empty($_POST['saisisseur'])){
            ...
            for ($i = 0; $i < count($_POST['epaisseur']); $i++){
                if(!empty($_POST['epaisseur'][$i]) && !empty($_POST['poidspese'][$i])){
                    ...
                    //** On vérifie si le nombre est exact
                        ...
                        */
                        ...
                        //Rechercher le nombre de piéces sur le lieu de depart
                            $sqlEpaisseur = "SELECT * FROM `matiere` where `lieutransfert`='$pointdepart' and `poidsdeclare`='$poidsdeclare' and `epaisseur`='$epaisseur' and `nbbobineactuel` != 0 and `nbbobineactuel`>=$nbbobine LIMIT 1;";
        ...
        $(document).ready(function(){  
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
                            <input class="form-control designa" type="number" step="0.01" name="poidspese[]" id="validationDefault0<?$i+10?>" id="example" required>
                        </div>
                    </div>
                </td>
                <td style="background-color:#CFFEDA ;">
                                            ...
                                            <div class="row">
                                                            ...
                                                            ?>
                                                                <tr class="rowClass">
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control designa" id="validationDefault05" type="number" step="0.01" name="poidspese[]" id="example" value="<?php echo $_POST['poidspese'][$i] ?>" required>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <textarea class="form-control" id="validationTextarea" required name="commentaire" rows="4" cols="50"  placeholder="Commentaire en quelques mots ( pas obligatoire... )"><?= $row['commentaire'] ?></textarea>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="row">
