<?php
    ...
    if(isset($_POST['CreerTransfert'])){
        ...
        for ($i = 0; $i < count($_POST['epaisseur']); $i++){
            ...
            if(($numbobine == "" && $pointarrive != "") || ($numbobine == "" && $pointarrive != "")){ 
                ...
                */
                ...
                /*if($resultMatiereArrive){
                    ...
                    // Ajouter le nombre de bobine dans le lieu d'arrive
                        $insertUser=$db->prepare("INSERT INTO `matiere` (`idmatiere`, `epaisseur`, `poidsdeclare`, `poidspese`, `dateajout`,`nbbobine`,`lieutransfert`, `etatbobine`,`nbbobineactuel`,`idreception`,`numbobine`) 
                        VALUES (NULL, ?, ?, ?, current_timestamp(), ?, ?, ?, ?, ?, ?);");
                        $insertUser->execute(array($epaisseur,$poidsdeclare, $poidspese,$nbbobine,$pointarrive, $etatbobine, $nbbobine,$codereception,$numbobine));  
                ...
                //}else{
                    ...
                    $insertUser=$db->prepare("INSERT INTO `transfertdetails` (`idtransfertdetail`, `poidspese`, `dateajout`, `user`, `nbbobine`, `actif`, `pointdepart`, `idtransfert`, `epaisseur`, `etatbobine`, `poidsdeclare`, `commentaire`, `pointarrive`,`idmatieredepart`,`idmatierearrive`,`codereception`,`numbobine`)
                    VALUES (NULL, ?, current_timestamp(), NULL, ?, '1', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
                    $insertUser->execute(array($poidspese,$nbbobine,$pointdepart,$idtransfert,$epaisseur,$etatbobine,$poidsdeclare,$commentaire,$pointarrive,$Iddepart,$idMax,$codereception,$numbobine));
                //}
            }
