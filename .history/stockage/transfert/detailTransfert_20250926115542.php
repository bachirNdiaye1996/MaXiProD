                                            ...
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="multiactiontransfert.php?idtransfert=<?= $_GET['idtransfert']?>" class="btn btn-primary w-lg bouton mr-3 ml-4">Multi-Action<i class="fa fa-angle-double-right ml-2"></i></a>
                                                </div>
                                            </div>
                                        <?php
                                            //}
