                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseReception" class="collapse show" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="../stockage/graphe.php">Graphique Niambour</a>
                            <a class="collapse-item active" href="../stockage/grapheMetal1.php">Graphique Metal 1</a>
                        </div>
                    </div>
                </li>
            <?php } ?>
