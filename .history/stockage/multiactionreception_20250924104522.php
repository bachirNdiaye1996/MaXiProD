                                            ...
                                            <div class="col-md-8 align-items-center mb-3">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    <?php if($reception['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        <button class="btn btn-warning w-lg bouton ml-3" type="submit" name="demandeApprobation" value="demandeApprobation" title="Demander l'autorisation de modifier au pret du DSI">
                                                            <span class="text-nowrap"><i class="fas fa-file-signature"></i>&nbsp;Demande Approbation</span>
                                                        </button>
                                                    <?php }?>
                                                    <?php if($_SESSION['niveau']=='admin'){ ?>
                                                        <button class="btn btn-primary w-lg bouton ml-3" type="submit" name="approbation" value="approbation" title="Permettre au responsable du pont bascule de modifier ou suprimer cette reception">
                                                            <span class="text-nowrap"><i class="fas fa-paper-plane"></i>&nbsp;Approuver</span>
                                                        </button>
                                                    <?php }?>
                                                    <?php if($_SESSION['niveau']=='pontbascule'){ ?>
                                                        <button class="btn btn-danger w-lg bouton ml-3" type="submit" name="supprimer" value="supprimer" title="Supprimer">
