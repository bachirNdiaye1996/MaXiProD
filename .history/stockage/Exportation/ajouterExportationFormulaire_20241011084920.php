<?php
    ...
    $idexportation = $_GET['idexportation'];  // On recupére l'ID exportation par get
    ...
    //Revoir si on a ajouté une ligne
        ...
        $sql = "select * from exportation where idexportation=$idexportation";
        $result = $db->query($sql);
        $row = $result->fetch();  
        ...
        $dateexportation=$row['dateexportation'];
                        ...
                        if($resultEpaisseur){
                            ...
                            //}else{
                                ...
                                if(!$pointarrive){
                                    ...
                                    $insertUser->execute(array($poidspese,$nbbobine,$pointdepart,$idexportation,$epaisseur,$etatbobine,$poidsdeclare,$commentaire,"Indefini",$Iddepart,$idMax));
                                }else{
                                    $insertUser=$db->prepare("INSERT INTO `exportationdetails` (`idexportationdetail`, `poidspese`, `dateajout`, `user`, `nbbobine`, `actif`, `pointdepart`, `idexportation`, `epaisseur`, `etatbobine`, `poidsdeclare`, `commentaire`, `pointarrive`,`idmatieredepart`,`idmatierearrive`)
                                    VALUES (NULL, ?, current_timestamp(), NULL, ?, '1', ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ...
        $(document).ready(function(){  
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
                            <input class="form-control designa" type="text" name="pointarrive[]" placeholder="Pas obligatoire">
                        </div>
                    </div>
                </td>
                <td style="background-color:#CFFEDA ;">
                            ...
                            <div class="modal-dialog-centered">
                                <div class="modal-content col-lg-12">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myExtraLargeModalLabel">Ajouter une exportation</h5>
                                                            ...
                                                            ?>
                                                                <tr class="rowClass">
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <input class="form-control designa" type="text" name="pointarrive[]" value="" placeholder="Pas obligatoire">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td style="background-color:#CFFEDA ;">
