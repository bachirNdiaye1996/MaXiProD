                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="background-color:#CFFEDA ;">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailTransfert.php?idtransfert=<?= $exportation['idexportation'] ?>" class="link-offset-2 link-underline"><?php echo "TRAN00-".$exportation['idexportation'] ?></a>
                                                        </td>
