                                                            ...
                                                            $('.accepteExportationmod<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Permettre la modification",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: "approuveExportation.php?idtransfertDemandeAccepter=<?= $_GET['idtransfert'] ?>&idmatiereDemandeAccepter=<?= $transfert['idtransfertdetail'] ?>&epaisseur=<?= $transfert['epaisseur'] ?>&nombrebobine=<?= $transfert['nbbobine'] ?>&pointdepart=<?= $transfert['pointdepart'] ?>&pointarrive=<?= $transfert['pointarrive'] ?>&idPointdepart=<?= $transfert['idmatieredepart'] ?>&idPointarrive=<?= $transfert['idmatierearrive'] ?>",
                                                                                //data: str,
