                        ...
                        */
                        ...
                        if($resultEpaisseur){
                            ...
                            //}else{
                                ...
                                $insertUser=$db->prepare("INSERT INTO `exportationdetails` (`idexportationdetail`, `poidspese`, `dateajout`, `user`, `nbbobine`, `actif`, `pointdepart`, `idtransfert`, `epaisseur`, `etatbobine`, `poidsdeclare`, `commentaire`, `pointarrive`,`idmatieredepart`,`idmatierearrive`)
