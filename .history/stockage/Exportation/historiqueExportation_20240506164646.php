...
//** Debut select des receptions
    $sql = "SELECT * FROM `exportationdetails` where `actif`=1 ORDER BY `idexportationdetail` DESC;";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Contient la nav bar gauche -->
            <?php include "./navGaucheExportation.php" ?>
        <!-- End  -->
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <a href="../historique.php" class="btn w-lg bouton mr-5"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCoverReception">Historique bobines réceptionnées</h4></a>
                                <a href="../transfert/historiqueTransfert.php" class="btn w-lg bouton mr-5"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCover">Historique bobines transférées</h4></a>
                                <a href="" class="btn btn-danger w-lg bouton"><i class=""></i><h4 class="m-0 font-weight-bold text-primary">Historique bobines exportées</h4></a>
                            </div>
                            <div class="row m-2">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" title="Allez vers la reception planifiée correspondante" href="" class="link-offset-2 link-underline"><?php echo "EXP-0".$exportation['idexportation']."-BOB-0".$exportation['idexportationdetail'] ?></a>
                                                    </td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['epaisseur'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['nbbobine'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['poidsdeclare'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['poidspese'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['etatbobine'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['pointdepart'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['pointarrive'] ?></td>
                                                    <td style="<?php if($exportation['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($exportation['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $exportation['dateajout'] ?></td>
                                                </tr>
                                            <?php
                                                }
                                            ?>
                                    ...
                                    <div class="col-md-8 align-items-center">
                                        <div class="d-flex gap-2 pt-4">
                                            <a href="exportation.php" class="btn btn-danger w-lg bouton ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(".historiqueCoverReception").mouseenter(function(event){
            event.target.style.backgroundColor = "#0AB16C";
        });  
        
        $(".historiqueCoverReception").mouseleave(function(event){
            event.target.style.backgroundColor = "#FFFFFF";
        });
    </script>
