                                        ...
                                        ?>
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                        <a href="ajouterExportationFormulaire.php?idtransfert=<?= $_GET['idtransfert']?>&NombreLigne=0" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter transfert</a>
                                                    <?php
                                                            //} 
                                                        }
                                                    ?>
