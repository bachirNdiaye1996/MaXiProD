            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'>
                    <p align='center' style='margin-top:20px;'><br><br>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] a approuvé la demande d'autorisation de modifier ou de supprimer une exportation de code d'exportation : <strong>EXP00-$idexportation </strong></p>
