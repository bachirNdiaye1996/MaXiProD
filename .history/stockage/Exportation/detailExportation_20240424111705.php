                                                            ...
                                                            $('#suprimerExportation<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Suprimer la exportation",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: "suprimerExportation.php?idsuptransfert=<?=  $_GET['idtransfert'] ?>&idtransfertsup=<?= $transfert['idtransfertdetail'] ?>&epaisseur=<?= $transfert['epaisseur'] ?>&lieuDepart=<?= $transfert['pointdepart'] ?>&nombrebobine=<?= $transfert['nbbobine'] ?>",
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
