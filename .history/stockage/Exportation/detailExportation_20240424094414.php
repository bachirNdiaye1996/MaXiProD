        ...
        if(!empty($_POST['motifRectifier'])){
            ...
            if($resultMatiereArrive){
                ...
                <body>
                    <div id='email-wrap' style='background: linear-gradient(45deg, #FC466B, #3F5EFB); border-radius: 10px;'>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou supprimer une exportation de code d'exportation : <strong>TRAN00-$idtransfert </strong></p>
                ...
                foreach($UserMails as $user => $item){
                    envoie_mail("METAL AFRIQUE",$item['email'],"Demande de réctification pour le transfert de code TRAN00-$idtransfert",$messageD);
                }
