                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <script>
                                                        console.log("approuveExportation.php?idexportationDemandeAccepter=<?= $_GET['idexportation'] ?>&idmatiereDemandeAccepter=<?= $exportation['idexportationdetail'] ?>&epaisseur=<?= $transfert['epaisseur'] ?>&nombrebobine=<?= $transfert['nbbobine'] ?>&pointdepart=<?= $transfert['pointdepart'] ?>&pointarrive=<?= $transfert['pointarrive'] ?>&idPointdepart=<?= $transfert['idmatieredepart'] ?>&idPointarrive=<?= $transfert['idmatierearrive'] ?>");
