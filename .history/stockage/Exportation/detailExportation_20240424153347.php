...
$sqlEpaisseur = "SELECT * FROM `matiere` where `lieutransfert`='Niambour' and `epaisseur`='7' and `nbbobineactuel` != 0 and `nbbobineactuel`>=$nbbobine LIMIT 1;";
...
if($resultEpaisseur){
    echo $resultEpaisseur['idmatiere'];
}
...
//Pour send mail approuveTransfertRectifie
    if(isset($_POST['approuveExportationRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            <
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'>
                    <p align='center' style='margin-top:20px;'>
                        <h2 align='center' style='color:white'>METAL * * * AFRIQUE</h2>
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou supprimer une exportation de code d'exportation : <strong>EXP00-$idexportation </strong></p>
