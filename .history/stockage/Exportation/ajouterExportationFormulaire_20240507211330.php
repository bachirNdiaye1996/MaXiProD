        ...
        if(!empty($_POST['saisisseur'])){
            ...
            for ($i = 0; $i < count($_POST['epaisseur']); $i++){
                if(!empty($_POST['epaisseur'][$i])){
                    ...
                    $_POST['epaisseur'][$i]=NULL;
                    $_POST['etatbobine'][$i]=NULL;
                    $_POST['poidsdeclare'][$i]=NULL;
                    $_POST['pointdepart'][$i]=NULL;
                    $_POST['pointarrive'][$i]=NULL;
                    $_POST['nbbobine'][$i]=NULL;
                }else{
