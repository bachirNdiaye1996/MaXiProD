                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-6 mt-3 text-start">
                                                    ...
                                                    <select class="form-control" name="pointarrive" value="<?php echo $row[''];?>">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="mb-6 text-start">
                                                    ...
                                                    <input class="form-control designa" type="number" value="<?php echo $row['pointarrive'];?>" name="poidsdeclare" id="validationDefault02"  placeholder="Taper le poids déclaré" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-3">
                                                <div class="mb-6 text-start">
