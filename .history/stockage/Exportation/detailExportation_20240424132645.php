            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou supprimer une exportation de code d'exportation : <strong>EXP00-$exportation </strong></p>
