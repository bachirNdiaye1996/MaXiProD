...
// Pour insertion details exportation
...
//Fin insertion details exportation

//** Debut select des exportations
    $sql = "SELECT * FROM `exportation` where `actif`=1 ORDER BY `idexportation` DESC;";
                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Liste des exports</h6>
                                </div>
                                <div class="row m-2">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="background-color:#CFFEDA ;">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailExportation.php?idexportation=<?= $exportation['idexportation'] ?>" class="link-offset-2 link-underline"><?php echo "EXP00-".$exportation['idexportation'] ?></a>
                                                        </td>
                                                        <td style="background-color:#CFFEDA ;"><?= $exportation['user'] ?></td>
                                                        <td style="background-color:#CFFEDA ;"><?= $exportation['saisisseur'] ?></td>
                                                        <td style="background-color:#CFFEDA ;"><?= $exportation['dateexportation'] ?></td>
                                                        <td style="background-color:#CFFEDA ;"><?= $exportation['dateajout'] ?></td>
                                                        <td style="background-color:#CFFEDA ; text-align: center;">
                                                            <?php if($exportation['commentaire'] != NULL){ ?>
                                                        ...
                                                        <div class="modal-dialog modal-xl modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body border border-warning" style="margin:70px; border-radius: 15px 30px; margin-top:20px; background-color: #fef1df;">
                                                                    <h4><?php echo $exportation['commentaire']; ?></h4>                                                                                                
                                                                </div>                                                                                             
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <script>
                                                            ...
                                                            $(document).ready( function(){
                                                                $('.suprimerExportation<?= $i ?>').click(function(e) {
                                                                    ...
                                                                    confirmButtonText: "Suprimer l'exportation",
                                                                    }).then((result) => {
                                                                        if (result.isConfirmed) {                                                                                                                  
                                                                            $.ajax({
                                                                                    type: "POST",
                                                                                    url: 'suprimerExportation.php?idexportationreel=<?= $exportation['idexportation'] ?>',
                                                                                    //data: str,
                                                                                    success: function( response ) {
                                                                                        Swal.fire({
                                                                                            text: 'Exportation suprimée avec succes!',
                                                                                            icon: 'success',
                                                                                            timer: 3000,
                                                                                    ...
                                                                                    error: function( response ) {
                                                                                        $('#status').text('Impossible de supprimer cette exportation : '+ response.status + " " + response.statusText);
