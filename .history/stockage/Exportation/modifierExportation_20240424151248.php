        ...
        if(isset($_POST['modifierExportation'])){
            ...
            */
            ...
            // |--> Pour le update des nombres de bobines dans matiere
                ...
                $pointdepartEncien = $_GET['pointdepart'];

                //Rechercher le nombre de piéces sur le lieu de depart
                    $sqlEpaisseur = "SELECT * FROM `matiere` where `lieutransfert`='$pointdepartEncien' and `epaisseur`='$epaisseur' and `nbbobineactuel` != 0 and `nbbobineactuel`>=$nbbobine LIMIT 1;";
