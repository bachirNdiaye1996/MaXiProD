                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="<?php if($exportation['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" title="Allez vers la reception planifiée correspondante" href="detailsReceptionPlanifie.php?idtransfert=<?= $exportation['idexportation'] ?>" class="link-offset-2 link-underline"><?php echo "EXP-0".$exportation['idexportation']."-BOB-0".$exportation['idexportationdetail'] ?></a>
                                                        </td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['epaisseur'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['nbbobine'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['poidsdeclare'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['poidspese'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['etatbobine'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['pointdepart'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['pointarrive'] ?></td>
                                                        <td style="<?php if($transfert['actifapprouvexportation'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $transfert['dateajout'] ?></td>
                                                        <td >
                                                            ...
                                                            <?php if(($exportation['acceptereceptionmodif'] == 0) && ($exportation['actifapprouvexportation'] == 1) && $_SESSION['niveau']=='pontbascule'){ ?>
                                                                <a href="modifierTransfert.php?idtransfert=<?= $_GET['idtransfert'] ?>&idtransfertModifSimp=<?= $exportation['idtransfertdetail'] ?>&epaisseur=<?= $exportation['epaisseur'] ?>&nombrebobine=<?= $exportation['nbbobine'] ?>&idPointdepart=<?= $exportation['idmatieredepart'] ?>&idPointarrive=<?= $exportation['idmatierearrive'] ?>" class="px-2" title="Modifier le transfert"><i class="far fa-edit"></i></a>
                                                            <?php }?>
                                                            <?php if(($exportation['acceptereceptionmodif'] == 0) && ($exportation['actifapprouvexportation'] == 1) && $_SESSION['niveau']=='pontbascule'){ ?>
                                                                <a href="javascript:void(0);" id="suprimerExportation<?= $i ?>" class=" px-2 text-danger" title="Suprimer le transfert"><i class="fa fa-cut"></i></a>
                                                            <?php }?>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <div class="modal-dialog modal-xl modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="myExtraLargeModalLabel">Demander la rectification de ce transfert au prét de l'administrateur</h5>
