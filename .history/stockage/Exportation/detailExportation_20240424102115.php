    ...
    if(isset($_POST['approuveExportationRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            if($resultMatiereArrive){
                $sql1 = "UPDATE `exportationdetails` set `actifapprouvtransfert`=1 where idexportationdetail=$idtransfertDemandeRectifier";
                $db->query($sql1);
    
                //Pour enlever la couleur rouge
                $sql1 = "UPDATE `exportationdetails` set `acceptereceptionmodif`=1 where idexportationdetail=$idtransfertDemandeRectifier";
                $db->query($sql1);
