                                    ...
                                    <div class="modal-body">
                                        <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                            <div class="row">
                                                ...
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y'a une erreur ?> 
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        ...
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="detailExportation.php?idexportation=<?= $_GET['idtransfert'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
