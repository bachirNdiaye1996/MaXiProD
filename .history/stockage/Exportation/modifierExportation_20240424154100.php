            ...
            */
            ...
            if(($nbEpaisseurDepart < $nbbobine) || ($nbbobine == 0)){
                ...
                // |--> Pour le update des nombres de bobines dans matiere
                    ...
                    $pointdepartOld = $_GET['pointdepart'];
                    $epaisseurOld = $_GET['epaisseur'];

                    //Rechercher le nombre de piéces sur le lieu de depart
                        $sqlEpaisseur = "SELECT * FROM `matiere` where `lieutransfert`='$pointdepartOld' and `epaisseur`='$epaisseurOld' and `nbbobineactuel` != 0 and `nbbobineactuel`>=$nbbobine LIMIT 1;";
                        // On prépare la requête
                        $queryEpaisseur = $db->prepare($sqlEpaisseur);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="mb-6 text-start">
                                                    ...
                                                    <input class="form-control designa" type="text" value="<?php echo $row['pointarrive'];?>" name="pointarrive"  placeholder="Taper le point arrive ">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-3">
                                                <div class="mb-6 text-start">
