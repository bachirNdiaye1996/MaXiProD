                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseReception" class="collapse show" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="../stockage/grapheMetalMbao.php">Graphe Metal Mbao</a>
                        </div>
                    </div>
                </li>
            <?php } ?>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../Production/Cranteuse/quart1.php">Quart 1</a>
                            <a class="collapse-item" href="../Production/Cranteuse/quart2.php">Quart 2</a>
                            <a class="collapse-item" href="../Production/Cranteuse/quart3.php">Quart 3</a>
                            <a class="collapse-item" href="../Production/Cranteuse/quart3.php">Etat Production</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div id="chartContainer" style="height: 640px; width: 100%; margin-top:60px"></div>
