                                    ...
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                        <div class="table-responsive">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center d-print-none"><span>
                                                                <input type="checkbox" class="multi_checkbox checkall" style="width: 20px; height: 20px;" name="check<?= $i ?>" value="
                                                                idsupreceptionDetail=<?= $reception['idmatiere'] ?>&idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&epaisseur=<?= $reception['epaisseur'] 
                                                                ?>&nombrebobine=<?= $reception['nbbobine'] ?>&lieutransfert=<?= $reception['lieutransfert'] ?>">
                                                                </span>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="col-md-8 align-items-center mb-3">
                                                <div class="d-flex gap-2 pt-4">
                                                    <a href="detailsReception.php?idreception=<?= $_GET['idreception']?>" class="btn btn-danger w-lg bouton mr-3 ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                                                    <?php if($reception['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveReceptionRectifie<?= $i ?>" class="px-2 ml-5 mt-2" title="Demander l'autorisation de modifier au pret du DSI">
                                                        </a>
                                                        <button class="btn btn-link mult_submit" type="submit" name="submit_mult" value="demandeApprobation" title="Supprimer">
                                                            <span class="text-nowrap"><i class="fas fa-file-signature"></i>&nbsp;Supprimer</span>
                                                        </button>
                                                    <?php }?>
                                                    <?php if($_SESSION['niveau']=='admin'){ ?>
                                                        <a href="javascript:void(0);" class="acceptereceptionmod<?= $i ?> px-2" class="px-2 ml-5 mt-2" title="Permettre au responsable du pont bascule de modifier ou suprimer cette reception">
                                                    ...
                                                    <?php if($_SESSION['niveau']=='pontbascule'){ ?>
                                                        <a href="javascript:void(0);" class="suprimerReception<?= $i ?> px-2 text-danger ml-5 mt-2" title="Suprimer la réception"><i class="fa fa-cut"></i></a>
                                                        <button class="btn btn-link mult_submit" type="submit" name="submit_mult" value="delete" title="Supprimer">
                                                            <span class="text-nowrap"><img src="themes/dot.gif" title="Supprimer" alt="" class="icon ic_b_drop">&nbsp;Supprimer</span>
                                                        </button>
                                                    <?php }?>
