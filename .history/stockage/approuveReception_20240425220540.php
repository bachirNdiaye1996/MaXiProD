    ...
    // L'admin permet de donner la main au responsable du pont bascule
        if(isset($_GET['idmatiereDemandeAccepter'])){
            ...
            <body>
                ...
                ";
            $idRecep = $_GET['idexportationDemandeAccepter'];
            ...
            foreach($UserMails as $user => $item){
                envoie_mail("Gestion de production réctification",$item['email'],"Demande de réctification pour la réception de code de réception REC00-$",$messageD);
            }
