                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($_SESSION['niveau']=='pontbascule'){ ?>
                                                            <td class="text-center d-print-none"><span>
                                                                ...
                                                                idsupreceptionDetail=<?= $reception['idmatiere'] ?>&idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&epaisseur=<?= $reception['epaisseur'] ?>&nombrebobine=<?= $reception['nbbobine'] ?>&lieutransfert=<?= $reception['lieutransfert'] ?>">
                                                                </span>
                                                            </td>
                                                        <?php }?>
                                                        <?php if($_SESSION['niveau']=='admin'){ ?>
