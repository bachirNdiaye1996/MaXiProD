...
//** Fin select des receptions 
    if(isset($_POST['submit_mult_approuve'])){
        print_r($_POST);
    }
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if($i<=1){ ?>
                                                            <form method="post" id="resultsForm_465586843" class="ajax">
                                                        <?php }?>
                                                        ...
                                                        <?php if($_SESSION['niveau']=='admin'){ ?>
                                                            <td class="text-center d-print-none"><span>
                                                                <input type="checkbox" class="multi_checkbox checkall" style="width: 20px; height: 20px;" id="id_rows_to_delete1_left" name="rows_to_delete[0]" value="`matiere`.`idmatiere` = 1">
                                                                </span>
                                                            </td>
                                                        <?php }?>
                                                        <?php if($i<=1){ ?>
                                                                <div class="mb-3 ml-5 mt-2">
                                                                    ...
                                                                    <button class="btn btn-link mult_submit" type="submit" name="submit_mult_approuve" value="edit" title="Éditer">
