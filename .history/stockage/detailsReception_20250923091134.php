                    ...
                    <!-- DataTales Example -->
                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                ...
                                <div class="row m-2">
                                    <form method="post" name="resultsForm" id="" class="ajax">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="d-print-none">
                                                            ...
                                                            <button class="btn btn-link mult_submit" type="submit" name="submit_mult" value="export" title="Exporter">
                                                                <span class="text-nowrap"><img src="themes/dot.gif" title="Exporter" alt="Exporter" class="icon ic_b_tblexport">&nbsp;Approuver</span>
                                                            </button>
                                                        </div>
