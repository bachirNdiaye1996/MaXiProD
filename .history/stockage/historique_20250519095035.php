...
//** Debut select des receptions
    $sql = "SELECT * FROM `matiere` ORDER BY `idmatiere` DESC;";
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" class="link-offset-2 link-underline"><?php echo "REC-0".$reception['idreception']."-BOB-0".$reception['idmatiere'] ?></a>
                                                        </td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"> <?= $reception['epaisseur'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['nbbobine'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['nbbobineactuel'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['poidsdeclare'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['poidspese'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['etatbobine'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['lieutransfert'] ?></td>
                                                        <td style="<?php if($reception['couleurhistorique'] == 1){ echo 'background-color:#D72708 ; color:white;';}elseif($reception['couleurhistorique'] == 2){echo 'background-color:#E17B15 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $reception['dateajout'] ?></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?> 
