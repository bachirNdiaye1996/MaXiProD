                                            ...
                                            <div class="col-md-8 align-items-center mb-3">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    <?php if($reception['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        <button class="btn btn-danger w-lg bouton ml-3" type="submit" name="demandeApprobation" value="demandeApprobation" title="Demander l'autorisation de modifier au pret du DSI">
