                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-1 text-start">
                                                        ...
                                                        <textarea class="form-control"  name="commentaire" rows="4" cols="50" id="validationTextarea" required  placeholder="Commentaire en quelques mots ( pas obligatoire... )"><?= $row['commentaire'] ?></textarea>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="row">
