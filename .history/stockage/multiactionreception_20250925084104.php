                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($reception['actifapprouvreception'] == 0 && ($_SESSION['niveau']=='pontbascule')){?>
                                                            <td class="text-center d-print-none"><span>
                                                                ...
                                                                value="<?= $reception['idmatiere'] ?>&&<?= $_GET['idreception'] ?>&&<?= $reception['epaisseur'] ?>
                                                                    &&<?= $reception['nbbobine'] ?>&&<?= $reception['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                </span>
                                                            </td>
                                                        <?php }?>
                                                        ...
                                                        <?php if($reception['acceptereceptionmodif'] == 1 && $_SESSION['niveau']=='admin'){ ?>
                                                            <td class="text-center d-print-none"><span>
                                                                ...
                                                                <?= $reception['idmatiere'] ?>&&<?= $_GET['idreception'] ?>&&<?= $reception['epaisseur'] ?>
                                                                &&<?= $reception['nbbobine'] ?>&&<?= $reception['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                </span>
                                                            </td>
                                                        <?php }?>
