                                            ...
                                            <div class="col-md-8 align-items-center mb-3">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    <?php if($reception['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        <button class="btn btn-link mult_submit" type="submit" name="demandeApprobation" value="demandeApprobation" title="Demander l'autorisation de modifier au pret du DSI">
                                                            <span class="text-nowrap"><i class="fas fa-file-signature"></i>&nbsp;Demande Approbation</span>
                                                        </button>
                                                    <?php }?>
                                                    <?php if($_SESSION['niveau']=='admin'){ ?>
                                                        <a href="javascript:void(0);" class="acceptereceptionmod<?= $i ?> px-2" class="px-2 ml-5 mt-2" title="">
                                                        </a>
                                                        <button class="btn btn-link mult_submit" type="submit" name="approbation" value="approbation" title="Permettre au responsable du pont bascule de modifier ou suprimer cette reception">
