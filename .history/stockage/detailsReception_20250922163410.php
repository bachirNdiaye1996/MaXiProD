                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="form-check-inline">
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="" id="cocherPontBascule">
                                                                        </label>
                                                                    </div>
                                                                </div>                                                             
                                                            <?php }?>
                                                            <?php if($_SESSION['niveau']=='admin'){ ?>
                                                                <div class="col-md-10">
                                                                    <div class="form-check-inline">
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="cocherAdmin" id="cocherAdmin">
                                                                        </label>
                                                                    </div>
                                                                </div>                                                             
                                                            <?php }?>
                                                        ...
                                                        <td class="text-center d-print-none"><span>
                                                            <input type="checkbox" class="multi_checkbox checkall" id="id_rows_to_delete0_left" name="rows_to_delete[0]" value="`matiere`.`idmatiere` = 1">
                                                            <input type="hidden" class="condition_array" value="{&quot;`matiere`.`idmatiere`&quot;:&quot;= 1&quot;}">
                                                            </span>
                                                        </td>
                                                    </tr>
