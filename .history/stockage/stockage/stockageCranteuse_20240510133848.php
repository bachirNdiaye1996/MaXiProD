                                                                ...
                                                                <div class="card-body">
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <h5 style=""><?= "REC00-".$stock['idmatiere'] ?></h5>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php
                                                                                                $i=0;
                                                                                                foreach($stockCranteuse as $stockdet){
                                                                                                    $i++;
                                                                                                    //if($article['status'] == 'termine'){
                                                                                            ?>
                                                                                                <tr>
                                                                                                    <td style="background-color:#CFFEDA ; text-align: center;">
                                                                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" title="Allez vers la reception correspondante" href="detailsReception.php?idreception=<?= $stockdet['idreception'] ?>" class="link-offset-2 link-underline"><?php echo "REC-0".$stockdet['idreception']."-BOB-0".$stockdet['idmatiereplanifie'] ?></a>
                                                                                                    </td>
                                                                                                    <td style="background-color:#CFFEDA ;"><?php echo "DIA ".$stockdet['epaisseur']." MM" ?></td>
                                                                                                    <td style="background-color:#CFFEDA ;"><?= $stockdet['nbbobine'] ?></td>
                                                                                                    <td style="background-color:#CFFEDA ;"><?= $stockdet['poidsdeclare'] ?></td>
                                                                                                    <td style="background-color:#CFFEDA ;"><?= $stockdet['poidsbrut'] ?></td>
                                                                                                    <td style="background-color:#CFFEDA ;"><?= $stockdet['dateajout'] ?></td>
                                                                                                </tr>
                                                                                            <?php
                                                                                                }
                                                                                            ?> 
