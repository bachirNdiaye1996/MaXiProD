                    ...
                    <div class="col-lg-3 mt-3 mr-5">
                        <div class="">
                            <div class="list-group">
                                ...
                                <a href="stockageTrefilage.php" class="list-group-item list-group-item-action active">MACHINE TREFILAGE</a>
                            </div>
                                <!-- End of Sidebar -->
                            <!-- Page Heading -->
                            <!-- <div class="row">
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" href="javascript:void(0);" data-toggle="modal" data-target="#Information<?php echo $i; ?>" title="Voir details du produit" class="link-offset-2 link-underline"><?php echo "REC00".$stock['idreception']."-BOB-0".$stock['idmatiere'] ?></a>
