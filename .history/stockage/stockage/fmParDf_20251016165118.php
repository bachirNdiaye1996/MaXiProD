                            ...
                            <form method="POST" enctype="multipart/form-data" class="row g-3">
                                <div class="col-md-2 mt-3">
                                    <div class="mb-1 text-start">
                                        <input class="form-control" id="validationDefault01" type="text" name="recherche" value="<?= $row['recherche'] ?>" placeholder="Mettez le DF" required>                                               
                                    </div>
                                </div>
                                <div class="mt-3">                           
                    ...
                    <!-- RECHERCHE -->
                        <div class="mt-5 mr-3">
                            <form method="POST" enctype="multipart/form-data" class="row g-3">
                                ...
                                <hr/>
                                    <a href="pdfProductiviteCrant.php?mois=<?= $moisPourPDF; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
