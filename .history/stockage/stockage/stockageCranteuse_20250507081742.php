    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-lg-8 mt-3 mr-5">
                <ul class="list-group list-group-horizontal mt-4 ml-5">
                <li class="list-group-item"><a href="stockage.php" class="list-group-item list-group-item-action" aria-current="true">METAL 1</a></li>
                <li class="list-group-item"><a href="stockageCranteuse.php" class="list-group-item list-group-item-action active">MACHINE CRANTEUSE</a></li>
