            ...
            <div id="content">
                ...
                <div class="col-lg-12 mt-5 mr-5">
                    <ul class="row list-group-horizontal mt-4 ml-5">
                        ...
                        <li class="list-group mr-4"><a href="fmParDfMetal.php" class="list-group-item list-group-item-action active">FM PAR DF</a></li>
                        <li class="list-group mr-4"><a href="fmParDfNiambour.php" class="list-group-item list-group-item-action active">FM PAR DF</a></li>
                    </ul>
                </div>
                <!-- Begin Page Content -->
