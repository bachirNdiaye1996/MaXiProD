                                                                    ...
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            //** Debut select des receptions
                                                                                $sql = "SELECT * FROM `matiere` where `actif`=1 and `idmatiere`=$IDR;";
                                                                        ...
                                                                        ?>
                                                                            <div class="form-group row">
                                                                                <label for="staticEmail" class="col-sm-4 col-form-label"><h5>Commentaire associé :<?php echo $Reception['idreception']; ?></h5></label>
                                                                                <div class="col-sm-6">
                                                                                    <h5></h5>
                                                                                </div>
                                                                            </div>
