...
// Niambour
    ...
    $sqlepaisseur = "SELECT sum(nbbobineactuel) as som,epaisseur FROM `matiere` where `actif`=1 AND `nbbobineactuel`>0 and `lieutransfert`='Metal Mbao' GROUP BY epaisseur;";
