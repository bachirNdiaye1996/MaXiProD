                                        ...
                                        <div class="col-md-8 align-items-center">
                                            <div class="d-flex gap-2 pt-4">
                                                ...
                                                <?php if($reception['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                    <a style="width: 40px; height: 40px;" href="javascript:void(0);" data-toggle="modal" data-target=".approuveReceptionRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier au pret du DSI">
                                                    <i class="fas fa-file-signature" style="width: 40px; height: 40px;"></i></a>
                                                <?php }?>
                                            </div>
                                        </div>
                                    </div>
