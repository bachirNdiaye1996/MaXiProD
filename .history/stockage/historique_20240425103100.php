                       ...
                       <div class="col-lg-12">
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <a href="ajouterReceptionFormulaire.php?" class="btn btn-success w-lg bouton mr-5"><i class=""></i><h4 class="m-0 font-weight-bold text-primary">Historique bobines réceptionnées</h4></a>
                                    <a href="ajouterReceptionFormulaire.php?" class="btn w-lg bouton"><i class=""></i><h4 class="m-0 font-weight-bold text-primary historiqueCover">Historique bobines transférées</h4></a>
                                </div>
                                <div class="row m-2">
                                        ...
                                        ?>
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    <a href="./.php" class="btn btn-danger w-lg bouton mr-3 ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                                                </div>
                                            </div>
                                        <?php
                                            //}
