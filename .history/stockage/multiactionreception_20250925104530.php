        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if($reception['acceptereceptionmodif'] == 1 && $_SESSION['niveau']=='admin'){ ?>
                                                            <td class="text-center d-print-none"><span>
                                                                <input type="checkbox" class="multi_checkbox checkall" style="width: 20px; height: 20px;" name="check[]" value="
                                                                <?= $reception['idmatiere'] ?>&&<?= $_GET['idreception'] ?>&&<?= $reception['epaisseur'] ?>&&<?= $reception['nbbobine'] ?>&&<?= $reception['lieutransfert'] ?>&&<?php echo $_SESSION['nomcomplet'];?>">
                                                                </span>
                                                            </td>
                                                        <?php }?>
                                                    </tr>
                    ...
                    ?> 
                        <script>    Swal.fire({
                            text: 'Impossible de supprimer une ligne bleu seul une ligne rouge est permise!',
                            icon: 'error',
                            timer: 6000,
                            showConfirmButton: false,
                            });
