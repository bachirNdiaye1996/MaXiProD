                                                        ...
                                                        <?php if($i<=1){ ?>
                                                                <div class="d-print-none">
                                                                    ...
                                                                    <button class="btn btn-link mult_submit" type="submit" name="submit_mult" value="edit" title="Éditer">
                                                                        <span class="text-nowrap"><img src="themes/dot.gif" title="Éditer" alt="Éditer" class="icon ic_b_edit">&nbsp;Approuver</span>
                                                                    </button>

                                                                    <button class="btn btn-link mult_submit" type="submit" name="submit_mult" value="delete" title="Supprimer">
                                                                        <span class="text-nowrap"><img src="themes/dot.gif" title="Supprimer" alt="Supprimer" class="icon ic_b_drop">&nbsp;upprimer</span>
                                                                    </button>
                                                                </div>
                                                            </form>
                                                        <?php }?>
