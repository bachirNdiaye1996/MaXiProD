                                            ...
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                       ...
                                                       <!-- A revoir aprés correction. <a href="multiactionreception.php?idreception=<?= $_GET['idreception']?>" class="btn btn-primary w-lg bouton mr-3 ml-3">Multi-Action<i class="fa fa-angle-double-right ml-2"></i></a> -->
                                                    <?php
                                                        /*$id = $_GET['idreception'];
                                                        $sql = "select * from reception where idreception=$id";
                                                        $result = $db->query($sql);
