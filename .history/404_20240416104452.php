            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">Session expirée</p>
                        <p class="text-gray-500 mb-0">Si votre session est arrivée à expiration, il est impératif de vous reconnecter en cliquant sur le lien ci-dessous...</p>
                        <a class="btn btn-success  w-lg bouton mr-3 mb-5 mt-5" href="../index.php">&larr; Retour à la page de connexion</a>
                    </div>
