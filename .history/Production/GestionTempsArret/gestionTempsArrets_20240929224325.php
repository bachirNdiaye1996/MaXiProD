...
//** Debut select 
    $sql = "SELECT * FROM `gestiontempsarret` where `actif`=1 ORDER BY `idgestiontempsarret` DESC;";
        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilitiesReception" class="collapse show" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php if(isset($activeR)){echo $activeR;} ?>" href="../Reception/reception.php">reception</a>
                </div>
            </div>
        </li>
    <?php } ?>
    ...
    <?php if($_SESSION['niveau'] != 'pontbascule'){ ?>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Les informations :</h6>
                    <a class="collapse-item" href="../Cranteuse/ficheCranteuse.php">Fiches Productions</a>
                    <a class="collapse-item" href="../Cranteuse/etatProduction.php">Etats Productions</a>
                    <a class="collapse-item" href="../Cranteuse/historiqueCranteuse.php">Historiques</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilitiesDresseuse" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Dresseuse/historiqueDresseuse.php">Historiques</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilitiesTrefilage" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Les informations :</h6>
                    <a class="collapse-item" href="../Trefilage/ficheParQuartTrefilage.php">Fiches Productions</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="../../indexPage/ParametreUtilisateur.php?idUser=<?php echo $_SESSION['id']; ?>">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Changer paramétres
                                </a>
                                <?php if($_SESSION['niveau']=='admin'){ ?>
                                    <a class="dropdown-item" href="../../indexPage/utilisateur.php">
                                        <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Liste des temps arrets</h6>
                            </div>
                            <div class="row m-2">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>       
                                                <th>ID temps arrets</th>                                                                                
                                                <th>Libelle arrets</th>
                                                <th>Machine</th>
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                foreach($tempsArrets as $tempsArret){
                                                    $i++;
                                                    //if($article['status'] == 'termine'){<p><a class="" href="#">Underline opacity 0</a></p>
                                            ?>
                                                <tr>
                                                    <td style="background-color:#CFFEDA ;"><?= $tempsArret['idgestiontempsarret'] ?></td>
                                                    <td style="background-color:#CFFEDA ;"><?= $tempsArret['libelletempsarret'] ?></td>
                                                    <td style="background-color:#CFFEDA ;"><?= $tempsArret['machine'] ?></td>
                                                    <td style="background-color:#CFFEDA ;"><?= $tempsArret['dateajout'] ?></td>
                                                    <td style="background-color:#CFFEDA ; text-align: center;">
                                                        <a href="javascript:void(0);" class="suprimerTempsArret<?= $i ?> px-2 text-danger" title="Supprimer l'arret"><i class="fa fa-cut"></i></a>
                                                        <a href="modifierTempsArret.php?idgestiontempsarret=<?= $tempsArret['idgestiontempsarret'] ?>" class="px-2" title="Modifier l'arret"><i class="far fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                                <!-- Pour le sweetAlert Suprimer Utilisateur !-->
                                                    <script>
                                                        ...
                                                        $(document).ready( function(){
                                                            $('.suprimerTempsArret<?= $i ?>').click(function(e) {
                                                                e.preventDefault();
                                                                Swal.fire({
                                                                title: 'En es-tu sure?',
                                                                text: 'Voulez-vous vraiment supprimer cet arret ?',
                                                                icon: 'warning',
                                                                ...
                                                                confirmButtonText: "Supprimer",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'supressionTempsArret.php?idgestiontempsarret=<?= $tempsArret['idgestiontempsarret'] ?>',
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
                                                                                        text: 'Temps arret suprimé avec succes!',
                                                                                        icon: 'success',
                                                                                        timer: 3000,
                                    ...
                                    ?>
                                        <div class="col-md-8 align-items-center">
                                            <div class="d-flex gap-2 pt-4">
                                                ...
                                                ?>
                                                    <a href="./creerTempsArrets.php" class="ajouterReception btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Créer temps arrets</a>
