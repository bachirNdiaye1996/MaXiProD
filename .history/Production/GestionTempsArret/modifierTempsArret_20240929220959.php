                                                                ...
                                                                <tr class="rowClass">
                                                                    ...
                                                                    <td style="background-color:#CFFEDA ;">
                                                                        <div class="col-md-10">
                                                                            <div class="mb-1 text-start">
                                                                                <select class="form-control" name="machine[]">
                                                                                    <option <?php if ( $rowEntete['machine']=="Cranteuse") {echo "selected='selected'";} ?>>Cranteuse</option>
                                                                                    <option <?php if ( $rowEntete['machine']=="Dresseuse") {echo "selected='selected'";} ?>>Dresseuse</option> 
                                                                                    <option <?php if ( $rowEntete['machine']=="Four") {echo "selected='selected'";} ?>>Four</option>
                                                                                    <option <?php if ( $rowEntete['machine']=="Grillage") {echo "selected='selected'";} ?>>Grillage</option>
                                                                                    <option <?php if ( $rowEntete['machine']=="Trefilage") {echo "selected='selected'";} ?>>Trefilage</option>
                                                                                </select>                                                
                                                                            </div>
                                                                        </div>
                                                                    </td>
