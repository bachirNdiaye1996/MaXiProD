                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#CFFEDA ;"><?= $utilisateur['idgestiontempsarret'] ?></td>
                                                    <td style="background-color:#CFFEDA ;"><?= $utilisateur['libelletempsarret'] ?></td>
                                                    <td style="background-color:#CFFEDA ;"><?= $utilisateur['dateajout'] ?></td>
