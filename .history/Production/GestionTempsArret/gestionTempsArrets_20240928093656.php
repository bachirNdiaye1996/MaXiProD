                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="background-color:#CFFEDA ; text-align: center;">
                                                        ...
                                                        <a href="modifierTempsArret.php?idutilisateur=<?= $tempsArret['id'] ?>" class="px-2" title="Modifier l'arret"><i class="far fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                                            ...
                                                            $('.suprimerTempsArret<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Supprimer",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'supressionUtilisateur.php?idutilisateur=<?= $tempsArret['id'] ?>',
                                                                                //data: str,
