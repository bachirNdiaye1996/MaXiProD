                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                foreach($Dresseuses as $cranteuseq1){
                                                    $i++;
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsFicheDresseuse.php?idfichedresseuse=<?= $cranteuseq1['idfichedresseuse'] ?>&quart=<?= $cranteuseq1['quart'] ?>" class="link-offset-2 link-underline"><?php echo "DRES-".$cranteuseq1['idfichedresseuse']; ?></a>
                                                    </td>
