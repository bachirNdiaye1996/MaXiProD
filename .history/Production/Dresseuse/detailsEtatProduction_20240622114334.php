    ...
    /** Dresseuse 1 Q1 */
        ...
        if ($productionDresD1Q1) {
            ...
            //** Debut select de la production (arret)
                $sql = "SELECT * FROM `dresseusearret` where `actif`=1 and `iddresseusearret`=$IdproductiondresD1Q1;";
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            ...
                            <!-- Debut quart1 -->
                            <?php
                                if($productionDresD1Q1 || $productionDresD1Q1){
                            ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <table class="table table-bordered mb-2 col-lg-2" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD1Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD1Q1[0]-1)." H ".$TotalArretHReelD1Q1[1]." min" ?></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD1Q1['compteurdebut'] ?> /  fin : <?= $productionDresD1Q1['compteurfin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD1Q1['controleur1'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD1Q1['controleur2'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD1Q1['observationfin'] ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <?php
                                                                //$TempsFonctionTotal +=  (strtotime($productioncrantC1Q1['heurefinquart']) - strtotime($productioncrantC1Q1['heuredepartquart']));
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD2Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD2Q1[0]-1)." H ".$TotalArretHReelD2Q1[1]." min" ?></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD2Q1['compteurdebut'] ?> /  fin : <?= $productionDresD2Q1['compteurfin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD2Q1['controleur1'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD2Q1['controleur2'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD2Q1['observationfin'] ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($productionsD4Q1 as $productionD4Q1){
                                                                $PoidsProduitTotal += $productionD4Q1['piodstotal'];
                                                                $RebusTotal += $productionD4Q1['dechet'];
                                                        ?>
                                                            <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <?php
                                                                //$TempsFonctionTotal +=  (strtotime($productioncrantC1Q1['heurefinquart']) - strtotime($productioncrantC1Q1['heuredepartquart']));
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD4Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD4Q1[0]-1)." H ".$TotalArretHReelD4Q1[1]." min" ?></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD4Q1['compteurdebut'] ?> /  fin : <?= $productionDresD4Q1['compteurfin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD4Q1['controleur1'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD4Q1['controleur2'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD4Q1['observationfin'] ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($productionsD5Q1 as $productionD5Q1){
                                                                $PoidsProduitTotal += $productionD5Q1['piodstotal'];
                                                                $RebusTotal += $productionD5Q1['dechet'];
                                                        ?>
                                                            <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <?php
                                                                //$TempsFonctionTotal +=  (strtotime($productioncrantC1Q1['heurefinquart']) - strtotime($productioncrantC1Q1['heuredepartquart']));
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD5Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD5Q1[0]-1)." H ".$TotalArretHReelD5Q1[1]." min" ?></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD5Q1['compteurdebut'] ?> /  fin : <?= $productionDresD5Q1['compteurfin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD5Q1['controleur1'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD5Q1['controleur2'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD5Q1['observationfin'] ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($consommationsD6Q1 as $consommationD6Q1){
                                                                $PoidsConsommeTotal += $consommationD6Q1['piodstotal'];
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $consommationD6Q1['piodstotal'] ?></td>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($productionsD6Q1 as $productionD6Q1){
                                                                $PoidsProduitTotal += $productionD6Q1['piodstotal'];
                                                                $RebusTotal += $productionD6Q1['dechet'];
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionD6Q1['piodstotal'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionD6Q1['proddiametre'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionD6Q1['dechet'] ?></td>
                                                            </tr>
                                                        <!-- Pour le sweetAlert approuveTransfert !--> 
                                                        <?php
                                                            }
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <?php
                                                                //$TempsFonctionTotal +=  (strtotime($productioncrantC1Q1['heurefinquart']) - strtotime($productioncrantC1Q1['heuredepartquart']));
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD7Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD6Q1[0]-1)." H ".$TotalArretHReelD6Q1[1]." min" ?></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD6Q1['compteurdebut'] ?> /  fin : <?= $productionDresD6Q1['compteurfin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD6Q1['controleur1'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD6Q1['controleur2'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionDresD6Q1['observationfin'] ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($consommationsD7Q1 as $consommationD7Q1){
                                                            $PoidsConsommeTotal += $consommationD7Q1['piodstotal'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $consommationD7Q1['piodstotal'] ?></td>
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($productionsD7Q1 as $productionD7Q1){
                                                            $PoidsProduitTotal += $productionD7Q1['piodstotal'];
                                                            $RebusTotal += $productionD7Q1['dechet'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD7Q1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD7Q1['proddiametre'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD7Q1['dechet'] ?></td>
                                                        </tr>
                                                    <!-- Pour le sweetAlert approuveTransfert !--> 
                                                    <?php
                                                        }
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php
                                                            //$TempsFonctionTotal +=  (strtotime($productioncrantC1Q1['heurefinquart']) - strtotime($productioncrantC1Q1['heuredepartquart']));
                                                        ?>
                                                        <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD7Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD7Q1[0]-1)." H ".$TotalArretHReelD7Q1[1]." min" ?></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="background-color:#4e73df ; color:white;">Départ : <?= $productionDresD7Q1['compteurdebut'] ?> /  fin : <?= $productionDresD7Q1['compteurfin'] ?></td>
                                                        <td style="background-color:#4e73df ; color:white;"><?= $productionDresD7Q1['controleur1'] ?></td>
                                                        <td style="background-color:#4e73df ; color:white;"><?= $productionDresD7Q1['controleur2'] ?></td>
                                                        <td style="background-color:#4e73df ; color:white;"><?= $productionDresD7Q1['observationfin'] ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
