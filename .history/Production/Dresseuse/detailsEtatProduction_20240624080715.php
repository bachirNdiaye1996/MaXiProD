                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    <!-- Debut D1Q1 -->
                                        ...
                                        ?>
                                            <div class="">
                                                <a href="detailsFicheDresseuse.php?idfichedresseuse=<?= $productionDresD1Q1['idfichedresseuse'] ?>" class="d-inline"><p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-dark" style="">Dresseuse 1</p></a>
                                                <a style="text-decoration: none; font-family: arial; font-size: 30px;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD1Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5 d-inline"><i class="fas fa-comments"></i></a>
                                            </div>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <?php 
                                    /*
                                    //** Debut select de la production (consommation)
                                        $sql = "SELECT * FROM `dresseuseproduction`where idfichedresseuse=$IdproductiondresD1Q1 or idfichedresseuse=$IdproductiondresD2Q1;";
