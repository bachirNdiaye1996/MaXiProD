...
$TotalPoids = 0;
$TotalBarres = 0;
$idlogfichedresseuse = $_GET['idlogfichedresseuse'];  // On recupére l'ID de la fiche log par get
...
//** Debut select de la production (erreur)
    $sql = "SELECT * FROM `logdresseusearret` where `actif`=1 and `idfichedresseuse`=$idlogfichedresseuse ORDER BY `idlogdresseusearret` DESC;";
    ...
    $productionDresseuseArrets = $query->fetchAll();
//** Fin select de la production 

//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logdresseuseconsommation` where `actif`=1 and `idfichedresseuse`=$idlogfichedresseuse ORDER BY `idlogdresseuseconsommation` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logdresseuseproduction` where `actif`=1 and `idfichedresseuse`=$idlogfichedresseuse ORDER BY `idlogdresseuseproduction` DESC;";
...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichedresseuse` where `actif`=1 and `idlogfichedresseuse`=$idlogfichedresseuse";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <img src="../../image/fer-a-beton.jpg" class="img-fluid" alt="" style="border-radius: 50%; margin:20px; opacity: 0.7;" width="200">
                        </div>
                    </div>

                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-end justify-content-end mb-4 mr-3">
                        <a href="pdfLogFicheDresseuse.php?idlogfichedresseuse=<?php echo $_GET['idlogfichedresseuse']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION <?php echo $Dresseuse['machine']; ?></p>
                                <div class="mb-4">
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 10%;"><span class="mr-4">Date : </span> <?php echo $Dresseuse['dateCreation']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-4">Début quart : </span> <?php echo $Dresseuse['heuredepartquart']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;"><span class="mr-4">Fin quart : </span> <?php echo $Dresseuse['heurefinquart']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 8%;"><span class="mr-4">Contrôleurs : </span> <?php echo $Dresseuse['controleur1']." */* ".$Dresseuse['controleur2']?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Quart : </span> <?php echo $Dresseuse['quart']; ?></p>
                                </div>
                                <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 30%;"><span class="mr-4">Compteur Horaire Début : </span> <?php echo $Dresseuse['compteurdebut']; ; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Observations (Début) : </span> <?php echo $Dresseuse['observationdebut']; ; ?></p>
                                <p class="m-0 mt-3  h5 ml-3" style="color: white;"><span class="mr-5">Compteur Horaire Fin : </span> <?php echo $Dresseuse['compteurfin']; ; ?></p>
                            </div>
                                    ...
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                $TotalArretH=0;
                                                foreach($productionDresseuseArrets as $prodcrantq1){
                                                                    ...
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        <?php
                                                                            ...
                                                                            //** Debut select des receptions
                                                                                $sql = "SELECT * FROM `matiere` where `actif`=1 and `numbobine`=$IDM;";
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach($production as $prod){
                                                $TotalPoids += (int)$prod['prodpoids'];
                                                $TotalBarres += (int)($prod['prodnbBarreColis']*$prod['prodnbcolis'])+ (int)$prod['prodnbbarrerestant'];
                                                $i++;
                                                //if($article['status'] == 'termine'){
                                        ?>
                                            <tr>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;" ><span class="mr-4">Vitesse : </span> <?php echo $Dresseuse['vitesse']; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids estimatif travaillé et non noté : </span> <?php echo $Dresseuse['poidsestimetravaillenonnote'] ; ?></p>
                            </div>
                            <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 51.5%;"></p>
                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Observations (Fin) : </span> <?php echo $Dresseuse['observationfin']; ?></p>
                            <?php
                                if(((strtotime($Dresseuse['heurefinquart']) - strtotime($Dresseuse['heuredepartquart'])) > 0)){
                                    $TotalHeureTravaille =  (strtotime($Dresseuse['heurefinquart']) - strtotime($Dresseuse['heuredepartquart']));
                                }else{
                                    $TotalHeureTravaille =  (-strtotime($Dresseuse['heurefinquart']) + strtotime($Dresseuse['heuredepartquart']));
                                }
                            ?>
                    ...
                    <div class="col-md-8 align-items-center mt-5 mb-5">
                        <div class="d-flex gap-2 pt-4">
                                <a href="logFicheDresseuse.php?idfichedresseuse=<?php echo $_GET['idfichedresseuse']; ?>" class="btn btn-danger w-lg bouton ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                        </div>
                    </div> 
                </div> 
            </div><!-- div Content -->
