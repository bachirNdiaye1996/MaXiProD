<?php
    ...
    $pdf->SetFont('Arial','B',10);
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,5,utf8_decode("Total arret : $TotalArretHReelH Heures $TotalArretHReel[1] minutes    Total poids produit : $TotalPoids     Vitesse : $Cranteuse[vitesse]"),0,1,'C');
