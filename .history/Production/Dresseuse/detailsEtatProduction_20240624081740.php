                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <div class="">
                                                ...
                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD2Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline m-5"><i class="fas fa-comments"></i></a>
                                            </div>
