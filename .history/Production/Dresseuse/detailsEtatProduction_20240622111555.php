                                        ...
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-4 col-lg-3" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($consommationsD1Q1 as $consommationD1Q1){
                                                            $PoidsConsommeTotal += $consommationD1Q1['piodstotal'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $consommationD1Q1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $consommationD1Q1['diametre'] ?></td>
                                                        </tr>
                                                    <!-- Pour le sweetAlert approuveTransfert !--> 
                                                    <?php
                                            ...
                                            <table class="table table-bordered mb-2 mr-4 col-lg-4" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($productionsD1Q1 as $productionD1Q1){
                                                            $PoidsProduitTotal += $productionD1Q1['piodstotal'];
                                                            $RebusTotal += $productionD1Q1['dechet'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD1Q1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD1Q1['proddiametre'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD1Q1['dechet'] ?></td>
                                                        </tr>
                                                    <!-- Pour le sweetAlert approuveTransfert !--> 
                                                    <?php
                                                        }
