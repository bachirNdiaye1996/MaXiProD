                ...
                for ($i = 0; $i < count($_POST['diametre']); $i++){   
                    ...
                    if($idConsommation != ""){
                       ...
                       $insertUser->execute(array($diametre,$numerofin,$poids,$dechet,$heuremontagebobine,$idConsommation));
                        ...
                        $insertUser=$db->prepare("INSERT INTO `dresseuseconsommation` (`idcranteuseq1consommation`, `diametre`, `numerofin`, `poids`, `dechet`, `idfichedresseuse`, `actif`,`heuremontagebobine`) 
                        VALUES (NULL, ?, ?, ?, ?, ?, '1', ?);");
