...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if($_SESSION['niveau'] != 'pontbascule'){ ?>
        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilitiesDresseuse" class="collapse show" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Les informations :</h6>
                    <a class="collapse-item <?php if(isset($activeD)){echo $activeD;} ?>" href="./ficheDresseuse.php">Fiches Productions</a>
                    ...
                    <a class="collapse-item <?php if(isset($historique)){echo $historique;} ?>" href="./historiqueDresseuse.php">Historiques</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilitiesDresseuse" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Les informations :</h6>
                    <a class="collapse-item <?php if(isset($activeD)){echo $activeD;} ?>" href="../Trefilage/ficheTrefilage.php">Fiches Productions</a>
                    <a class="collapse-item <?php if(isset($activeEtatProduction)){echo $activeEtatProduction;} ?>" href="../Trefilage/etatProduction.php">Etats Productions</a>
                    <a class="collapse-item <?php if(isset($historique)){echo $historique;} ?>" href="../Trefilage/historiqueTrefilage.php">Historiques</a>
                </div>
            </div>
        </li>
