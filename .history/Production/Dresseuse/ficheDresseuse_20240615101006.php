                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($dresseuse['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?php if($dresseuse['actifapprouvprod'] == 0 && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveProdRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier ou de suprimer cette fiche au prêt du DSI <?php echo ' --> DRES-'.$dresseuse['iddresseuse']; ?>">
