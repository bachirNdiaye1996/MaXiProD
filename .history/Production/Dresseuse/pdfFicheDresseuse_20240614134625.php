<?php
    ...
    //** Debut select de la production (arret)
        $sql = "SELECT * FROM `cranteuseq1arret` where `actif`=1 and `idfichedresseuse`=$idfichedresseuse ORDER BY `idcranteuseq1arret` DESC;";
    ...
    //** Debut select de la production (consommation)
        $sql = "SELECT * FROM `cranteuseq1consommation` where `actif`=1 and `idfichedresseuse`=$idfichedresseuse ORDER BY `idcranteuseq1consommation` DESC;";
    ...
    //** Debut select de la production (consommation)
        $sql = "SELECT * FROM `cranteuseq1production` where `actif`=1 and `idfichedresseuse`=$idfichedresseuse ORDER BY `idcranteuseq1production` DESC;";
    ...
    //** Debut select de la production (echantillon)
        $sql = "SELECT * FROM `cranteuseechantillon` where `actif`=1 and `idfichedresseuse`=$idfichedresseuse ORDER BY `idcranteuseechantillon` DESC;";
