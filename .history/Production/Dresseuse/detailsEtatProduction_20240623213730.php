                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#4e73df ; color:white;">
                                                                <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD1Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD1Q1[0]-1)." H ".$TotalArretHReelD1Q1[1]." min" ?></a>
