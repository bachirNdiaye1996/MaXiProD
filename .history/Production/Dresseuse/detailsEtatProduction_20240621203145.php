...
/** Quart 1 */
    /** Cranteuse1 Q1 */
        ...
        if ($productionDresD1Q1) {
            ...
            $IdproductiondresD1Q1 = $productionDresD1Q1['idfichecranteuseq1'];    // Id de productioncrantC1Q1

            //** Debut select de la production (consommation)
                $sql = "SELECT sum(poids) as piodstotal, diametre, sum(dechet) as dechet FROM `cranteuseq1consommation` where `actif`=1 and `idfichecranteuseq1`=$IdproductiondresD1Q1 GROUP BY `diametre`;";
            ...
            //** Debut select de la production (prod)
                $sql = "SELECT sum(prodpoids) as piodstotal, proddiametre, sum(proddechet) as dechet FROM `cranteuseq1production` where `actif`=1 and `idfichecranteuseq1`=$IdproductiondresD1Q1 GROUP BY `proddiametre`;";
    ...
    /** Fin Cranteuse2 Q1 */
        //** Debut select de la production (Pour cranteuse 2)
            $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `dateCreation`='$datefichedresseuse' and `machine`='cranteuse 2' and `quart`='1';";
...
/** Quart 2 */
    /** Cranteuse1 Q1 */
        //** Debut select de la production (Pour cranteuse 1)
        $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `dateCreation`='$datefichedresseuse' and `machine`='cranteuse 1' and `quart`='2';";
    ...
    /** Debut Cranteuse2 Q2 */
        //** Debut select de la production (Pour cranteuse 2)
            $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `dateCreation`='$datefichedresseuse' and `machine`='cranteuse 2' and `quart`='2';";
...
/** Quart 3 */
    /** Cranteuse1 Q3 */
        //** Debut select de la production (Pour cranteuse 1)
        $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `dateCreation`='$datefichedresseuse' and `machine`='cranteuse 1' and `quart`='3';";
