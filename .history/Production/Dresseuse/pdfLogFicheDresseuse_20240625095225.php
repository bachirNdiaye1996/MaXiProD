<?php
    ...
    $idfichecranteuse = $_GET['idlogfichecranteuse']; 

    //** Debut select de la production (arret)
        $sql = "SELECT * FROM `logcranteusearret` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuse ORDER BY `idlogcranteusearret` DESC;";
    ...
    //** Debut select de la production (consommation)
        $sql = "SELECT * FROM `logcranteuseconsommation` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuse ORDER BY `idlogcranteuseconsommation` DESC;";
    ...
    //** Debut select de la production (consommation)
        $sql = "SELECT * FROM `logcranteuseproduction` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuse ORDER BY `idlogcranteuseproduction` DESC;";
    ...
    //** Debut select de la production (echantillon)
        $sql = "SELECT * FROM `logcranteuseechantillon` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuse ORDER BY `idlogcranteuseechantillon` DESC;";
    ...
    //** Debut select de la production
        $sql = "SELECT * FROM `logfichecranteuse` where `actif`=1 and `idlogfichecranteuse`=$idfichecranteuse";
