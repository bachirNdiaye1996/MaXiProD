                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <?php 
                                    ...
                                    //** Fin select de la production 
                                ?> 
                                    <table class="table table-bordered mb-2 mr-4 col-lg-7 mb-5 ml-5" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>       
                                                            ...
                                                            foreach($consommationTables as $consommation){
                                                                ...
                                                                foreach($dresseuseproductions as $key => $dresseuseproduction){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style='background-color:#4e73df ; color:white;'>".round($dresseuseproduction['prodpoids']/$dresseuseproduction['prodnbcolis'],3)."</td>
