...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichedresseuse` where `idfichedresseuse`=$idfichecranteuseq1 ORDER BY `idlogfichedresseuse` DESC";
                        ...
                        <div class="card position-relative">
                            ...
                            <div class="row m-2">
                                <div class="table-responsive">
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailslogFicheCranteuse.php?idlogfichecranteuse=<?= $cranteuseq1['idlogfichecranteuse'] ?>&quart=<?= $cranteuseq1['quart'] ?>&idfichecranteuseq1=<?php echo $_GET['idfichecranteuseq1'];?>" class="link-offset-2 link-underline"><?php echo "CRAN-".$cranteuseq1['idlogfichecranteuse']; ?></a>
                                                    </td>
                                    ...
                                    <a href="historiqueCranteuse.php" class="btn btn-danger w-lg bouton m-5"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
