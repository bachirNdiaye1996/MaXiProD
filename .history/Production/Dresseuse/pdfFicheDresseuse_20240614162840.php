<?php
    ...
    $pdf->SetFont('Arial','B',10);
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,22,utf8_decode("Total arret : $TotalArretHReelH Heures $TotalArretHReel[1] minutes    Total poids produit : $TotalPoids     Vitesse : $Cranteuse[vitesse]"),0,1,'C');
    $pdf->Cell(190,10,utf8_decode("Temps de fonction : $TotalHeureTravaillerelleH Heures $TotalHeureTravaillerelle[1] min     Total barres produites : $TotalBarres      Poids estimatif travaillé et non noté : $Cranteuse[poidsestimetravaillenonnote] "),0,1,'C');
    $pdf->Cell(190,10,utf8_decode("OBSERVATIONS (FIN) : $Cranteuse[observationfin]"),0,1,'C');
