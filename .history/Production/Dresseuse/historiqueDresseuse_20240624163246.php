                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($dresseuse['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($dresseuse['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsdresseuse.php?idfichedresseuse=<?= $dresseuse['idfichedresseuse'] ?>&quart=<?= $dresseuse['quart'] ?>" class="link-offset-2 link-underline"><?php echo "CRAN-".$dresseuse['idfichedresseuse']; ?></a>
                                                    </td>
                                                    ...
                                                    <td style="background-color:#CFFEDA">
                                                        <?php if(($dresseuse['couleurhistoriquemodif'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="logFicheCranteuse.php?idfichedresseuse=<?= $dresseuse['idfichedresseuse'] ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
