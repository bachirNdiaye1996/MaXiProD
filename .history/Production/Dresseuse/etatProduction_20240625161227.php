...
//** Debut select de la production
    $sql = "SELECT * FROM `fichedresseuse` where `actif`=1 GROUP BY `dateCreation` ORDER BY `idfichedresseuse` DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#CFFEDA; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsEtatProduction.php?dateCreation=<?= $dresseuse['dateCreation'] ?>" class="link-offset-2 link-underline"><?php echo "EtatProd-".$i; ?></a>
                                                    </td>
                                                    ...
                                                    <?php if($_SESSION['niveau'] == 'admin'){ ?>
                                                        <td style="background-color:#CFFEDA;">
                                                            ...
                                                            <?php if(($dresseuse['accepteprodmodif'] == 1) && ($dresseuse['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                                <a href="modifierFicheCranteuse.php?idsupfiche=<?= $dresseuse['idfichecranteuseq1'] ?>&idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                            <?php }?>
                                                            <?php if(($dresseuse['accepteprodmodif'] == 1) && ($dresseuse['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
