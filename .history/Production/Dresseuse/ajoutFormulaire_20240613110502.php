<?php
    ...
    //** Debut select de stockage pour Metal1
        $sqlepaisseur = "SELECT * FROM `cranteuseq1production` where `actif`=1 and `lieutransfert`='Cranteuse'  ORDER BY `idcranteuseq1production` DESC;";
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Production de la machine Cranteuse :</h6>
                            </div>
                            <div class="row m-2">
