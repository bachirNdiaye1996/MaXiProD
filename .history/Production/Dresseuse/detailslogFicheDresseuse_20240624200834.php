...
//** Debut select de la production (erreur)
    $sql = "SELECT * FROM `logdresseusearret` where `actif`=1 and `idlogdresseusearret`=$idlogfichedresseuse ORDER BY `idlogdresseusearret` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logcranteuseconsommation` where `actif`=1 and `idfichecranteuseq1`=$idlogfichedresseuse ORDER BY `idlogcranteuseconsommation` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logcranteuseproduction` where `actif`=1 and `idfichecranteuseq1`=$idlogfichedresseuse ORDER BY `idlogcranteuseproduction` DESC;";
...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichecranteuse` where `actif`=1 and `idlogfichecranteuse`=$idlogfichedresseuse";
