                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($dresseuse['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        ...
                                                        <?php if(($dresseuse['accepteprodmodif'] == 1) && ($dresseuse['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="modifierFicheCranteuse.php?idsupfiche=<?= $dresseuse['idfichedresseuse'] ?>&quart=<?= $dresseuse['quart'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                        <?php }?>
                                                        <?php if(($dresseuse['accepteprodmodif'] == 1) && ($dresseuse['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                ...
                                                <script>
                                                    $(document).ready( function(){
                                                        $('#suprimerFiche<?= $i ?>').click(function(e) {
                                                            console.log(<?= $dresseuse['idfichedresseuse'] ?>);
                                                            e.preventDefault();
                                                            Swal.fire({
                                                            title: 'En es-tu sure?',
                                                            ...
                                                            confirmButtonText: "Supprimer la fiche",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'supressionFiche.php?idsupficheDresseuse=<?= $dresseuse['idfichedresseuse'] ?>&quart=<?= $dresseuse['quart'] ?>',
                                                                            //data: str,
