                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="col-lg-12 mt-5 mb-5">
                                                                    ...
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Opérateur 1</span><span class="mr-5 text-danger"> : <?= $productionDresD1Q1['controleur1'] ?></span></p>
