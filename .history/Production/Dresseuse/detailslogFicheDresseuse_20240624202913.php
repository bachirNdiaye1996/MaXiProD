            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-end justify-content-end mb-4 mr-3">
                        <a href="pdfLogFicheCranteuse.php?idlogfichedresseuse=<?php echo $_GET['idlogfichecranteuse']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
