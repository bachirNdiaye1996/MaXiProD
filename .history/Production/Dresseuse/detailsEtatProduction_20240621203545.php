    ...
    /** Cranteuse1 Q1 */
        ...
        if ($productionDresD1Q1) {
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT sum(poids) as prodstotal, diametre FROM `cranteuseq1consommation` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD1Q1 GROUP BY `diametre`;";
            ...
            //** Debut select de la production (arret)
                $sql = "SELECT * FROM `cranteuseq1arret` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD1Q1;";
            ...
            //** Debut select de la production (prod)
                $sql = "SELECT sum(prodpoids) as piodstotal, proddiametre, sum(proddechet) as dechet FROM `cranteuseq1production` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD1Q1 GROUP BY `proddiametre`;";
