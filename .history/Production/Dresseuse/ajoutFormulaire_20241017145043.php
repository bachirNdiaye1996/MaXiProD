            ...
            // Consommations
                for ($i = 0; $i < count($_POST['diametre']); $i++){   
                    ...
                    if(isset($_POST['finirfm'.$i])){ 
                        $req ="UPDATE cranteuseq1production SET `prodnbbobine`=0, `finirfm`=1 where `idcranteuseq1production`='$idcranteuseq1prod';";
                        //$db->query($req);
        ...
        $(document).ready(function(){  
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="">
                        <div class="mb-1 text-start">
                            <select class="form-control" id="numerofin`+i+`" name="numerofin[]">
                                <option></option> 
                                <?php
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="">
                        <div class="mb-1 text-start ">
                            <select class="form-control designa" name="Prodnumerofin[]" id="numerofinProd`+i+`">
                                <option></option> 
                                <?php
                                    foreach($stockCranteuse as $stock){
                                ?>      
