<?php
    ...
    $pdf->Cell(38,5,utf8_decode('Diamétre'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Numéro fil machine'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Nombre barres par colis'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Nombre de colis'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Nombre barres restant'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Longueur barres'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Total barres'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Poids'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Déchet (KG)'),1,1,'C');
    foreach($productions as $production){        
        $pdf->Cell(38,5,utf8_decode($production['proddiametre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodnumerofin']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodnbBarreColis']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodnbcolis']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodnbbarrerestant']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodlongueurbarre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode(($production['prodnbBarreColis']*$production['prodnbcolis'])+$production['prodnbbarrerestant']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['prodpoids']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['proddechet']),1,1,'C');
    }
