...
/** Quart 2 */
    ...
    /** Dresseuse 5 Q2 */
        ...
        if ($productionDresD5Q2) {
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT * FROM `dresseuseconsommation` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD521;";
...
/** Dresseuse 5 Q1 */
        ...
        if ($productionDresD6Q3) {
            ...
            // Calcul du temps d'arret
                foreach($arretsD6Q3 as $arretD6Q3){
                    if(((strtotime($arretD6Q1['finarret']) - strtotime($arretD6Q3['debutarret'])) > 0)){
    ...
    /** Dresseuse 7 Q3 */
        ...
        if ($productionDresD7Q3) {
            ...
            $IdproductiondresD7Q3 = $productionDresD7Q3['idfichedresseuse'];    // Id de productioncrantC1Q1
                                                    ...
                                                    <table class="table table-bordered mb-2 col-lg-2" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                ?>
                                                                <td style="background-color:#4e73df ; color:white;">
                                                                    <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD1Q3" title="Voir details des temps d'arret" class="link-offset-2 link-underline mb-5"><?= ($TotalArretHReelD1Q1[0]-1)." H ".$TotalArretHReelD1Q1[1]." min" ?></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
