                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#4e73df ; color:white;" class="text-center">
                                                                ...
                                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD1Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5"><i class="fas fa-comments"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <table class="table table-bordered mb-2 mt-2 mr-2 col-lg-12" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"></td>
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                    <div class="modal-content">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="col-lg-12 mt-5 mb-5">
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Compteur Horaire</span><span class="mr-5 text-danger">Départ : <?= $productionDresD1Q1['compteurdebut'] ?> /  fin : <?= $productionDresD1Q1['compteurfin'] ?></span></p>
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Opérateur 1</span><span class="mr-5 text-danger">Départ : <?= $productionDresD1Q1['compteurdebut'] ?> /  fin : <?= $productionDresD1Q1['compteurfin'] ?></span></p>
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Opérateur 2</span><span class="mr-5 text-danger">Départ : <?= $productionDresD1Q1['compteurdebut'] ?> /  fin : <?= $productionDresD1Q1['compteurfin'] ?></span></p>
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Remarques</span><span class="mr-5 text-danger">Départ : <?= $productionDresD1Q1['compteurdebut'] ?> /  fin : <?= $productionDresD1Q1['compteurfin'] ?></span></p>
                                                                </div>
                                                                <div class="col text-center">
                                                                    <a href="" class="btn btn-primary text-center">Retour</a>
                                                                </div>
