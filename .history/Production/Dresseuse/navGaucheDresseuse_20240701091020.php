        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilitiesDresseuse" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php if(isset($activeEtatProduction)){echo $activeEtatProduction;} ?>" href="../TrefilageetatProduction.php">Etats Productions</a>
                    <a class="collapse-item <?php if(isset($historique)){echo $historique;} ?>" href="../TrefilagehistoriqueTrefilage.php">Historiques</a>
                </div>
            </div>
        </li>
