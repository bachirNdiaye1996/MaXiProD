                    ...
                    <div class="">
                        <div class="mb-1 text-start">
                            <select class="form-control" name="numerofin[]">
                                ...
                                ?>                                                                                        
                                    <option value="<?php echo $stock['prodnumerofin'].'/'.$stock['cranteuseq1production']; ?>"> <?php echo $stock['prodnumerofin']; ?></option>                                                                                  
                                <?php
                                    }
                                ?>
                            </select>                                                
                                                                                ...
                                                                                <div class="mb-1 text-start">
                                                                                    <select class="form-control" id="numerofin" name="numerofin[]">
                                                                                        ...
                                                                                        <?php
                                                                                            foreach($stockCranteuse as $stock){
                                                                                        ?>   
                                                                                           <option value="<?php echo $stock['prodnumerofin'].'/'.$stock['cranteuseq1production'].'/'.$stock['proddiametre'].'/'.$stock['prodpoids']; ?>"> <?php echo $stock['prodnumerofin']; ?></option>                                                                                     
                                                                                        <?php
                                                                                            }
                                                                                        ?>
                                                                                    </select>                                                
