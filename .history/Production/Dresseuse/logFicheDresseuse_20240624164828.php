...
//** Debut select de la production
    $sql = "SELECT * FROM `fichedresseuse` where `idfichedresseuse`=$idfichedresseuse ORDER BY `idfichedresseuse` DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($dresseuse['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailslogFicheDresseuse.php?idlogfichedresseuse=<?= $dresseuse['idlogfichedresseuse'] ?>&quart=<?= $dresseuse['quart'] ?>&idfichedresseuse=<?php echo $_GET['idfichedresseuse'];?>" class="link-offset-2 link-underline"><?php echo "DRES-".$dresseuse['idfichedresseuse']; ?></a>
                                                    </td>
