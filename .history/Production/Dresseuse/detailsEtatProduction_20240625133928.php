                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionD1Q1['prodlongueurbarre']." m" ?></td>
                            ...
                            <div class="mb-4 mt-3">
                                ...
                                ?> 
                                    <table class="table table-bordered mb-2 mr-4 col-lg-7" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>       
                                                            <th style='background-color:#4e73df ; color:white;'>Productions (KG)</th>                                                                                
                                                            <th style='background-color:#4e73df ; color:white;'>Diametres</th>
                                                            ...
                                                            <th style='background-color:#4e73df ; color:white;'>Nombre barres restant</th>
                                                        ...
                                                        <?php
                                                            foreach($consommationTables as $consommation){
                                                                //** Debut select de la production (consommation)
                                                                    ...
                                                                    $sql = "SELECT * FROM `dresseuseproduction` where `actif`=1 and `idfichedresseuse`='$idfichedresseuse';";
                                                                    ...
                                                                    //print_r($dresseuseproduction);
                                                                //** Fin select de la production 
                                                                foreach($dresseuseproductions as $key => $dresseuseproduction){
                                                                                                                                        echo ($dresseuseproduction['prodpoids']." ");
                                                                    echo "
                                                                    <tr>
                                ...
                                <p class="m-0 mb-3 h5 d-inline mt-5" style="color: white;  padding-right: 10%;"><span class="mr-4"><span class="mr-4">Temps d'arret total :</span> <?php  $TempsArretTotalReel = explode(":",date("H:i",$TempsArretTotal) );  echo ($TempsArretTotalReel[0]-1)." H ".$TempsArretTotalReel[1]." min"; ?></p>
