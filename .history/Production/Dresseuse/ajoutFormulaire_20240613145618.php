        ...
        $(document).ready(function(){  
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
                            <input class="form-control designa" type="text" name="origine[]" id="example" value="" required>
                        </div>
                    </div>
                </td>
                <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="text" name="origine[]" id="example" value="<?php echo $_POST['origine'][$i]; ?>"  required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
