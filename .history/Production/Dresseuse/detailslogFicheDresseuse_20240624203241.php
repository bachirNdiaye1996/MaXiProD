                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            ...
                            <div class="table-responsive col-lg-7 mt-5">
                                <div class="">
                            ...
                            <div class="table-responsive col-lg-4 mt-5">
                                <div class="">
                                    <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-primary" style="">Echantillons</p>
                                </div>
                                <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>       
                                    ...
                                    <tbody>
                                        <?php
                                            $i=0;
                                            foreach($echantion as $echan){
                                                $i++;
                                                //if($article['status'] == 'termine'){
                                        ?>
                                            <tr>
                                                <td style="background-color:#4e73df ; color:white;"><?= $echan['echandiametre'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $echan['echanlongueur'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $echan['echandf'] ?></td>
                                            </tr>
                                        <?php
                                            }
                                        ?> 
                    ...
                    <div class="col-md-8 align-items-center mt-5 mb-5">
                        <div class="d-flex gap-2 pt-4">
                                <a href="logFicheCranteuse.php?idfichecranteuseq1=<?php echo $_GET['idfichecranteuseq1']; ?>" class="btn btn-danger w-lg bouton ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                        </div>
                    </div> 
                </div> 
            </div><!-- div Content -->
