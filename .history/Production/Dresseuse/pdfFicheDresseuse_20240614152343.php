<?php
    ...
    $pdf->Cell(21,5,utf8_decode('Numéro fil machine'),1,0,'C');
    $pdf->Cell(21,5,utf8_decode('Nombre barres par colis'),1,0,'C');
    $pdf->Cell(21,5,utf8_decode('Nombre de colis'),1,0,'C');
    $pdf->Cell(22,5,utf8_decode('Nombre barres restant'),1,0,'C');
