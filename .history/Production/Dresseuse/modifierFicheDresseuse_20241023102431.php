                            ...
                            if($idConsommation != ""){
                               ...
                               $insertUser->execute(array($diametre,$numerofin,$poids,$heuremontagebobine,$idConsommation));
                                ...
                                if(isset($_POST['suprimerCons'.$i])){
                                    // On le supprime dans la table dresseuseconsommation
                                    ...
                                    // On le supprime dans la table cranteuseq1production
                                    $req ="UPDATE cranteuseq1production SET `prodnbbobine`=0, `actif`=0 where `idcranteuseq1production`='$idcranteuseq1prod';";
                                    //$db->query($req);
