...
/** Quart 1 */
    /** Dresseuse 1 Q1 */
        ...
        if ($productionDresD1Q1) {
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT sum(poids) as piodstotal, diametre FROM `dresseuseconsommation` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD1Q1 GROUP BY `diametre`;";
            ...
            //** Debut select de la production (prod)
                $sql = "SELECT sum(prodpoids) as piodstotal, proddiametre, sum(proddechet) as dechet FROM `dresseuseproduction` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD1Q1 GROUP BY `proddiametre`;";
    ...
    /** Dresseuse 2 Q1 */
        ...
        if ($productionDresD2Q1) {
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT sum(poids) as piodstotal, diametre FROM `dresseuseconsommation` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD2Q1 GROUP BY `diametre`;";
            ...
            //** Debut select de la production (prod)
                $sql = "SELECT sum(prodpoids) as piodstotal, proddiametre, sum(proddechet) as dechet FROM `dresseuseproduction` where `actif`=1 and `idfichedresseuse`=$IdproductiondresD2Q1 GROUP BY `proddiametre`;";
                                ...
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered mb-2 mr-4 col-lg-6" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 col-lg-3" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($consommationsD2Q1 as $consommationD2Q1){
                                                            $PoidsConsommeTotal += $consommationD2Q1['piodstotal'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $consommationD2Q1['piodstotal'] ?></td>
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($productionsD2Q1 as $productionD2Q1){
                                                            $PoidsProduitTotal += $productionD2Q1['piodstotal'];
                                                            $RebusTotal += $productionD2Q1['proddechet'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productionD2Q1['piodstotal'] ?></td>
