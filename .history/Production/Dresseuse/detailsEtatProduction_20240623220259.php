                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#4e73df ; color:white;">
                                                                ...
                                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD2Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5"><i class="fas fa-comments"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#4e73df ; color:white;">
                                                                ...
                                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD4Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5"><i class="fas fa-comments"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#4e73df ; color:white;">
                                                                ...
                                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD5Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5"><i class="fas fa-comments"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-bordered mb-2 col-lg-2" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td style="background-color:#4e73df ; color:white;">
                                                                <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationArretD7Q1" title="Voir details des temps d'arret" class="link-offset-2 link-underline"><?= ($TotalArretHReelD6Q1[0]-1)." H ".$TotalArretHReelD6Q1[1]." min" ?></a>
                                                                <a style="text-decoration: none; font-family: arial; font-size: 30px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationProdD7Q1" title="Voir details les supplémentaires" class="link-offset-2 link-underline mt-5"><i class="fas fa-comments"></i></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
