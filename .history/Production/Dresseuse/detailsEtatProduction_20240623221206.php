                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                    <div class="modal-content">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="col-lg-12 mt-5 mb-5">
                                                                    <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">Compteur Horaire :</span><span class="mr-5 text-primary">Départ : <?= $productionDresD5Q1['compteurdebut'] ?> /  fin : <?= $productionDresD2Q1['compteurfin'] ?></span></p>
