                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            ...
                                                            <tbody id="dynamicaddProductions">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="invisible">
                                                                        <div class="">
                                                                            <input class="form-control designa" type="number" step="0.01" name="idcranteuseq1production[]" id="example" value="<?php echo $rowConsommation['idcranteuseq1consommation']; ?>">
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                }
