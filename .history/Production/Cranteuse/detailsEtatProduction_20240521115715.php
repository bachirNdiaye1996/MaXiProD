                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION </p>
                                <p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;"><span class="mr-4">Date : </span> <?php echo $productioncrantC1Q1['dateCreation']; ?></p>
                                <div class="mb-4">
