                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($productionsC1Q1 as $productionC1Q1){
                                                            $PoidsProduitTotal += $consommationC1Q1['piodstotal'];
                                                    ?>
                                                        <tr>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 20%;"><span class="mr-4"><span class="mr-4">Temps d'arret total :</span> <?php  echo $TempsArretTotal; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Poids total produit : </span> <?php echo $PoidsProduitTotal; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids total consommé : </span> <?php  echo $PoidsConsommeTotal; ?></p>
                            </div>
