            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){  
                ...
                for ($i = 0; $i < count($_POST['diametre']); $i++){   
                    ...
                    $insertUser=$db->prepare("UPDATE `cranteuseq1consommation` SET `diametre`=?, `numerofin`=?, `poids`=?,
                     `dechet`=?, `codeReception`=?, `idfichecranteuseq1`=? where `idcranteuseq1consommation`=?;");
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <div class="">
                                                                            <div class="">
                                                                                <input class="form-control designa" type="number" step="0.01" name="idConsommation[]" id="example" value="<?php echo $_POST['idcranteuseq1consommation']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                                            <button class="btn btn-danger removeConsommations"
