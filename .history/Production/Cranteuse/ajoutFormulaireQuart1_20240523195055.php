<?php
    ...
    $idcranteuseq1 = $_GET['idcranteuseq1'];  // On recupére l'ID idcranteuseq1 par get
    $quart = $_GET['quart'];
    ...
    if(isset($_POST['CreerFicheProduction'])){
        ...
        if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){            
            ...
            header("location: detailsCranteuseQ1.php?idcranteuseq1=$idcranteuseq1&idfichecranteuseq1=$idfichecranteuseq1Max&quart=$quart");
            exit;
        }
    }
