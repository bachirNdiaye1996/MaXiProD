<?php
    ...
    $pdf->Cell(32,5,utf8_decode('Echantillons Longueur'),1,0,'C');
    $pdf->Cell(32,5,utf8_decode('Echantillons Poids'),1,0,'C');
    $pdf->Cell(32,5,utf8_decode('Echantillons Numéro DF'),1,1,'C');
    foreach($productions as $production){        
        ...
        $pdf->Cell(38,5,utf8_decode($production['echanlongueur']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['echanpoids']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['echandf']),1,1,'C');
    }
