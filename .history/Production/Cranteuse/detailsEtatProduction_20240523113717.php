                        ...
                        <div class="card position-relative">
                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    <!-- Page Loader -->
                                    <div class="">
                                        <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-dark" style="">Cranteuse 1</p>
                                    </div>
                                    <?php 
                                        if($productioncrantC1Q1){
                                    ?>
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-3 col-lg-3" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 mr-3 col-lg-3" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 mr-2 col-lg-5" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                ...
                                <div class="table-responsive col-lg-12">
                                    <div class="">
                                        <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-dark" style="">Cranteuse 2</p>
                                    </div>
                                    <?php 
