...
<meta charset="utf-8">
    ...
    <script type="text/javascript"> 
        ...
        $(document).ready(function(){  
            ...
            var j = <?php echo sizeof($rowErreurs); ?>-1; 
                    ...
                    <div class="col-md-10">
                        <div class="form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="suprimerArret`+j+`[]">
                            </label>
                        </div>
                    </div>  
                </td>
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="suprimerConsom`+i+`[]">
                            </label>
                        </div>
                    </div>  
                </td>
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="suprimerProd`+i+`[]">
                            </label>
                        </div>
                    </div>  
                </td>
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="form-check-inline">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="suprimerCons<?php echo $i; ?>[]" <?php if(isset($_POST['finirfm'.$i])){ echo "checked";} ?>>
                                                                                    </label>
                                                                                </div>
                                                                            </div> 
                                                                        </td>
