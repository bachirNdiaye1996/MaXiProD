                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['acceptereception'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsReception.php?idreception=<?= $cranteuseq1['idreception'] ?>" class="link-offset-2 link-underline"><?php echo "REC00-".$cranteuseq1['idreception'] ?></a>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['acceptereception'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        <?= $cranteuseq1['entetedf'] ?>
                                                    </td>
                                                    <td style="font-size:20px; text-align: center; background-color:#CFFEDA; <?php if($cranteuseq1['status'] == "Nouvelle reception"){ echo "color:#FB9324"; ?> <?php }elseif($cranteuseq1['status'] == "Terminée"){ echo "color:#E52503";}else{ echo "color:#7EB003"; ?><?php }?>;">
                                                        <?= $cranteuseq1['status'] ?>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['acceptereception'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        <?= $cranteuseq1['user'] ?>
                                                    ...
                                                    <?php if($_SESSION['niveau'] == 'admin'){ ?>
                                                        <td style="<?php if($cranteuseq1['acceptereception'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>; text-align: center;">
                                                            <?php if($cranteuseq1['actifapprouvreception'] == 0 && $_SESSION['niveau'] == ''){ ?>
                                                            ...
                                                            <?php }?>
                                                            <?php if($cranteuseq1['acceptereception'] == 1 && $_SESSION['niveau'] == 'admin'){ ?>
                                                            ...
                                                            <?php }?>
                                                            <?php if($cranteuseq1['actifapprouvreception'] == 1 && $cranteuseq1['acceptereception'] == 0 && $_SESSION['niveau'] == ''){ ?>
