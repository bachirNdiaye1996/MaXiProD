                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            ...
                            <p class="m-0 mt-3  h5 ml-3 mb-3 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Temps de fonction total : </span> <?php $TotalArretHReelC1Q1 = explode(":",date("H:i",$TotalArretH) ); echo $TempsFonctionTotal; ?></p>
                        </div>
