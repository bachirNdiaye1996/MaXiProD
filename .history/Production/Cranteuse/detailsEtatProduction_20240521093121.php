...
$IdproductioncrantC1Q1 = $productioncrantC1Q1['fichecranteuseq1'];    // Id de productioncrantC1Q1



//** Debut select de la production (consommation)
$sql = "SELECT * FROM `cranteuseq1consommation` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC1Q1;";
...
// On récupère les valeurs dans un tableau associatif
$erreurs = $query->fetchAll();
//** Fin select de la production 

//** Debut select de la production (consommation)
$sql = "SELECT * FROM `cranteuseq1erreur` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC1Q1;";
...
//** Debut select de la production (consommation)
$sql = "SELECT * FROM `cranteuseq1production` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC1Q1;";
...
//** Debut calcul de la production (Pour cranteuse 1)
    foreach ($productioncrantC1Q1 as $key => $valueC1){
    }
//** Fin 

print_r($productioncrantC1Q1);
