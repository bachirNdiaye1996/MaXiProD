    ...
    // L'admin permet de donner la main au responsable du pont bascule
        if(isset($_GET['idcranteuseq1'])){
            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] a approuvé la demande d'autorisation de modifier ou de supprimer la fiche de code : <strong>CRANQ1-$id</strong></p>
            ...
            foreach($UserMails as $user => $item){
                envoie_mail("Gestion de production réctification",$item['email'],"Demande de réctification de la fiche de code TRAN00-$_GET[idexportationDemandeAccepter]",$messageD);
            }
