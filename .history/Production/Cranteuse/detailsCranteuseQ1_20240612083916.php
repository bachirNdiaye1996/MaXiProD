                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <a href="modifierFicheCranteuse.php?idsupfiche=<?= $cranteuseq1['idfichecranteuseq1'] ?>"><p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION <?php echo $Cranteuseq1['machine']; ?></p></a>
                                <div class="mb-4">
