<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        $sql = "select * from cranteuseq1arret where idcranteuseq1arret=$idsupfiche";
        $result = $db->query($sql);
        $rowErreurs = $result->fetchAll();

        $sql = "select * from cranteuseq1consommation where idcranteuseq1consommation=$idsupfiche";
        $result = $db->query($sql);
                                                ...
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-md-2 mr-2 mt-3 mb-5 mr-4">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <input class="form-control" id="validationDefault01" type="text" name="controleur2" value="<?php echo $rowEntete['compteurfin']; ?>" placeholder="Mettez le nom complet du contrôleur 2" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mr-2 mt-3 mb-5 mr-4">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label font-weight-bold text-primary" for="nom">Nom complet du contrôleur 3</label>
                                                            <input class="form-control" id="validationDefault01" type="text" name="controleur3" value="<?php echo $rowEntete['compteurfin']; ?>" placeholder="Mettez le nom complet du contrôleur 3">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 mt-3 mr-4">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <input class="form-control" id="validationDefault03" type="date" name="datecreationfiche" value="<?php echo $rowEntete['compteurfin']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 mr-4">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label font-weight-bold text-primary" for="nom">Heure réelle départ du quart</label>
                                                            <input class="form-control" id="validationDefault03" type="time" name="heuredepartquart" value="<?php echo $rowEntete['compteurfin']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 mr-4">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label font-weight-bold text-primary" for="nom">Heure réelle fin du quart</label>
                                                            <input class="form-control" id="validationDefault03" type="time" name="heurefinquart" value="<?php echo $rowEntete['compteurfin']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 mt-5">
                                                        <div class="mb-5 float-right mr-5">
                                                            ...
                                                            <textarea class="form-control" name="observationdebut" rows="4" cols="120"  placeholder="Mettez ici les observations ( pas obligatoire... )"><?php echo $rowEntete['compteurfin']; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-5 ">
