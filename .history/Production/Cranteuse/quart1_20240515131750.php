                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        <?php if($cranteuseq1['accepteprodmodif'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 0) && ($exportation['actifapprouvexportation'] == 1) && $_SESSION['niveau']=='pontbascule'){ ?>
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 0) && ($cranteuseq1['actifapprouvexportation'] == 1) && $_SESSION['niveau']=='pontbascule'){ ?>
