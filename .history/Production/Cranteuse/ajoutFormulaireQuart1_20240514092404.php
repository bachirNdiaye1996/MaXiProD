                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5 ml-5">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <select class="form-control" name="machine">
                                                                ...
                                                                <option <?php if ( $_POST['machine'][$i]=="Cranteuse 2") {echo "selected='selected'";} ?>>Cranteuse 2</option>
                                                                <option <?php if ( $_POST['machine'][$i]=="Cranteuse 3") {echo "selected='selected'";} ?>>Cranteuse 3</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 mr-4">
