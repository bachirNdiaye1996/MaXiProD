                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8 align-items-center mt-5 mb-5">
                        <div class="d-flex gap-2 pt-4">
                                <a href="logFicheCranteuse.php?idfichecranteuseq1=<?php echo $Cranteuseq1['idfichecranteuseq1']; ?>" class="btn btn-danger w-lg bouton ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                        </div>
                    </div> 
                </div> 
            </div><!-- div Content -->
