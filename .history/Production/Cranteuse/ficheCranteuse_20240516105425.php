                                ...
                                <div class="table-responsive">
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsCranteuseQ1.php?idfichecranteuseq1=<?= $cranteuseq1['idfichecranteuseq1'] ?>&quart=1" class="link-offset-2 link-underline"><?php echo $cranteuseq1['machine']; ?></a>
                                                    </td>
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="ajoutFormulaireQuart1.php?idfichecranteuseq1=<?= $_GET['idfichecranteuseq1']?>&quart=<?= $_GET['quart']?>" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter fiche</a>
                                            <?php
                                                } 
                                            ?>
