                                        ...
                                        <div class="table-responsive col-lg-7">
                                            ...
                                            <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodcrantq1['diametre'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodcrantq1['numerofin'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodcrantq1['poids'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodcrantq1['dechet'] ?></td>
                                                        </tr>
                                                    <!-- Pour le sweetAlert approuveTransfert !--> 
                                                    <?php
                                                        }
