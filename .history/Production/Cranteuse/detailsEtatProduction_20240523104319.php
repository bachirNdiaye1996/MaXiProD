                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    <!-- Page Loader -->
                                    <div class="">
                                        <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-primary" style="">Cranteuse 1</p>
                                    </div>
                                    <?php 
                                        if($productioncrantC1Q1){
                                    ?>
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-3 col-lg-4" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 mr-3 col-lg-4" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 mr-2 col-lg-3" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                        ...
                                        <table class="table table-bordered mb-2 mr-2 col-lg-12" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>       
                                                    <th>Compteur Horaire départ / fin</th>                                                                                
                                                    <th>Opérateur 1</th>
                                                    <th>Opérateur 2</th>
                                                    <th>Remarques</th> 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['compteurdebut'] ?> / <?= $productioncrantC1Q1['compteurfin'] ?></td>
                                                    ...
                                                    <td style="background-color:#4e73df ; color:white;"><?= ($TotalArretHReelC1Q1[0]-1)." H ".$TotalArretHReelC1Q1[1]." min" ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="table-responsive col-lg-6">
                                    <div class="">
                                        <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-primary" style="">Cranteuse 2</p>
                                    </div>
                                    <?php 
                                        if($productioncrantC2Q1){
                                    ?>
                                        <table class="table table-bordered mb-2" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>       
                                                    <th>Consommations (KG)</th>                                                                                
                                                    <th>Diametres</th>
                                        ...
                                        <table class="table table-bordered mb-2" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>       
                                                    <th>Compteur Horaire départ</th>                                                                                
                                                    <th>Compteur Horaire Fin</th>
                                                    <th>Opérateur 1</th>
                                                    <th>Opérateur 2</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC2Q1['compteurdebut'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC2Q1['compteurfin'] ?></td>
                                        ...
                                        <table class="table table-bordered mb-2" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="background-color:#4e73df ; color:white;"><?= ($TotalArretHReelC2Q1[0]-1)." H ".$TotalArretHReelC2Q1[1]." min" ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 20%;"><span class="mr-4"><span class="mr-4">Total arret :</span> <?php   ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Poids total produit : </span> <?php  ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids total consommé : </span> <?php  ?></p>
                            </div>
                            <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 52%;"></p>
                            <p class="m-0 mt-3  h5 ml-3 mb-3" style="color: white;"><span class="mr-5">Temps de fonction : </span></p>
                        </div>
