                        ...
                        <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <p class="m-0 mt-3  h5 ml-3" style="color: white;"><span class="mr-4">Compteur Horaire Fin : </span> <?php echo "7859966777" ; ?></p>
                                    </div>
                                    <div class="row m-2 col-lg-5">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td style="<?php if($transfert['actifapprouvtransfert'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $prodcrantq1['epaisseur'] ?></td>
                                                            <td style="<?php if($transfert['actifapprouvtransfert'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $prodcrantq1['nbbobine'] ?></td>
                                                            <td style="<?php if($transfert['actifapprouvtransfert'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $prodcrantq1['poidsdeclare'] ?></td>
                                                        </tr>
