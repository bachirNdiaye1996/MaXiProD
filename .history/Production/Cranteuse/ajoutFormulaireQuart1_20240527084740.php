        ...
        if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
            ...
            // Echantillons
                for ($i = 0; $i < count($_POST['Echandiametre']); $i++){   
                    ...
                    $insertUser=$db->prepare("INSERT INTO `cranteuseechantillon` (`idcranteuseechantillon`, `echandiametre`, `echanlongueur`, `idfichecranteuseq1`, `actif`,df) 
                    VALUES (NULL, ?, ?, ?, '1', ?);");
                    $insertUser->execute(array($diametre,$poids,$idfichecranteuseq1Max,$df));
                }
            //
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="text" name="Echandf[]" id="example" value="<?php echo $_POST['Echanlongueur'][$i]; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
