                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsEtatProduction.php?dateCreation=<?= $cranteuseq1['dateCreation'] ?>" class="link-offset-2 link-underline"><?php echo $cranteuseq1['dateCreation']; ?></a>
                                                    </td>
