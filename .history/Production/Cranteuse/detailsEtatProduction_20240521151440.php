                                    ...
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['diametre'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['dechet'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['dechet'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
