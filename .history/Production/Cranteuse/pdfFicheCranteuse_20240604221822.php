<?php
    ...
    foreach($consommations as $consommation){        
        $pdf->SetTextColor(0,0,0);
        $pdf->SetFont('Arial','B',8);
        $pdf->Cell(30,5,utf8_decode('D'),1,0,'Diamétre');
        $pdf->Cell(30,5,utf8_decode('Numéro fil machine'),1,0,'C');
        $pdf->Cell(126,5,utf8_decode('Poids'),1,1,'C');
        $pdf->Cell(126,5,utf8_decode('Heure de montage'),1,1,'C');
        $pdf->Cell(126,5,utf8_decode('Déchet'),1,1,'C');


        $pdf->Cell(30,5,utf8_decode($consommation['debutarret']),1,0,'C');
        $pdf->Cell(30,5,utf8_decode($consommation['finarret']),1,0,'C');
        $pdf->Cell(126,5,utf8_decode($consommation['raison']),1,1,'C');
    }
