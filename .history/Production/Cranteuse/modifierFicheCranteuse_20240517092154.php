    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['CreerFicheProduction'])){
            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){  
                ...
                $insertUser=$db->prepare("UPDATE `fichecranteuseq1` SET `idfichecranteuseq1`, `user`, `dateajout`, `quart`, `actif`, `dateCreation`, `compteurdebut`,
                ...
                `observationfin`, `poidsestimetravaillenonnote`, `accepteprodmodif`, `actifapprouvprod`,`idcranteuseq1`;");
