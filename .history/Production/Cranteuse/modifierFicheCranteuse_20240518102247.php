<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if($rowEntete['actifapprouvprod'] == 0 || $rowEntete['actifapprouvprod'] == 0){
        ...
        if(isset($_POST['CreerFicheProduction'])){
            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){  
                ...
                header("location: detailsCranteuseQ1.php?idcranteuseq1=$idcranteuseq1&idfichecranteuseq1=$idsupfiche&quart=$quart");
                exit;
            }
        }
    }
                                                ...
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-md-2 mr-2 mt-3 mb-5 mr-4">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <input class="form-control" id="validationDefault01" type="text" name="controleur3" value="<?php echo $rowEntete['controleur3']; ?>" placeholder="Mettez le nom complet du contrôleur 3">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mr-4 mt-3 mb-5 ml-5">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <select class="form-control" name="machine">
                                                                ...
                                                                <option <?php if ( $rowEntete['machine']=="Cranteuse 3") {echo "selected='selected'";} ?>>Cranteuse 3</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 mr-4">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <textarea class="form-control" name="raisonerreur[]" id="exampleFormControlTextarea1"  rows="2" required><?php echo $rowErreur['raison']; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;" class="text-center"> 
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="codeReception[]" id="example" value="<?php echo $rowConsommation['codeReception']; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
