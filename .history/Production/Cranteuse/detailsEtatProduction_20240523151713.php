                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                                            ...
                                            <table class="table table-bordered mb-2 col-lg-4" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php
                                                            $TempsFonctionTotal =  (strtotime($arretC1Q1['finarret']) - strtotime($arretC1Q1['debutarret']));
                                                            //$TotalArretHReelC1Q1 = explode(":",date("H:i",$TotalArretH) );
                                                        ?>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            ...
                            <p class="m-0 mt-3  h5 ml-3 mb-3 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Temps de fonction total : </span> <?php echo $TempsFonctionTotal; ?></p>
                        </div>
