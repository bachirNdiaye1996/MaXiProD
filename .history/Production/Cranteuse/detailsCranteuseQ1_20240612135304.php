...
$valideTransfert="";
$idmatierearrive="";
$idfichecranteuseq1 = $_GET['idfichecranteuseq1'];  // On recupére l'ID de la réception par get
...
//** Debut select de la production
    $sql = "SELECT * FROM `fichecranteuseq1` where `idfichecranteuseq1`=$idfichecranteuseq1";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-end justify-content-end mb-4 mr-3">
                        <a href="pdfFicheCranteuse.php?idfichecranteuse=<?php echo $_GET['idfichecranteuseq1']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Poids des bobines : </span><?php echo $MatiereDepart['poidsdeclare']; ?></h5></label>
                                                                            <div class="col-sm-4">
                                                                                <h5></h5>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Lieu de la réception : </span><?php echo $Matiere['lieutransfert']; ?></h5></label>
                                                                            <div class="col-sm-4">
                                                                                <h5></h5>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Poids de la bobine déclaré lors du transfert : </span><?php echo $Matiere['poidsdeclare']; ?></h5></label>
                                                                            <div class="col-sm-4">
                                                                                <h5></h5>
                                                                            </div>
                                                                        </div>
