                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsCranteuseQ1.php?idreception=<?= $cranteuseq1['idcranteuseq1'] ?>&quart=1" class="link-offset-2 link-underline"><?php echo "CRANQ1-".$cranteuseq1['idcranteuseq1'] ?></a>
                                                    </td>
