                   ...
                   $insertUser->execute(array($Ruser,$Rquart,$Rdatecreationfiche,$Rcompteurdebut,$Rcompteurfin,$Rcontroleur1,$Rcontroleur2,$Rmachine,$Robservationdebut,$Rheuredepartquart,$Rheurefinquart,$Ruser,$Rvitesse,$Robservationfin,$Rpoidsestimetravaillenonnote,$idsupfiche));
                    ...
                    // Arrets
                        foreach($rowErreurs as $rowErreur => $key){
                            $debutarret=htmlspecialchars( $key['debutarret'][$i]);
                            $finarret=htmlspecialchars($key['finarret'][$i]);
                            $raisonerreur=htmlspecialchars($key['raisonerreur'][$i]);
                    ...
                    // Consommations
                        foreach($rowConsommations as $rowConsommation => $key){
                            $diametre=htmlspecialchars($key['diametre'][$i]);
                            $numerofin=htmlspecialchars($key['numerofin'][$i]);
                            $poids=htmlspecialchars($key['poids'][$i]);
                            $dechet=htmlspecialchars($key['dechet'][$i]);
                            $heuremontagebobine=htmlspecialchars($key['heuremontagebobine'][$i]);
                    ...
                    // Productions
                        foreach($rowProductions as $rowProduction => $key){
                            ...
                            $numerofin=htmlspecialchars($key['Prodnumerofin'][$i]);
                    ...
                    // Echantillons
                        foreach($rowEchantillons as $rowEchantillon => $key){
                            $diametre=htmlspecialchars( $key['Echandiametre'][$i]);
                            $echanlongueur=htmlspecialchars($key['Echanlongueur'][$i]);
                            $df=htmlspecialchars($key['Echandf'][$i]);
