                                                                ...
                                                                <div class="card-body">
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        ...
                                                                        <div class="form-group row mt-5">
                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Nombre de bobine : </span><?php echo "REC00".$Matiere['idreception']."-BOB-0".$Matiere['idmatiere']; ?></h5></label>
                                                                            <div class="col-sm-4">
                                                                                <h5></h5>
                                                                            </div>
                                                                        </div>
