                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="javascript:void(0);" id="suprimerFiche<?= $i ?>" class=" px-2 text-danger" title="Suprimer la fiche"><i class="fa fa-cut"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                                        ...
                                                        $('.suprimerFiche<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Supprimer la fiche",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'supressionReception.php?idsupfiche=<?= $cranteuseq1['idfichecranteuseq1'] ?>',
                                                                            //data: str,
