                                            ...
                                            <div class="row">
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    <div class="col-md-2 ml-5 mt-3">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Compteur début</label>
                                                    ...
                                                    <div class="col-md-2 ml-5 mt-3">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Compteur fin</label>
                                                    ...
                                                    <div class="col-md-2 mr-2 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Nom complet du contrôleur 1</label>
                                                            <input class="form-control" id="validationDefault01" type="text" name="saisisseur" value="" placeholder="Mettez le nom complet du contrôleur" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mr-2 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Nom complet du contrôleur 2</label>
                                                            <input class="form-control" id="validationDefault01" type="text" name="saisisseur" value="" placeholder="Mettez le nom complet du contrôleur" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mr-2 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Nom complet du contrôleur 3</label>
                                                            <input class="form-control" id="validationDefault01" type="text" name="saisisseur" value="" placeholder="Mettez le nom complet du contrôleur" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 ml-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Date de production</label>
                                                ...
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    <div class="col-md-2 mr-5 mt-3 mb-5 ml-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Vitésse</label>
                                                    ...
                                                    <div class="col-md-2 mt-3 mb-5 ">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="nom">Poids estimatif travaillé et non noté </label>
