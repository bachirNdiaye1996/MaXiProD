                        ...
                        <div class="card position-relative">
                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        <div class="">
                                        <a href="ficheCranteuse.php" class="btn btn-danger w-lg bouton ml-3"><p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-dark" style="">Cranteuse 1</p></a>
                                        </div>
