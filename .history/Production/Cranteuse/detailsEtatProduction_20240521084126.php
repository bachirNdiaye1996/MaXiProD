...
//** Debut select de la production (Pour cranteuse 1)
    $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `dateCreation`='$idfichecranteuseq1' and `machine`='cranteuse 1';";
    ...
    $productioncrantC1 = $query->fetchAll();
//** Fin select de la production 

//** Debut calcul de la production (Pour cranteuse 1)
foreach ($productioncrantC1 as $key => $valueC1){
}
//** Fin 

print_r($productioncrantq1);
