                    ...
                    <div class="col-lg-12">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($consommationsC1Q3 as $consommationC1Q3){
                                                            ...
                                                            $RebusTotal += $consommationC1Q13['dechet'];
                                                    ?>
                                                        <tr>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-5">Rebus total : </span> <?php echo ($PoidsConsommeTotal - $PoidsProduitTotal); ?> (KG)</p>
                            </div>
