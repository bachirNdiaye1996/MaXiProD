<?php
    ...
    $pdf->Cell(38,5,utf8_decode('Numéro fil machine'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Poids'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Echantillons Longueur'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Echantillons Poids'),1,0,'C');
    $pdf->Cell(38,5,utf8_decode('Echantillons Numéro DF'),1,1,'C');
