        ...
        if(isset($_POST['CreerFicheProduction'])){
            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){  
                ...
                for ($i = 0; $i < count($_POST['debutarret']); $i++){
                    ...
                    $insertUser=$db->prepare("UPDATE `cranteuseq1arret` SET `debutarret`=?, `finarret`=?, `raison`=? where `idfichecranteuseq1`=?;");
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            ...
                                                            <tbody id="dynamicaddErreurs">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="invisible">
                                                                        <div class="">
                                                                            <input class="form-control designa" type="number" step="0.01" name="iderreur[]" id="example" value="<?php echo $rowConsommation['idcranteuseq1consommation']; ?>">
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                    }
