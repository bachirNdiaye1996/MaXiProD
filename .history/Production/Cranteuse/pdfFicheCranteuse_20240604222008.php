<?php
    ...
    foreach($consommations as $consommation){        
        $pdf->SetTextColor(0,0,0);
        $pdf->SetFont('Arial','B',8);
        $pdf->Cell(38,5,utf8_decode('D'),1,0,'Diamétre');
        ...
        $pdf->Cell(38,5,utf8_decode($consommation['debutarret']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['finarret']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['raison']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['finarret']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['raison']),1,1,'C');
    }
