...
$sql = "SELECT * FROM `cranteuseq1consommation` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC1Q1 ORDER BY `idcranteuseq1consommation` DESC;";
...
//** Debut select de la production (consommation)
$sql = "SELECT * FROM `cranteuseq1erreur` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idcranteuseq1consommation` DESC;";
