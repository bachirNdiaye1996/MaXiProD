                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <select class="form-control" name="numerofin[]" onchange="remplir(this.value);">
                                                                                        <option></option> 
                                                                                        <?php
                                                                                            foreach($stockCranteuse as $stock => $key){
                                                                                                echo "<option value='$key[numbobine]/$key[epaisseur]/$key[poidsdeclare]'></option>";
                                                                                        ?>                                                                                        
                                                                                        <?php
                                                                                            }
                                                                                        ?>
