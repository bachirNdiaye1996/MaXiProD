                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php  echo "background-color:#CFFEDA"; ?>;">
                                                        <?php if(($cranteuseq1['couleurhistoriquemodif'] == 0) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="javascript:void(0);" id="suprimerFiche<?= $i ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
