...
//** Debut select de la production (consommation)
$sql = "SELECT * FROM `cranteuseq1production` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idcranteuseq1consommation` DESC;";
                            ...
                            <div class="table-responsive col-lg-7 mt-5">
                                ...
                                <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information<?php echo $i; ?>" title="Voir details du produit" class="link-offset-2 link-underline"><?= $prod['diametre'] ?></a></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['numerofin'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['poids'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['dechet'] ?></td>
                                            </tr>
                                            <!-- Pour le sweetAlert approuveTransfert !--> 
                                            <div class="modal fade " id="Information<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
