                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        ...
                                                        <?php }?>
                                                        <?php if($cranteuseq1['actifapprouvprod'] == 1 && $_SESSION['niveau']=='admin'){ ?>
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 0) && $_SESSION['niveau']=='chefquart'){ ?>
