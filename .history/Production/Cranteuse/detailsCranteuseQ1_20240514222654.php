                            ...
                            <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div class="mb-4">
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 25%;"><span class="mr-4">Date : </span> <?php echo "24/04/2024" ; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 20%;"><span class="mr-4">Quart : </span> <?php echo "1" ; ?></p>
                                ...
                                <div class="card-footer py-3 mt-5 bg-primary">
                                        <div class="mb-4">
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 25%;"><span class="mr-4"></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 20%;"><span class="mr-4">Quart : </span> <?php echo strtotime("23:50")." ".strtotime("23:10")  ; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Vitesse : </span> <?php echo "Modou Ndiaye ; Papi Diop" ; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids estimatif travaillé et non noté : </span> <?php echo "Modou Ndiaye ; Papi Diop" ; ?></p>
                                        </div>
                                        <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 30%;"><span class="mr-4">Total arret : </span> <?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." H ".$TotalArretHReel[1]." min"; ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Observations (Fin) : </span> <?php echo "Test observations fin" ; ?></p>
                                        <p class="m-0 mt-3  h5 ml-3" style="color: white;"><span class="mr-5">Temps de fonction : </span> <?php echo "  7859966777" ; ?></p>
                                    </div>
                            </div>
                        <?php
                            }else{
