...
/** Quart 1 */
    ...
    /** Fin Cranteuse2 Q1 */
        ...
        if ($productioncrantC2Q1) {
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT sum(poids) as piodstotal, diametre, numerofin, sum(dechet) as dechet FROM `cranteuseq1consommation` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC2Q1 GROUP BY `diametre` ORDER BY `diametre`;";
            ...
            //** Debut select de la production (prod)
                $sql = "SELECT sum(prodpoids) as piodstotal, proddiametre, sum(proddechet) as dechet FROM `cranteuseq1production` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC2Q1 GROUP BY `proddiametre` ORDER BY `proddiametre`;";
