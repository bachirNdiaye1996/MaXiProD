                                                ...
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <textarea class="form-control" name="commentaire" rows="4" cols="100"  placeholder="Commentaire en quelques mots ( pas obligatoire... )"><?= $row['commentaire'] ?></textarea>
                                                        </div>
                                                    </div> 
                                                <?php }else{  // Lorsqu'il y a une erreur ?>
                                                    <div class="col-md-2 mr-2 mt-3 mb-5">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label fw-bold" for="commentaire" >Observations (fin) </label>
                                                            <textarea class="form-control" name="commentaire" rows="4" cols="100"  placeholder="Commentaire en quelques mots ( pas obligatoire... )"><?= $_POST['commentaire'] ?></textarea>
                                                        </div>
                                                    </div> 
                                                <?php } ?>
                                            </div>
