<?php
    ...
    if(isset($_POST['CreerFicheProduction'])){
        ...
        //On verifie avant d'inserer
            if(($compteurfin > $compteurdebut) || ( $heureFinHeure > $heureDebutHeure) || (( $heureFinHeure == $heureDebutHeure)&&( $heureFinMin > $heureDebutMin)) ){
                                ...
                                <div class="modal-content col-lg-12">
                                    ...
                                    <div class="modal-body">
                                        <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                            <div class="row">
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeArret != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        <?php if($ProblemeCompteur == "erreurProblemeCompteur") || ($ProblemeQuart == "")){ ?> 
                                                            <script>    
                                                                Swal.fire({
                                                        ...
                                                        <?php if($ProblemeArret == "erreurProblemeArret"){ ?> 
                                                            <script>    
                                                                Swal.fire({
                                                                    text: "Veiller revoir les heures de depart et d'arrivée des arrets svp!",
                                                                    icon: 'error',
                                                                    timer: 5500,
                                                                    showConfirmButton: false,
                                                                },
