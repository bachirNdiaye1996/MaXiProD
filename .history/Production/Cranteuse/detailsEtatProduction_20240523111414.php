                                    ...
                                    ?>
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered mb-2 mr-3 col-lg-4" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($productioncrantC2Q1 as $productioncrantC2Q1){
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC2Q1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC2Q1['proddiametre'] ?></td>
                                                        </tr>
                                                    <!-- Pour le sweetAlert approuveTransfert !--> 
                                                    <?php
                                                        }
