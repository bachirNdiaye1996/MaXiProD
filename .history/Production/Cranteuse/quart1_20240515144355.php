                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        <?php if($cranteuseq1['accepteprodmodif'] == 0 && $_SESSION['niveau']=='admin'){ ?>
                                                        ...
                                                        <?php if($cranteuseq1['accepteprodmodif'] == 1 && $_SESSION['niveau']=='admin'){ ?>
                                                            <a href="javascript:void(0);" class="accepteExportationmod<?= $i ?> px-2" class="px-2" title="Permettre au responsable du pont bascule de modifier ou suprimer cette fiche">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="">
                                                                            <?php 
                                                                                if($ValideMotification != "errorValideMotif"){ 
                                                                            ?> 
                                                                                <script>    Swal.fire({
