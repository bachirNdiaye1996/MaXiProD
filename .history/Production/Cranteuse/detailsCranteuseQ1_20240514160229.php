                        ...
                        <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div >
                                            <p class="m-0 font-weight-bold mb-3 h5 text-uppercase d-inline" style="color: white;  padding-right: 16%;"><span class="mr-4">Date : </span> <?php echo "24/04/2024" ; ?></p>
                                            <p class="m-0 font-weight-bold mb-3 h5 text-uppercase d-inline" style="color: white; padding-right: 13%;"><span class="mr-4">Quart : </span> <?php echo "1" ; ?></p>
                                            <p class="m-0 font-weight-bold mb-3 h5 text-uppercase d-inline" style="color: white;"><span class="mr-4">Contrôleurs : </span> <?php echo "Modou Ndiaye ; Papi Diop" ; ?></p>
                                        </div>
                                        <p class="m-0 font-weight-bold mb-3 h5 text-uppercase mt-3" style="color: white;"><span class="mr-4">Compteur Horaire Début : </span> <?php echo "Modou Ndiaye ; Papi Diop" ; ?></p>
                                        <p class="m-0 font-weight-bold mb-3 h5 text-uppercase" style="color: white;"><span class="mr-4">Compteur Horaire Fin : </span> <?php echo "Modou Ndiaye ; Papi Diop" ; ?></p>
