...
// Calcul du temps d'arret
    foreach($arretsC1Q1 as $prodcrantq1){
    ...
    $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes";
                                    ...
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['operateur1'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['operateur2'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['piodstotal'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
