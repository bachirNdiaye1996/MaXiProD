                                    ...
                                    <div class="card-footer py-3 mt-5 bg-primary">
                                        ...
                                        <?php
                                            if(((strtotime($Cranteuseq1['heurefinquart']) - strtotime($Cranteuseq1['heuredepartquart'])) > 0)){
                                                $TotalHeureTravaille =  (strtotime($prodcrantq1['heurefinquart']) - strtotime($prodcrantq1['heuredepartquart']));
                                            }else{
                                                $TotalHeureTravaille =  (-strtotime($prodcrantq1['heurefinquart']) + strtotime($prodcrantq1['heuredepartquart']));
                                            }
                                            $TotalHeureTravaillerelle = explode(":",date("H:i",$TotalHeureTravaille - $TotalArretH) ); echo ($TotalHeureTravaillerelle[0]-1)." H ".$TotalHeureTravaillerelle[1]." min";
                                        ?>
