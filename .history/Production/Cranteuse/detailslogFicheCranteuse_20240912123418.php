...
$valideTransfert="";
$idmatierearrive="";
$idfichecranteuseq1 = $_GET['idlogfichecranteuse'];  // On recupére l'ID de la fiche log par get
...
//** Debut select de la production (erreur)
    $sql = "SELECT * FROM `logcranteusearret` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idlogcranteusearret` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logcranteuseconsommation` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idlogcranteuseconsommation` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `logcranteuseproduction` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idlogcranteuseproduction` DESC;";
...
//** Debut select de la production (echantillon)
    $sql = "SELECT * FROM `logcranteuseechantillon` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idlogcranteuseechantillon` DESC;";
...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichecranteuse` where `actif`=1 and `idlogfichecranteuse`=$idfichecranteuseq1";
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION <?php echo $Cranteuseq1['machine']; ?></p>
                                <div class="mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['echanlongueur'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['echanpoids'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['echandf'] ?></td>
                                            </tr>
                                            <!-- Pour le sweetAlert approuveTransfert !--> 
                                            <div class="modal fade " id="Information<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
