                        ...
                        <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div >
                                            <p class="m-0 font-weight-bold mb-3 h6 text-uppercase d-inline" style="color: white;  padding-right: 22%;"><span class="mr-4">Date : </span> <?php echo "Cranteuse 1" ; ?></p>
                                            <p class="m-0 font-weight-bold mb-3 h6 text-uppercase d-inline" style="color: white; padding-right: 15%;"><span class="mr-4">Quart : </span> <?php echo "Cranteuse 1" ; ?></p>
