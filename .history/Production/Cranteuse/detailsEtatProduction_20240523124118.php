                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        ...
                                        <!-- Pour le sweetAlert approuveTransfert !--> 
                                        <div class="modal fade " id="InformationArret" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                            <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                <div class="modal-content">
                                                    <div class="card">
                                                            ...
                                                            <div class="col-lg-12 mt-5 mb-5">
                                                                ...
                                                                <?php
                                                                    foreach($arretsC1Q1 as $arretC1Q1 => $key){
                                                                        ?>
                                                                            <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">De <?= $key['debutarret'] ?></span> <span class="mr-5">à</span> <span class="mr-5"><?= $key['finarret'] ?></span> <span class="mr-5 text-danger"><?= $key['raison'] ?></span></p>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </div>
