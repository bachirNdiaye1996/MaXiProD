                                        ...
                                        <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                            <div class="row">
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-md-2 mt-3 ml-5 mr-5">
                                                        <div class="mb-1 text-start">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-5 float-right">
                                                            ...
                                                            <textarea class="form-control" name="commentaire" rows="4" cols="90"  placeholder="Commentaire en quelques mots ( pas obligatoire... )"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 ">
