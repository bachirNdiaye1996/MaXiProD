<?php
    ...
    foreach($productions as $production){        
        ...
        $pdf->Cell(38,5,utf8_decode($production['diametre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['numerofin']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($production['poids']),1,1,'C');
    }
    ...
    $pdf->Cell(194,10,'',0,1);
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,8,utf8_decode("Echantillons"),0,1,'C');
    $pdf->SetFont('Arial','B',7);
    foreach($echantillons as $echantillon){        
        ...
        $pdf->Cell(38,5,utf8_decode($echantillon['diametre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($echantillon['longueur']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($echantillon['numerodf']),1,1,'C');
    }
