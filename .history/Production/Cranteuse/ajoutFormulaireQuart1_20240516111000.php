<?php
    ...
    $idfichecranteuseq1 = $_GET['idfichecranteuseq1'];  // On recupére l'ID exportation par get
    $quart = $_GET['quart'];
        ...
        if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){            
            $insertUser=$db->prepare("INSERT INTO `fichecranteuseq1` (`idfichecranteuseq1`, `user`, `dateajout`, `quart`, `actif`, `dateCreation`, `compteurdebut`,
             `compteurfin`, `controleur1`, `controleur2`, `controleur3`, `machine`, `observationdebut`, `heuredepartquart`, `heurefinquart`, `saisisseur`, `vitesse`,
              ...
              ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '0', '0', ?);");
            $insertUser->execute(array($user,$quart,$datecreationfiche,$compteurdebut,$compteurfin,$controleur1,$controleur2,$controleur3,$machine,$observationdebut,$heuredepartquart,$heurefinquart,$user,$vitesse,$observationfin,$poidsestimetravaillenonnote,$idcranteuseq1));
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        ...
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="detailsCranteuseQ1.php?idcranteuseq1=<?= $_GET['idfichecranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information<?php echo $i; ?>" title="Voir details du produit" class="link-offset-2 link-underline"><?php echo "BOB-0".$stock['idmatiere']; ?></a>
