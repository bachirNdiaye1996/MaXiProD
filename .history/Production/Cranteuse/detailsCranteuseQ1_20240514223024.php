                        ...
                        ?>
                            <div class="col-lg-12">
                                ...
                                <div class="card-footer py-3 mt-5 bg-primary">
                                        <div class="mb-4">
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 30%;"><span class="mr-4"><span class="mr-4">Total arret :</span> <?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." H ".$TotalArretHReel[1]." min"; ?></p>
