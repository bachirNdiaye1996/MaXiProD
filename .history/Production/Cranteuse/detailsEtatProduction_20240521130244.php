            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <hr>
                        <p class="font-weight-bold  text-center h2 text-uppercase mt-2 mb-2 text-primary">Quart 2</p>
                        <hr>
                        <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-5">
                                    <div class="">
                        ...
                        <hr>
                        <p class="font-weight-bold  text-center h2 text-uppercase mt-2 mb-2 text-primary">Quart 3</p>
                        <hr>
                        <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-5">
                                    <div class="">
