                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="ajoutFormulaireQuart1.php?idcranteuseq1=<?= $_GET['idcranteuseq1']?>&idfichecranteuseq1=<?= $_GET['idcranteuseq1']?>&quart=<?= $_GET['quart']?>" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter une fiche</a>
                                            <?php
                                                } 
                                            ?>
