...
$valideTransfert="";
$idmatierearrive="";
$idfichecranteuseq1 = $_GET['idcranteuseq1'];  // On recupére l'ID de la réception par get
$ValideFiche = "";
...
//Pour send mail approuveProdRectifie
    if(isset($_POST['approuveProdRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            $sql1 = "UPDATE `cranteuseq1` set `actifapprouvprod`=1 where idcranteuseq1=$idcranteuseq1";
            $db->query($sql1);
            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou de supprimer une fiche de production de code de production : <strong>CRANQ1-$idcranteuseq1</strong></p>
...
//** Debut select de la production
    $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `idcranteuseq1`=$idfichecranteuseq1";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        ...
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="modifierExportation.php?idcranteuseq1=<?= $cranteuseq1['idcranteuseq1'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="javascript:void(0);" id="suprimerExportation<?= $i ?>" class=" px-2 text-danger" title="Suprimer la fiche"><i class="fa fa-cut"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                                                    <div class="row">
                                                                        <div class="invisible">
                                                                            <div class="">
                                                                                <input class="" type="text" value="<?= $cranteuseq1['idcranteuseq1'] ?>" name="idcranteuseq1">
                                                                            </div>
                                                                        </div> 
                                                        ...
                                                        $('.suprimerReception<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Supprimer la réception",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'supressionReception.php?idsupreception=<?= $cranteuseq1['idcranteuseq1'] ?>',
                                                                            //data: str,
                                                        ...
                                                        $('.accepteProdmodifmod<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Autoriser la demande",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'autoriserProductionRectifie.php?idcranteuseq1=<?= $cranteuseq1['idcranteuseq1'] ?>',
                                                                            //data: str,
                                                                            success: function( response ) {
                                                                                Swal.fire({
