        ...
        if(isset($_POST['CreerFicheProduction'])){
            ...
            //On verifie avant d'inserer
                ...
                //On vérifie si la fiche existe ou pas
                    $sqlEpaisseur = "SELECT * FROM `fichecranteuseq1` WHERE `actif`=1 AND `quart`='$quart' AND `machine`='$machine' AND `dateCreation`='$datecreationfiche' AND `accepteprodmodif`='$quart' AND `machine`='$machine';";
