<?php
    ...
    foreach($productions as $production){        
        ...
        $pdf->Cell(38,5,utf8_decode($consommation['diametre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['numerofin']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['poids']),1,1,'C');
    }
    ...
    $pdf->SetFont('Arial','B',7);
    foreach($echantillons as $consommation){        
        $pdf->SetTextColor(0,0,0);
        $pdf->SetFont('Arial','B',8);
        $pdf->Cell(38,5,utf8_decode('Diamétre'),1,0,'C');
        ...
        $pdf->Cell(38,5,utf8_decode($consommation['diametre']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['longueur']),1,0,'C');
        $pdf->Cell(38,5,utf8_decode($consommation['numerodf']),1,1,'C');
    }
