<?php
    ...
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,18,utf8_decode("DATE : $Cranteuse[dateCreation]          QUART : $Cranteuse[quart] / $Cranteuse[heuredepartquart] - $Cranteuse[heurefinquart]             CONTROLEURS : $Cranteuse[controleur1] */* $Cranteuse[controleur2]"),0,1,'C');
    $pdf->Cell(190,18,utf8_decode("HORAIRES : $Cranteuse[heuredepartquart]  -  $Cranteuse[heurefinquart]             OBSERVATIONS (DEBUT) : $Cranteuse[controleur1] */* $Cranteuse[controleur2]"),0,1,'C');
