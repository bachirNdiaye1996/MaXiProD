                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color:#CFFEDA">
                                                        <?php if(($cranteuseq1['couleurhistoriquemodif'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="modifierFicheCranteuse.php?idsupfiche=<?= $cranteuseq1['idfichecranteuseq1'] ?>&quart=<?= $cranteuseq1['quart'] ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
