        ...
        //On verifie avant d'inserer
            //if(!empty($_POST['saisisseur'])){
                for ($i = 0; $i < count($_POST['debutarret']); $i++){
                    ...
                    echo $heureFinHeure = $heures[0]; 
                    echo $heureFinMin = $heures[1]; 

                    $heures = explode(":", $debutarret);
                    echo $heureDebutHeure = $heures[0]; 
                    echo $heureDebutMin = $heures[1]; 

                    if(( $heureFinMin > $heureDebutHeure) || (( $heureFinMin == $heureDebutHeure)&&( $heureFinMin > $heureDebutHeure))){
                    }else{
