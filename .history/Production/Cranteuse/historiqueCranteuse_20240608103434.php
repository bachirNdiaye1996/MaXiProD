                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php  echo "background-color:#CFFEDA"; ?>;">
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 0) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart'){ ?>
                                                        ...
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
