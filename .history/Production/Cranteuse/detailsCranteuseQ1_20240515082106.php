                            ...
                            <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div class="mb-4">
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 15%;"><span class="mr-4">Date : </span> <?php echo $Cranteuseq1['dateCreation']; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 15%;"><span class="mr-4">Début quart : </span> <?php echo $Cranteuseq1['machine']; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 15%;"><span class="mr-4">Fin quart : </span> <?php echo $Cranteuseq1['machine']; ?></p>
                                    ...
                                    <div class="card-footer py-3 mt-5 bg-primary">
                                        <div class="mb-4 mt-3">
                                            ...
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids estimatif travaillé et non noté : </span> <?php echo $Cranteuseq1['dateCreation'] ; ?></p>
                                        </div>
                                        <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 52%;"></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Observations (Fin) : </span> <?php echo $Cranteuseq1['dateCreation']; ?></p>
                                        <p class="m-0 mt-3  h5 ml-3 mb-3" style="color: white;"><span class="mr-5">Temps de fonction : </span> <?php echo $Cranteuseq1['dateCreation']; ?></p>
                                    </div>
                            </div>
                        <?php
                            }else{
