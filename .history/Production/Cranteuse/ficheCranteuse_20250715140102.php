            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] c modifier ou de supprimer une fiche de production cranteuse (quart $quart) de code de production : <strong>CRAN-$idfichecranteuseq1</strong></p>
