                                ...
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        ...
                                        <table class="table table-bordered mb-2 mr-2 col-lg-12" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['compteurdebut'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $productioncrantC1Q1['compteurfin'] ?></td>
