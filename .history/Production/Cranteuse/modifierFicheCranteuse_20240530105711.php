    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        if(isset($_POST['CreerFicheProduction'])){
            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart"){  
                ...
                $insertUser->execute(array($user,$quart,$datecreationfiche,$compteurdebut,$compteurfin,$controleur1,$controleur2,$controleur3,$machine,$observationdebut,$heuredepartquart,$heurefinquart,$user,$vitesse,$observationfin,$poidsestimetravaillenonnote));
                ...
                for ($i = 0; $i < count($_POST['diametre']); $i++){   
                    ...
                    if($idConsommation != ""){
                        ...
                        `dechet`=?, `codeReception`=? where `idcranteuseq1consommation`=?;");
                       $insertUser->execute(array($diametre,$numerofin,$poids,$dechet,$codeReception,$idConsommation));
                    }else{
                        ...
                        VALUES (NULL, ?, ?, ?, ?, ?, ?, '1');");
                        $insertUser->execute(array($diametre,$numerofin,$poids,$dechet,$codeReception,$idsupfiche));
                    }
                }
                ...
                <body>
                    <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                        <p align='center' style='margin-top:20px;'>
                            ...
                            <p align='center' style='color:white'>$_SESSION[nomcomplet] a modifié la fiche de production cranteuse (quart $quart) de code de production : <strong>CRANQ1-$idcranteuseq1</strong></p>
                ...
                foreach($UserMails as $user => $item){
                    envoie_mail("Gestion de production modification fiche",$item['email'],"Modification de la fiche de code CRANQ1-$idcranteuseq1",$messageD);
                }

                header("location: detailsCranteuseQ1.php?idcranteuseq1=$idsupfiche");
                exit;
            }
        }
    }
...
<meta charset="utf-8">
    ...
    <script type="text/javascript"> 
        $(document).ready(function(){  
            ...
            <div class="invisible">
                <div class="">
                    <input class="form-control designa" type="number" step="0.01" name="idConsommation[]" id="example" value="">
                </div>
            </div>`
            );});
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            ...
                                                            <tbody id="dynamicaddErreurs">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="invisible">
                                                                        <div class="">
                                                                            <input class="form-control designa" type="number" step="0.01" name="idErreur[]" id="example" value="<?php echo $rowErreur['idcranteuseq1arret']; ?>">
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                    }
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="numerofin[]" id="example" value="<?php echo $rowConsommation['numerofin']; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                    ...
                                                                    <div class="invisible">
                                                                        <div class="">
                                                                            <input class="form-control designa" type="number" step="0.01" name="idConsommation[]" id="example" value="<?php echo $rowConsommation['idcranteuseq1consommation']; ?>">
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                    }
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Proddiametre[]" id="example" value="<?php echo $rowProduction['Proddiametre'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Prodnumerofin[]" id="example" value="<?php echo $rowProduction['Prodnumerofin'][$i]; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Prodpoids[]" id="example" value="<?php echo $rowProduction['Prodpoids'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Echandiametre[]" id="example" value="<?php echo $rowConsommations['Echandiametre']; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Echanlongueur[]" id="example" value="<?php echo $rowConsommations['Echanlongueur']; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="text" name="Echandf[]" id="example" value="<?php echo $rowConsommations['Echandf']; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                            ...
                                                            <tbody id="dynamicaddErreurs">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <div class="invisible">
                                                                            <div class="">
                                                                                <input class="form-control designa" type="number" step="0.01" name="idErreur[]" id="example" value="<?php echo $_POST['idErreur'][$i]; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <td style="background-color:#CFFEDA;" class="text-center"> 
                                                                            <button class="btn btn-danger removeErreurs"
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <div class="invisible">
                                                                            <div class="">
                                                                                <input class="form-control designa" type="number" step="0.01" name="idConsommation[]" id="example" value="<?php echo $_POST['idConsommation'][$i]; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                                            <button class="btn btn-danger removeConsommations"
                                                ...
                                                <div class="col-md-12 text-end">
                                                    <div class="col-md-8 align-items-center col-md-12 text-end"> 
                                                        ...
                                                        <div class="d-flex gap-2 pt-4">                           
                                                            <a href="ficheCranteuse.php?idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>"><input class="btn btn-danger  w-lg bouton mr-3" name=""  value="Annuler"></a>
