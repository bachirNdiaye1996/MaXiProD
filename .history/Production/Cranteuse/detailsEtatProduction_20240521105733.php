...
//** Debut select de la production (consommation)
    $sql = "SELECT sum(poids) as piodstotal FROM `cranteuseq1consommation` where `actif`=1 and `idfichecranteuseq1`=$IdproductioncrantC1Q1 GROUP BY `diametre` ;";
