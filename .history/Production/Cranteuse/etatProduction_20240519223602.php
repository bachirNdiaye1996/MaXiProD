...
//** Debut select de la production
    $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 GROUP BY `dateCreation` ORDER BY `idfichecranteuseq1` DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsEtatProduction.php?idcranteuseq1=<?= $cranteuseq1['idcranteuseq1'] ?>&idfichecranteuseq1=<?= $cranteuseq1['idfichecranteuseq1'] ?>&quart=1" class="link-offset-2 link-underline"><?php echo $cranteuseq1['dateCreation']; ?></a>
                                                    </td>
