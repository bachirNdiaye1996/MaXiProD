                        ...
                        <div class="card position-relative">
                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-5 col-lg-4" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                            ...
                                            <table class="table table-bordered mb-2 mr-5 col-lg-4" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
