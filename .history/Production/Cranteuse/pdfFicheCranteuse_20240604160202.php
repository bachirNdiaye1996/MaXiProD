<?php
    ...
    foreach($arrets as $arret){        
        ...
        $pdf->Cell(194,1,'',0,1);
        $pdf->SetTextColor(50,60,100);
        $pdf->Cell(194,4,utf8_decode("Demande N° "),1,1,'C');
        $pdf->SetTextColor(0,0,0);
        $pdf->SetFont('Arial','B',8);
        $pdf->Cell(10,5,utf8_decode('Début arrets'),1,0);
        $pdf->Cell(10,5,utf8_decode('Fin arrets'),1,0);
        $pdf->Cell(10,5,utf8_decode('Raisons'),1,1);

        $pdf->Cell(124,5,$arret['debutarret'],1,0,'C');
        $pdf->Cell(124,5,utf8_decode($arret['finarret']),1,0,'C');
        $pdf->Cell(124,5,utf8_decode($arret['raison']),1,0,'C');
    }
