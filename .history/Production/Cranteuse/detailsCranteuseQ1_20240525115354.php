...
//** Debut select de la production (echantillon)
    $sql = "SELECT * FROM `cranteuseechantion` where `actif`=1 and `idfichecranteuseq1`=$idfichecranteuseq1 ORDER BY `idcranteuseq1production` DESC;";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="background-color:#4e73df ; color:white;"><?= $consom['nbbobine'] ?></td>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $echan['echanpoids'] ?></td>
                                            </tr>
                                        <?php
                                            }
                                        ?> 
