                                        ...
                                        <div class="col-md-8 align-items-center">
                                            <div class="d-flex gap-2 pt-4">
                                                <?php
                                                    //if($_SESSION['niveau']==''){
                                                ?>
                                                    <a href="javascript:void(0);" class="ajouterReception btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Créer production</a>
                                                <?php
                                                    //} 
                                                ?>
                                        ...
                                        <script>
                                            ...
                                            $(document).ready( function(){
                                                $('.ajouterReception').click(function(e) {
                                                    ...
                                                    Swal.fire({
                                                    title: 'En es-tu sure?',
                                                    text: 'Voulez-vous vraiment créer une production ?',
                                                    icon: 'warning',
                                                    showCancelButton: true,
                                                    confirmButtonColor: '#3085d6',
                                                    cancelButtonColor: '#d33',
                                                    confirmButtonText: "Créer une production",
                                                        ...
                                                        if (result.isConfirmed) {                                                                                                                  
                                                            $.ajax({
                                                                    type: "POST",
                                                                    url: 'creerProctionCranteuse.php?creerProd=true&user='+nomcomplet,
                                                                    //data: str,
                                                                    success: function( response ) {
                                                                        Swal.fire({
