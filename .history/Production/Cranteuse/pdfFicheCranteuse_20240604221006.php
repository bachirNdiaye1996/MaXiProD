<?php
    ...
    foreach($arrets as $arret){        
        ...
        $pdf->Cell(30,5,utf8_decode('Début arrets'),1,0);
        $pdf->Cell(30,5,utf8_decode('Fin arrets'),1,0);
        $pdf->Cell(126,5,utf8_decode('Raisons'),1,1);

        $pdf->Cell(30,5,$arret['debutarret'],1,0,'C');
        ...
        $pdf->Cell(194,14,'',0,1);
        $pdf->SetTextColor(50,60,100);
        $pdf->Cell(80,8,utf8_decode("Géstion des temps d'arret"),0,1,'C');
        $pdf->SetFont('Arial','B',7);
        foreach($arrets as $arret){        
            $pdf->SetTextColor(0,0,0);
            $pdf->SetFont('Arial','B',8);
            $pdf->Cell(20,5,utf8_decode('Début arrets'),1,0);
            $pdf->Cell(20,5,utf8_decode('Fin arrets'),1,0);
            $pdf->Cell(150,5,utf8_decode('Raisons'),1,1);
    
            $pdf->Cell(20,5,$arret['debutarret'],1,0,'C');
            $pdf->Cell(20,5,utf8_decode($arret['finarret']),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($arret['raison']),1,0,'C');    
        }
