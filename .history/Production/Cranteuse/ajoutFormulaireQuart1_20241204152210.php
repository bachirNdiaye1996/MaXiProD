            ...
            <tr id="row'+i+'" class="rowClass">
                    ...
                    <div class="col-md-10">
                        <div class="form-check-inline">
                            <label class="form-check-label">
                                <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="" id="finirfm`+i+`" value="">
                            </label>
                        </div>
                    </div>  
                </td>
                `+foo1+`
                    $('#finirfm`+i+`').click(function(){
                        ...
                        $('#finirfm`+i+`').attr('value', 'on');
                    });
                    $('#finirfmactif`+i+`').click(function(){
                        $('#finirfmactif`+i+`').attr('name', '');
                        $('#finirfmactif`+i+`').attr('id', 'finirfm`+i+`');
                        $('#finirfm`+i+`').attr('value', '');
                    });
                `+foo2+`
                <td style="background-color:#CFFEDA ;" class="text-center"> 
