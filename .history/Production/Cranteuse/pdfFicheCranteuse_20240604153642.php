<?php
    ...
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,18,utf8_decode("DATE : $Cranteuse[dateCreation]          QUART : $Cranteuse[quart]  $Cranteuse[heuredepartquart]-$Cranteuse[heuredepartquart]             CONTROLEURS : $Cranteuse[controleur1] */* $Cranteuse[controleur2]"),0,1,'C');
