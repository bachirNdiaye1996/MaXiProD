                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($cranteuseq1['actif'] == 1){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FFBD6E"; ?><?php }?>;">
                                                        <?php if($cranteuseq1['accepteprodmodif'] == 0 && $_SESSION['niveau']=='admin'){ ?>
                                                            <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveReceptionRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier ou de suprimer cette fiche au prêt du DSI">
