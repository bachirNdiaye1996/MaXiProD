<?php
    ...
    $pdf->Cell(190,2,utf8_decode("Temps de fonction : $TotalHeureTravaillerelleH Heures $TotalHeureTravaillerelle[1] min              OBSERVATIONS (DEBUT) : $Cranteuse[observationdebut]"),0,1,'C');
