                                                ...
                                                <?php if($valideExportation != "erreurEpaisseur" && $ProblemeNbBobineDepart != "erreurProblemeNbDepart"){ // Lorsqu'il y a pas de erreur ?> 
                                                    <div class="col-md-2 ml-5 mt-3">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <input class="form-control" id="validationDefault02" type="number" step="0.01" name="transporteur" value="" placeholder="Mettez le nom complet du transporteur" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 ml-5 mt-3">
                                                        <div class="mb-1 text-start">
