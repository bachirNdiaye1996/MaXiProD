                                                            ...
                                                            <div class="col-lg-12 mt-5 mb-5">
                                                                ...
                                                                <?php
                                                                    foreach($arretsC1Q1 as $arretC1Q1, $key){
                                                                        ?>
                                                                            <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-2 text-primary">De <?= $productioncrantC1Q1['controleur1'] ?> à <?= $productioncrantC1Q1['controleur1'] ?> : <?= $productioncrantC1Q1['controleur1'] ?></p>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </div>
