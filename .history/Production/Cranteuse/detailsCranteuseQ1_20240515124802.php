                                ...
                                <div class="card position-relative">
                                    ...
                                    <div class="row m-1 mb-3 col-lg-12">
                                        <div class="table-responsive col-lg-5">
                                            ...
                                            <!-- Page Loader -->
                                            <div class="">
                                                <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-2 text-primary" style="">Géstion des erreurs</p>
                                            </div>
                                    ...
                                    <!-- Tableau d'en bas -->
                                        ...
                                        <div class="table-responsive col-lg-7">
                                            <div class="">
                                                <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-5 text-primary" style="">Consommations</p>
                                            </div>
                                            <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
