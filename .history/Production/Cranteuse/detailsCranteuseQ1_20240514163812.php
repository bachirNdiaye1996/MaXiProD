                        ...
                        <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <p class="m-0 mb-3 h5 d-inline float-right" style="color: white;"><span class="mr-4">Observations (Début) : </span> <?php echo "Test observations début Test observations début Test observations début Test observations début Test observations début Test observations début Test observations début" ; ?></p>
