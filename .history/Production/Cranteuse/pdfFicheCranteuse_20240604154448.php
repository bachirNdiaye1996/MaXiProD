<?php
    ...
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,5,utf8_decode("DATE : $Cranteuse[dateCreation]          QUART : $Cranteuse[quart] / $Cranteuse[heuredepartquart] - $Cranteuse[heurefinquart]             CONTROLEURS : $Cranteuse[controleur1] */* $Cranteuse[controleur2]"),0,1,'C');
