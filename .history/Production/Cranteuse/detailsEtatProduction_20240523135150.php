                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 20%;"><span class="mr-4"><span class="mr-4">Temps d'arret total :</span> <?php  $TotalArretHReelC1Q1 = explode(":",date("H:i",$TotalArretH) );  echo $TempsArretTotal; ?></p>
