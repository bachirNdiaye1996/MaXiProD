                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <select class="form-control" id="numerofin" name="numerofin[]" onchange="remplir(this.value);">
                                                                                        <option></option> 
                                                                                        <?php
                                                                                            foreach($stockCranteuse as $stock){
                                                                                        ?>   
                                                                                           <option value="<?php echo $stock['numbobine'].$stock['numbobine'].$stock['numbobine']; ?>"> <?php echo $stock['numbobine']; ?></option>                                                                                     
                                                                                        <?php
                                                                                            }
                                                                                        ?>
                                                                                    </select>                                                
