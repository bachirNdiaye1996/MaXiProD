                                ...
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;"><span class="mr-4">Début quart : </span> <?php echo $Cranteuseq1['debutquart']; ?></p>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;"><span class="mr-4">Fin quart : </span> <?php echo $Cranteuseq1['finquart']; ?></p>
                                    ...
                                    <div class="card-footer py-3 mt-5 bg-primary">
                                        ...
                                        <p class="m-0 mt-3  h5 ml-3 mb-3" style="color: white;"><span class="mr-5">Temps de fonction : </span> <?php echo " A remplir "; ?></p>
                                    </div>
                            </div>
                        <?php
                            }else{
