                        ...
                        ?>
                            <div class="col-lg-12">
                                ...
                                <div class="card-footer py-3 mt-5 bg-primary">
                                        ...
                                        <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 30%;"><span class="mr-4">Total arret : </span> <?php $dStart = new DateTime("H,i,s",'23:52');
$dEnd = new DateTime("H,i,s",'00:20');
