...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php if($_GET['quart'] == 1){$activeQ1 = "active";}elseif($_GET['quart'] == 2){$activeQ2 = "active";}else{$activeQ3 = "active";} ?>
                                                                    ...
                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                        <?php
                                                                            ...
                                                                            //** Debut select des receptions
                                                                                $sql = "SELECT * FROM `matiere` where `actif`=1 and `numerofin`=$IDM;";
