...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichecranteuse` where `idcranteuseq1`=$idfichecranteuseq1 ORDER BY `idlogfichecranteuse` DESC";
                    ...
                    <div class="mt-5 mb-3 col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Historique des fiches de production de la section cranteuse</h6>
                            </div>
                            <div class="row m-2">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsCranteuseQ1.php?idfichecranteuseq1=<?= $cranteuseq1['idlogfichecranteuse'] ?>&quart=<?= $cranteuseq1['quart'] ?>" class="link-offset-2 link-underline"><?php echo "CRAN-".$cranteuseq1['idlogfichecranteuse']; ?></a>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $cranteuseq1['machine'] ?>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $cranteuseq1['user'] ?>
                                                    ...
                                                    <td style="background-color:#CFFEDA">
                                                        <?php if(($cranteuseq1['couleurhistoriquemodif'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="logFicheCranteuse.php?idfichecranteuseq1=<?= $cranteuseq1['idfichecranteuseq1'] ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
