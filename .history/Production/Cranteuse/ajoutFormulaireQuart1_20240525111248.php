        ...
        if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
            ...
            // Consommations
                for ($i = 0; $i < count($_POST['diametre']); $i++){   
                    ...
                    $insertUser=$db->prepare("INSERT INTO `cranteuseq1consommation` (`idcranteuseq1consommation`, `diametre`, `numerofin`, `poids`, `dechet`, `idfichecranteuseq1`, `actif`) 
                    VALUES (NULL, ?, ?, ?, ?, ?, '1');");
                    $insertUser->execute(array($diametre,$numerofin,$poids,$dechet,$idfichecranteuseq1Max));
                }
            //
            ...
            // Productions
                for ($i = 0; $i < count($_POST['Proddiametre']); $i++){   
                    ...
                    VALUES (NULL, ?, ?, ?, ?, '1');");
                    $insertUser->execute(array($diametre,$numerofin,$poids,$idfichecranteuseq1Max));
                }
            //
            ...
            // Echantillons
                for ($i = 0; $i < count($_POST['Echandiametre']); $i++){   
                    ...
                    $poids=htmlspecialchars($_POST['Echanpoids'][$i]);


                    $insertUser=$db->prepare("INSERT INTO `cranteuseechantillon` (`idcranteuseechantillon`, `echandiametre`, `echanpoids`, `idfichecranteuseq1`, `actif`) 
                    VALUES (NULL, ?, ?, ?, '1');");
                    $insertUser->execute(array($diametre,$poids,$idfichecranteuseq1Max));
                }
            //
        ...
        $(document).ready(function(){  
            ...
            <tr id="row'+i+'" class="rowClass">
                ...
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
                            <input class="form-control designa" type="number" step="0.01" name="Echanpoids[]" id="" value="">
                        </div>
                    </div>
                </td>
                <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Echanpoids[]" id="example" value="">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                ...
                                                <?php }else{  // Lorsqu'il y a une erreur ?>
                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5 ml-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label font-weight-bold text-primary" for="nom">Quart</label>
                                                            <select class="form-control" name="quart">
                                                                <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>1</option>
                                                                <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>2</option>
                                                                <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>3</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 mt-5">
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <select class="form-control" name="raisonerreur[]">
                                                                                        <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>Raison 1</option>
                                                                                        <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>Raison 2</option>
                                                                                        <option <?php if ( $_POST['machine']=="Cranteuse 1") {echo "selected='selected'";} ?>>Raison 3</option> 
                                                                                    </select>                                                
                                                                                </div>
                                                                            </div>
                                                                        </td>
