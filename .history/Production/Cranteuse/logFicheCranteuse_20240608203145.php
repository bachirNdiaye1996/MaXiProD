                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailslogFicheCranteuse.php?idfichecranteuseq1=<?= $cranteuseq1['idlogfichecranteuse'] ?>&quart=<?= $cranteuseq1['quart'] ?>" class="link-offset-2 link-underline"><?php echo "CRAN-".$cranteuseq1['idlogfichecranteuse']; ?></a>
                                                    </td>
