<?php
    ...
    $pdf->Cell(190,18,"FICHE DE PRODUCTION $Cranteuse[machine]",0,0,'C');
    $pdf->SetFont('Arial','B',8);
    $pdf->SetTextColor(50,60,100);
    $pdf->Cell(190,18,utf8_decode("DATE : $Cranteuse[dateCreation]          QUART : $Cranteuse[quart]                 CONTROLEURS : $Cranteuse[controleur1] */* $Cranteuse[controleur2]"),0,0,'C');
