        ...
        <li class="nav-item active">
            ...
            <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php if(isset($activeQ1)){echo $activeQ1;} ?>" href="./quart1.php">Quart 1</a>
                    <a class="collapse-item <?php if(isset($activeQ2)){echo $activeQ2;} ?>" href="./quart2.php">Quart 2</a>
                    <a class="collapse-item <?php if(isset($activeQ3)){echo $activeQ3;} ?>" href="./quart3.php">Quart 3</a>
                    <a class="collapse-item <?php if(isset($activeEtatProduction)){echo $activeEtatProduction;} ?>" href="./etatProduction.php">Etat Production</a>
                </div>
            </div>
        </li>
