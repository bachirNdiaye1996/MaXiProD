...
$valideTransfert="";
$idmatierearrive="";
$idcranteuseq1 = $_GET['idcranteuseq1'];  // On recupére l'ID  par get
$quart = $_GET['quart'];  // On recupére l'ID  par get
$ValideFiche = "";
    ...
    if(isset($_POST['approuveProdRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            <body>
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou de supprimer une fiche de production cranteuse (quart $quart) de code de production : <strong>CRANQ1-$idcranteuseq1</strong></p>
            ...
            foreach($UserMails as $user => $item){
                envoie_mail("Gestion de production réctification",$item['email'],"Demande de réctification pour la fiche de code CRANQ1-$idcranteuseq1",$messageD);
            }
...
//** Debut select de la production
    $sql = "SELECT * FROM `fichecranteuseq1` where `actif`=1 and `idcranteuseq1`=$idcranteuseq1";
                    ...
                    <div class="mt-5 mb-3 col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Listes des fiches pour la section cranteuse (Quart 1) </h6>
                            </div>
                            <div class="row m-2">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($cranteuseq1['accepteprodmodif'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsCranteuseQ1.php?idcranteuseq1=<?= $cranteuseq1['idcranteuseq1'] ?>&idfichecranteuseq1=<?= $cranteuseq1['idfichecranteuseq1'] ?>&quart=1" class="link-offset-2 link-underline"><?php echo $cranteuseq1['machine']; ?></a>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['accepteprodmodif'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>;">
                                                        <?= $cranteuseq1['user'] ?>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['accepteprodmodif'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>;">
                                                        <?= $cranteuseq1['dateajout'] ?>
                                                    </td>
                                                    <td style="<?php if($cranteuseq1['accepteprodmodif'] == 0 && $cranteuseq1['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>;">
                                                    ...
                                                    <td style="<?php if($cranteuseq1['accepteprodmodif'] == 0 && $cranteuseq1['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?php if($cranteuseq1['actifapprouvprod'] == 0 && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveProdRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier ou de suprimer cette fiche au prêt du DSI">
                                                        ...
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="modifierFicheCranteuse.php?idsupfiche=<?= $cranteuseq1['idfichecranteuseq1'] ?>&idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                        <?php }?>
                                                        <?php if(($cranteuseq1['accepteprodmodif'] == 1) && ($cranteuseq1['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                        ...
                                                        $('#suprimerFiche<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Supprimer la fiche",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'supressionFiche.php?idsupfiche=<?= $cranteuseq1['idfichecranteuseq1'] ?>&idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>',
                                                                            //data: str,
                                                        ...
                                                        $('.accepteProdmodifmod<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Autoriser la demande",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'autoriserProductionRectifie.php?idfichecranteuseq1=<?= $cranteuseq1['idfichecranteuseq1'] ?>&idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>',
                                                                            //data: str,
                                                                            success: function( response ) {
                                                                                Swal.fire({
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="ajoutFormulaireQuart1.php?idcranteuseq1=<?= $_GET['idcranteuseq1']?>&idfichecranteuseq1=<?= $_GET['idcranteuseq1']?>&quart=<?= $_GET['quart']?>" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i> Ajouter fiche</a>
                                            <?php
                                                } 
                                            ?>
