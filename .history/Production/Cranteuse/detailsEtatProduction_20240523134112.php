...
/** Cranteuse1 Q1 */
    ...
    // Calcul du temps d'arret
        ...
        $TempsArretTotal += $TempsArretTotal + $TotalArretH;
...
/** Fin Cranteuse2 Q1 */
    ...
    // Calcul du temps d'arret
        ...
        $TempsArretTotal += $TempsArretTotal + $TotalArretH;             //Calcul du temps d'arret
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 20%;"><span class="mr-4"><span class="mr-4">Temps d'arret total :</span> <?php   ?></p>
                            ...
                            <p class="m-0 mt-3  h5 ml-3 mb-3 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Temps de fonction total : </span></p>
                        </div>
