                                                            ...
                                                            <div class="col-lg-12 mt-5 mb-5">
                                                                ...
                                                                <?php
                                                                    foreach($arretsC1Q1 as $arretC1Q1 => $key){
                                                                        ?>
                                                                            <p class="m-0 font-weight-bold text-center h4 mt-2 text-primary"><span class="mr-5">De <?= $key['debutarret'] ?></span> <span>à</span> <span class="mr-5"><?= $key['finarret'] ?></span> <span class="mr-5 text-danger"><?= $key['raison'] ?></span></p>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </div>
