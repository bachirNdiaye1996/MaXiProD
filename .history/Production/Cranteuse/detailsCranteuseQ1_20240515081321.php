                            ...
                            <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <div class="mb-4">
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 15%;"><span class="mr-4">Date : </span> <?php echo $Cranteuseq1['machine']; ?></p>
                                            ...
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Contrôleurs : </span> <?php echo $Cranteuseq1['operateur1']." / ".$Cranteuseq1['operateur2']." / ".$Cranteuseq1['operateur3']; ?></p>
                                        </div>
