                        ...
                        <div class="col-lg-12">
                                <div class="card position-relative">
                                    <div class="card-header py-3 bg-primary">
                                        ...
                                        <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white;"><span class="mr-4">Compteur Horaire Début : </span> <?php echo "7859966633" ; ?></p>
                                        <p class="m-0 mb-3 h5 " style="color: white;  padding-right: 25%;"><span class="mr-4">Date : </span> <?php echo "24/04/2024" ; ?></p>
                                        <p class="m-0 mb-3 h5 ml-3" style="color: white;"><span class="mr-4">Compteur Horaire Fin : </span> <?php echo "7859966777" ; ?></p>
