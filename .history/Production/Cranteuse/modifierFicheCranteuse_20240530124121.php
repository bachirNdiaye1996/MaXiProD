                    ...
                    for ($i = 0; $i < count($_POST['Echandiametre']); $i++){   
                        ...
                        if($diametre != "" || $poids != "" || $df != ""){
                            if($idConsommation != ""){
                                ...
                                `idfichecranteuseq1Max`=?, `echandf`=? where `idcranteuseechantillon`=?;");
                            $insertUser->execute(array($diametre,$echanlongueur,$idfichecranteuseq1Max,$df,$idcranteuseechantillon));
                            }else{
