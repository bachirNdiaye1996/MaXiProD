            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="bg-secondary bg-gradient mb-5 mt-3">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 20%;"><span class="mr-4"><span class="mr-4">Temps d'arret total :</span> <?php  $TempsArretTotalReel = explode(":",date("H:i",$TempsArretTotal) );  echo ($TempsArretTotalReel[0]-1)." H ".$TempsArretTotalReel[1]." min"; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Poids total produit : </span> <?php echo $PoidsProduitTotal; ?> (KG)</p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Poids total consommé : </span> <?php  echo $PoidsConsommeTotal; ?> (KG)</p>
                            </div>
                            <p class="m-0 mt-3  h5 ml-3 mb-3 d-inline" style="color: white; padding-right: 20%;"><span class="mr-5">Temps de fonction total : </span> <?php $TotalArretHReelC1Q1 = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReelC1Q1[0]-1)." H ".$TotalArretHReelC1Q1[1]." min"; ?></p>
                        </div>
