...
//** Debut select de la production
    $sql = "SELECT * FROM `ficheparquarttrefilage` ORDER BY `idficheparquarttrefilage` DESC";
                    ...
                    <div class="mt-5 mb-3 col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Historique des fiches de production de la section tréfilage</h6>
                            </div>
                            <div class="row m-2">
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="historiqueFicheTrefilage.php?idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&dateCreation=<?= $trefilage['datecreation'] ?>" class="link-offset-2 link-underline"><?php echo "TREF-".$trefilage['idficheparquarttrefilage']; ?></a>
                                                    </td>
