                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6 ">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    ...
                                                                                                    <input class="form-control" type="number" name="nompeseur" value="" id="example-date-input4" placeholder="Taper le nom du peseur">
                                                                                                </div>
                                                                                            </div> 
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Nom du chef de quart</label>
                                                                                                    <input class="form-control" type="number" name="nomchefquart" id="validationDefault01" value="" id="example-date-input4" placeholder="Taper le nom du chef de quart" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
