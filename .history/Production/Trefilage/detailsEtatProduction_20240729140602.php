                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Nom de la DF : </span><?php echo $productionTref['controleur1']; ?></h5></label>
                                                                                            <div class="col-sm-4">
