       ...
       /* $compteurdebut=htmlspecialchars( $_POST['compteurdebut']);
        ...
        //On verifie avant d'inserer
            ...
            for ($i = 0; $i < count($_POST['poidstotalconsommation']); $i++){ 
                //print_r($_POST['numerofilmachine1'][$i]);  
                //if((isset($_POST['numerofilmachine1'][$i]) && $_POST['numerofilmachine1'][$i] =="") && (isset($_POST['numerofilmachine2'][$i]) && $_POST['numerofilmachine2'][$i] =="")){
