...
//Pour send mail approuveProdRectifie
    if(isset($_POST['approuveProdRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            $sql1 = "UPDATE `ficheparquarttrefilage` set `actifapprouvprod`=1 where idficheparquarttrefilage=$idfichetrefilage";
            $db->query($sql1);
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                                                    <div class="row">
                                                                        <div class="invisible">
                                                                            <div class="">
                                                                                <input class="" type="text" value="<?= $trefilage['idfichetrefilage'] ?>" name="idfichedresseuse">
                                                                            </div>
                                                                        </div> 
                                                                        <div class="invisible">
                                                                            <div class="">
