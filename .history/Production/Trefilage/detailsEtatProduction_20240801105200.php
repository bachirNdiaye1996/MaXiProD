                                ...
                                <div class="col-lg-12  py-3 bg-primary">
                                    <div class="mb-4 mt-3">
                                        <?php 
                                            ...
                                            //print_r($ficheParQuart);
                                        ?>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ3/(int)$ficheParQuart['nombrepersonne'],2); ?></span> <?php  ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Nombre de personne : </span> <?php echo $ficheParQuart['nombrepersonne']; ?></p>
                                        <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ3/(int)$ficheParQuart['nombrepersonne'],2); ?></p>
