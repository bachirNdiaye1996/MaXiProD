...
/** Quart 1 */
    /** Cranteuse1 Q1 */
        ...
        foreach($productionTref as $productionTr => $Key){
            ...
            array_push($ProdConsommationQ1, $consommationsQ1);
            ...
            //** Fin select de la production 
            // On pousse les consommations dans un tableaux qu'on va utiliser aprés
            array_push($ProdRevisionQ1, $revisionsQ1);
            ...
            //** Fin select de la production 
            // On pousse les consommations dans un tableaux qu'on va utiliser aprés
            foreach($productionsQ1 as $productions => $Key){
                array_push($ProdProductionQ1, $productionsQ1);
            }
        }
                                            ...
                                            <table class="table table-bordered mb-2 ml-3 mr-4 col-lg-3" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>       
                                                        ...
                                                        <th>Destination / Poids Rlx</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                                                                        print_r($ProdRevisionQ1);
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['matierepremier'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['produit'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['objectifminimal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['diametrefilensorti'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['librifiant'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $Key[$prodRevision]['destinationrouleaux']." / ".$Key[$prodRevision]['poidsrouleauxdestination']."(KG)" ?></td>
                                                        </tr>
