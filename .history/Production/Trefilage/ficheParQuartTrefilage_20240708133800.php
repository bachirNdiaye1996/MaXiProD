                                                        ...
                                                        <div class="modal-body">
                                                            <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="<?= $trefilage['nompeseur'] ?>" name="machine">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="<?= $trefilage['nomchefquart'] ?>" name="dateCreation">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="<?= $trefilage['nomchefequipe'] ?>" name="machine">
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                <div class="">
