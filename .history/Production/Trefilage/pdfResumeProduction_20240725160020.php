...
// Fin
    ...
    //Pour quart 2
        ...
        foreach($resultProdRevisionQ2 as $shipping => $values){ 
            $TotalProductionQ2 += $values['poidstotalproduction'];  
            $TotalPrevisionQ2 += $values['objectifminimal'];   

            $pdf->Cell(35,5,utf8_decode($shipping),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['objectifminimal']),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['poidstotalproduction']),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($TotalPrevisionQ2),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($TotalProductionQ2),1,1,'C');
        }
    ...
    //Pour quart 3
        ...
        foreach($resultProdRevisionQ3 as $shipping => $values){ 
            $TotalProductionQ3 += $values['poidstotalproduction'];  
            $TotalPrevisionQ3 += $values['objectifminimal'];   

            $pdf->Cell(35,5,utf8_decode($shipping),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['objectifminimal']),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['poidstotalproduction']),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($TotalPrevisionQ3),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($TotalProductionQ3),1,1,'C');
        }
