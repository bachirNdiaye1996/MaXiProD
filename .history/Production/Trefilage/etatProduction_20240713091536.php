                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#CFFEDA; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsEtatProduction.php?dateCreation=<?= $trefilage['dateCreation'] ?>&=<?= $trefilage['dateCreation'] ?>" class="link-offset-2 link-underline"><?php echo "EtatProd-".$i; ?></a>
                                                    </td>
