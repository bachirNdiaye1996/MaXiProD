            ...
            if($ProblemeArret != "erreurProblemeArret" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && $ProblemeFicheExist != "erreurProblemeFicheExist" && $ProblemeFilMachine != "erreurProblemeFilMachine"){  
                ...
                // Productions
                    for ($i = 0; $i < count($_POST['nombrerouleauxproduction']); $i++){   
                        ...
                        $insertUser=$db->prepare("UPDATE `trefilageproduction` SET `nombrerouleauxproduction`=?, `poidstotalproduction`=? where `idtrefilageproduction`=?;");
                        $insertUser->execute(array($nombrerouleauxproduction,$poidstotalproduction,$idtrefilageproduction));
                    }
                //
                                                ...
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeFilMachine != "erreurProblemeFilMachine" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                                        ...
                                                                        <td style="background-color:#CFFEDA" id="d2">
                                                                            <select class="form-control mb-3" id="numerofilmachine2" name="numerofilmachine[]">
                                                                                ...
                                                                                <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option id="numbobine"> <?php echo $stock['numbobine']; ?></option> 
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <div class="form-check-inline">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" style="width: 25px; height: 25px;" class="form-check-input" name="finirfm" <?php if(isset($rowConsommation['finirfm'][$i])){ echo "checked"; } ?> >
                                                                                    </label>
                                                                                </div>
                                                                            </div>  
                                                                        </td>
                                                    ...
                                                    <script>
                                                        ...
                                                        autres.addEventListener("click", () => {
                                                            ...
                                                            numerofilmachine1.setAttribute("name", "numerofilmachine[]");
                                                        })
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;" style="display:none" id="d1">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" name="" value="<?php echo $_POST['numerofilmachine'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>   
                                                                        <td style="background-color:#CFFEDA;">
