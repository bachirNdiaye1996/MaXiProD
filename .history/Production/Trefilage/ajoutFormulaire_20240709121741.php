                                                ...
                                                <?php }else{  // Lorsqu'il y a une erreur ?>
                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            <label class="form-label font-weight-bold text-primary" for="nom">Machine</label>
                                                            <select class="form-control" name="machine">
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR4</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR4-1</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR4-2</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR5</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR6-1</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR7-2</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR8</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR10</option>
                                                                <option <?php if ( $_POST['machine']=="Dresseuse 1") {echo "selected='selected'";} ?>>TR6-2</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3 mr-4 ml-5">
