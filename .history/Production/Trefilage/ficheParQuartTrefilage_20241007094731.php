                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 text-start">
                                                                            ...
                                                                            <input class="form-control designa" type="date" id="" value="<?php if(isset($_POST)){ echo $_POST['nomchefquart']; } ?>" name="datecreation" id="example"  placeholder="" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 ">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                            <label class="form-label font-weight-bold text-primary" for="1">Nom du peseur</label>
                                                                            <input class="form-control" type="text" name="nompeseur" value="<?php if(isset($_POST)){ echo $_POST['nomchefquart']; } ?>" id="example-date-input4" placeholder="Taper le nom du peseur">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                            ...
                                                                            <input class="form-control designa" type="text" id="" value="<?php if(isset($_POST)){ echo $_POST['nomchefquart']; } ?>" name="nomchefequipe" id="example"  placeholder="Taper le nom du chef d'équipe" required>
                                                                        </div>
                                                                    </div> 
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                            <label class="form-label font-weight-bold text-primary" for="3" >Nom du chef de section</label>
                                                                            <input class="form-control designa" type="text" id="" value="<?php if(isset($_POST)){ echo $_POST['nomchefquart']; } ?>" name="nomchefsection" id="example"  placeholder="Taper le nom du chef de section" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                            <label class="form-label font-weight-bold text-primary" for="3" >Nombre de personne</label>
                                                                            <input class="form-control designa" type="text" id="" value="<?php if(isset($_POST)){ echo $_POST['nomchefquart']; } ?>" name="nombrepersonne" id="example"  placeholder="Taper le nombre de personne qui ont travaillé dans ce quart" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="">
