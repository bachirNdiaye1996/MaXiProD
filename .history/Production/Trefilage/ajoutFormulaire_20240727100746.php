                                                                    ...
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <select class="form-control" name="destinationrouleaux[]" id="destinationrouleaux">
                                                                                        <option <?php if ( $_POST['destinationrouleaux']=="Four")   {echo "selected='selected'";} ?>>Four</option>
                                                                                        <option <?php if ( $_POST['destinationrouleaux']=="Clou")   {echo "selected='selected'";} ?>>Clou</option>
                                                                                    </select>                                                
                                                                                </div>
                                                                            </div>
                                                                        </td>
