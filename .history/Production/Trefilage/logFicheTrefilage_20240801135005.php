                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailslogFicheTrefilage.php?idlogfichetrefilage=<?= $trefilage['idlogfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&idfichetrefilage=<?php echo $_GET['idfichedresseuse'];?>" class="link-offset-2 link-underline"><?php echo "TREF-".$trefilage['idlogfichetrefilage']; ?></a>
                                                    </td>
