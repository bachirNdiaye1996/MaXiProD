                                ...
                                <div class="table-responsive col-lg-12">
                                    ...
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['debutarret'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['finarret'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['raison'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['debutarret'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['finarret'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['raison'] ?></td>
                                                </tr>
