                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-6 mt-5 text-start">
                                                                            ...
                                                                            <input class="form-control designa" type="text" id="" value="<?php if(isset($_POST)){ echo "Bachir"; } ?>" name="nombrepersonne" id="example"  placeholder="Taper le nombre de personne qui ont travaillé dans ce quart" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="">
