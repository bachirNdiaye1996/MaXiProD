                    ...
                    <div class="col-lg-12">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($ProdRevisionQ1 as $prodRevision => $Key){
                                                                ...
                                                                $PoidsObjectifMinimal += $Key['objectifminimal'];
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionTref['machine'] ?></td>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($ProdConsommationQ1 as $prodConsommation => $Key){
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                $PoidsConsommeTotal += $Key['poidstotal'];
                                                                //$RebusTotal += $consommationC1Q1['dechet']; 
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['numerofilmachine'] ?></td>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($ProdProductionQ1 as $prodProduction => $Key){
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                $PoidsProduitTotal += $Key['poidstotalproduction'];
                                                                //$RebusTotal += $consommationC1Q1['dechet'];
                                                        ?>
                                                            <tr>
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                ?>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimal/7,2); ?> (KG)</span> <?php  ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Nombre de personne : </span> <?php echo "7"; ?></p>
                                <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotal/7,2); ?> (KG)</p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total produit : </span> <?php echo $PoidsProduitTotal; ?> (KG)</p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total consommé : </span> <?php  echo $PoidsConsommeTotal; ?> (KG)</p>
                                <p class="mt-5 mb-3 h5 " style="color: white;"><span class=""></span></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Peseur : </span> <?php echo $ficheParQuart['nompeseur']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef d'équipe : </span> <?php echo $ficheParQuart['nomchefequipe']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef de section : </span> <?php echo $ficheParQuart['nomchefsection']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef de quart : </span> <?php echo $ficheParQuart['nomchefquart']; ?></p>
                            </div>
                        </div>
