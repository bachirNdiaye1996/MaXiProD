                                            ...
                                            <div class="row">
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeFilMachine != "erreurProblemeFilMachine" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                                        ...
                                                                        <td style="background-color:#CFFEDA" id="d2">
                                                                            <select class="form-control mb-3" id="numerofilmachine2" name="">
                                                                                ...
                                                                                <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option class="numerobobine"> <?php echo $stock['numbobine']; ?></option> 
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                    ...
                                                    <script>
                                                        ...
                                                        let numbobine = document.getElementsByClassName("numerobobine");
                                                        console.log(numerobobine);
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d1">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" name="numerofilmachine[]" value="<?php echo $_POST['numerofilmachine'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA; display:none" id="d2">
                                                                            <select class="form-control" id="numerofilmachine2" name="">
                                                                                ...
                                                                                <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option> <?php echo $stock['numbobine']; ?></option>                                                                                     
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </select> 
