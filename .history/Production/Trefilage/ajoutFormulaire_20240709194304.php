<?php
    ...
    if(isset($_POST['CreerFicheProduction'])){
        ...
        $datecreationfiche=htmlspecialchars( $_GET['datecreationfiche']);
        ...
        $idficheparquarttrefilage=$quart=htmlspecialchars($_GET['idficheparquarttrefilage']);
        ...
        if($ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && $ProblemeFilMachine != "erreurProblemeFilMachine" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
            ...
            // Révisions
                for ($i = 0; $i < count($_POST['matierepremier']); $i++){
                    ...
                    $insertUser=$db->prepare("INSERT INTO `trefilagerevision` (`idtrefilagerevision`, `matierepremier`, `produit`, `objectifminimal`, `diametrefilensorti`, `actif`, `librifiant`, `destinationrouleaux`, `poidsrouleauxdestination`) 
                    VALUES (NULL, ?, ?, ?, ?, '1', ?, ?, ?);");
                    $insertUser->execute(array($matierepremier,$produit,$objectifminimal,$diametrefilensorti,$librifiant,$destinationrouleaux,$poidsrouleauxdestination));
                }
            //
            ...
            // Consommations
                for ($i = 0; $i < count($_POST['numerofilmachine']); $i++){   
                    ...
                    $nombrerouleauxconsommation = htmlspecialchars($_POST['nombrerouleauxconsommation'][$i]);
                    ...
                    VALUES (NULL, ?, ?, '1', ?, ?);");
                    $insertUser->execute(array($numerofilmachine,$nombrerouleaux,$poidstotal,$idficheTrefilageMax));
                }
            //
            ...
            // Productions
                for ($i = 0; $i < count($_POST['nombrerouleauxproduction']); $i++){   
                    ...
                    VALUES (NULL, ?, ?, '1', ?);");
                    $insertUser->execute(array($nombrerouleauxproduction,$poidstotalproduction,$idfichetrefilage,$idficheTrefilageMax));
                }
            //

            header("location: detailsFicheTrefilage.php?idfichetrefilage=$idficheTrefilageMax&quart=$quart&idficheparquarttrefilage=$idficheparquarttrefilage");
            exit;
        }
    }
                                            ...
                                            <div class="row">
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeFilMachine != "erreurProblemeFilMachine" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-lg-12 mt-5">
                                                        <h5 class="modal-title mb-3 text-center font-weight-bold text-primary" id="myExtraLargeModalLabel">Révisions</h5>
                                                        ...
                                                        <div class="col-md-4  d-flex gap-2">
                                                            <div class="mb-5 text-start d-flex gap-2 pt-4">
                                                                <input class="btn btn-success  w-lg bouton mr-3" name="ChangerNombreLigne" id="addRevisions" type="button" value="Ajouter une ligne">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <select class="form-control" name="machine">
                                                                ...
                                                                <option <?php if ( $_POST['machine']=="TR4-1") {echo "selected='selected'";}   ?>>TR4-1</option>
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="text" name="destinationrouleaux[]" id="destinationrouleaux" value="<?php echo $_POST['destinationrouleaux'][$i]; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="validationDefault04" type="number" step="0.01" name="nombrerouleauxconsommation[]" value="<?php echo $_POST['nombrerouleauxconsommation'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
