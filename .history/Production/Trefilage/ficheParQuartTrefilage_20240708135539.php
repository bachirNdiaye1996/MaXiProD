                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-2 ml-5 mt-3 mr-4">
                                                                        <div class="mb-1 text-start">
                                                                            ...
                                                                            <input class="form-control" id="validationDefault02" type="number" step="0.01" name="" value="" placeholder="Mettez le compteur du début" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 mt-3 mr-4">
                                                                        <div class="mb-1 text-start">
                                                                            <label class="form-label font-weight-bold text-primary" for="nom">Compteur fin</label>
                                                                            <input class="form-control" id="validationDefault02" type="number" step="0.01" name="" value="" placeholder="Mettez le Compteur de la fin" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 mr-2 mt-3 mb-5 mr-4">
                                                                        <div class="mb-1 text-start">
                                                                            ...
                                                                            <input class="form-control" id="validationDefault01" type="text" name="" value="" placeholder="Mettez le nom complet du contrôleur 1" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 ml-5 mt-3 mr-4">
                                                                        <div class="mb-1 text-start">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 text-start">
                                                                                                    ...
                                                                                                    <input class="form-control" type="number" name="quart" id="validationDefault01" value="" id="example-date-input4" placeholder="Taper le nombre de bobine" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6 mt-3">
                                                                                                <div class="mb-6 text-start">
                                                                                                    <label class="form-label fw-bold" for="prenom" >Poids déclare</label>
                                                                                                    <input class="form-control designa" type="number" id="validationDefault02" value="" name="datecreation" id="example"  placeholder="Taper le poids déclaré" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6 ">
                                                                                                <div class="mb-6 mt-3 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Poids pesé</label>
                                                                                                    <input class="form-control" type="number" name="nompeseur" value="" id="example-date-input4" placeholder="Taper le poids pesé">
                                                                                                </div>
                                                                                            </div> 
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Nombre de bobine</label>
                                                                                                    <input class="form-control" type="number" name="nomchefquart" id="validationDefault01" value="" id="example-date-input4" placeholder="Taper le nombre de bobine" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6 mt-3">
                                                                                                <div class="mb-6 text-start">
                                                                                                    <label class="form-label fw-bold" for="prenom" >Poids déclare</label>
                                                                                                    <input class="form-control designa" type="number" id="validationDefault02" value="" name="nomchefequipe" id="example"  placeholder="Taper le poids déclaré" required>
                                                                                                </div>
                                                                                            </div> 
                                                                                        </div>
                                                                                    </form>  
