                                            ...
                                            <div class="row">
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeFilMachine != "erreurProblemeFilMachine" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <select class="form-control" name="machine">
                                                                <option class="togg2">TR4</option>
                                                                <option id="togg1">TR4-1</option>
                                                                <option class="togg3">TR4-2</option>
                                                                <option class="togg4">TR5</option>
                                                                <option class="togg5">TR6-1</option>
                                                                <option class="togg6">TR6-2</option>
                                                                <option class="togg7">TR7-2</option>
                                                                <option class="togg8">TR8</option>
                                                                <option class="togg9">TR10</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA; display:none" id="d2">
                                                                            <select class="form-control" id="numerofilmachine" name="numerofilmachine[]">
                                                                                <option></option> 
                                                                                <?php
                                                    ...
                                                    <script>
                                                        ...
                                                        let togg1 = document.getElementById("togg2");
                                                        let togg1 = document.getElementById("togg3");
                                                        let togg1 = document.getElementById("togg4");
                                                        let togg1 = document.getElementById("togg5");
                                                        let togg1 = document.getElementById("togg6");
                                                        let togg1 = document.getElementById("togg7");
                                                        let togg1 = document.getElementById("togg8");
                                                        let togg1 = document.getElementById("togg9");
