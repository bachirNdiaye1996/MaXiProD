                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveProdRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier ou de suprimer cette fiche au prêt du DSI <?php echo ' --> DRES-'.$trefilage['idfichedresseuse']; ?>"><i class="fa fa-plus me-1">Ajouter une production</i></a>
                                            <?php
                                                } 
                                            ?>
