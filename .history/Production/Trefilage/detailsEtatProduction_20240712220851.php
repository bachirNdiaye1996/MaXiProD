                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-2">Nombre de personne : </span> <?php echo "7"; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-2">Poids total produit : </span> <?php echo $PoidsProduitTotal; ?> (KG)</p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-2">Poids total consommé : </span> <?php  echo $PoidsConsommeTotal; ?> (KG)</p>
                                <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotal/7,2); ?> (KG)</p>
