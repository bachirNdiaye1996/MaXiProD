                                    ...
                                    ?>
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-4 col-lg-3" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                        foreach($ProdRevisionQ1 as $prodRevisionQ1){
                                                            //$PoidsConsommeTotal += $consommationC1Q1['piodstotal'];
                                                            //$RebusTotal += $consommationC1Q1['dechet'];
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['matierepremier'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['produit'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['objectifminimal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['diametrefilensorti'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['librifiant'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['destinationrouleaux']." / ".$prodRevisionQ1['poidsrouleauxdestination']."(KG)" ?></td>
                                                        </tr>
