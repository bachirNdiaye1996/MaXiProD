                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="mt-5 mb-3 h5 " style="color: white;"><span class="mr-2"></span></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Peseur : </span> <?php ; ?> (KG)</p>
