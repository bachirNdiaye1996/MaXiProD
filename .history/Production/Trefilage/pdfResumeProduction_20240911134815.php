...
// Fin
    ...
    //Pour Les totaux
        ...
        $pdf->Cell(194,10,'',0,1);
        $pdf->SetTextColor(50,60,100);
        $pdf->Cell(80,8,utf8_decode("TOTAL"),0,1,'C');
        $pdf->SetFont('Arial','B',7);
        ...
        $pdf->Cell(40,5,utf8_decode('Pourcentage de réalisation (%)'),1,1,'C');


        $pdf->SetTextColor(223,53,23);
        $pdf->Cell(40,5,utf8_decode($TotalPrevision),1,0,'C');
        $pdf->Cell(40,5,utf8_decode($TotalProduction),1,1,'C');
        $pdf->Cell(40,5,utf8_decode($TotalProduction/$TotalPrevision * 100),1,1,'C');
