...
//** Debut select de la production
    $sql = "SELECT * FROM `fichetrefilage` where `idficheparquarttrefilage`=$idficheparquarttrefilage ORDER BY `idfichetrefilage` DESC";
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                foreach($Trefilage as $trefilage){
                                                    $i++;
                                                    //if($article['status'] == 'termine'){<p><a class="" href="#">Underline opacity 0</a></p>
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($trefilage['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsFicheTrefilage.php?idfichetrefilage=<?= $trefilage['idfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>" class="link-offset-2 link-underline"><?php echo "FICHE-".$trefilage['idfichetrefilage']; ?></a>
                                                    </td>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($trefilage['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $trefilage['machine'] ?>
                                                    </td>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }elseif($trefilage['couleurhistoriquemodif'] == 1){echo 'background-color:#E17B15 ; color:white;';}else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $trefilage['user'] ?>
                                                    ...
                                                    <td style="background-color:#CFFEDA">
                                                        <?php if(($trefilage['couleurhistoriquemodif'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="logFicheTrefilage.php?idfichetrefilage=<?= $trefilage['idfichetrefilage'] ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
