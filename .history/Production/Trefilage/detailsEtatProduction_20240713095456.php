                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-5">Peseur : </span> <?php echo $ficheParQuart['nompeseur']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-5">Chef d'équipe : </span> <?php echo $ficheParQuart['nomchefequipe']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-5">Chef de section : </span> <?php echo $ficheParQuart['nomchefsection']; ?></p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-5">Chef de quart : </span> <?php echo $ficheParQuart['nomchefquart']; ?></p>
                            </div>
                        </div>
