                                                        ...
                                                        $('.accepteProdmodifmod<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Autoriser la demande",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'autoriserProductionRectifie.php?idfichetrefilage=<?= $trefilage['idfichetrefilage'] ?>&machine=<?= $trefilage['machine'] ?>&dateCreation=<?= $trefilage['dateCreation'] ?>&quart=<?= $trefilage['quart']; ?>',
                                                                            //data: str,
                                                                            success: function( response ) {
                                                                                Swal.fire({
