<?php
    ...
    if(isset($_POST['CreerFicheProduction'])){
        ...
        if($ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && $ProblemeFilMachine != "erreurProblemeFilMachine" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
            ...
            // Consommations
                for ($i = 0; $i < count($_POST['poidstotalconsommation']); $i++){   
                    $diametreconsommation = htmlspecialchars($_POST['diametreconsommation'][$i]);
                    ...
                    if(isset($_POST['numerofilmachine1'][$i])){
                        ...
                        $insertUser=$db->prepare("INSERT INTO `trefilageconsommation` (`idtrefilageconsommation`, `numerofilmachine`, `nombrerouleaux`, `actif`, `poidstotal`, `idfichetrefilage`, `diametre`, `nouveaudiametre`) 
                        VALUES (NULL, ?, ?, '1', ?, ?, ?, '1');");
                        $insertUser->execute(array($numerofilmachine,$nombrerouleauxconsommation,$poidstotalconsommation,$idficheTrefilageMax,$diametreconsommation));
                    }
                    // Si on choisit un numero bobine existant
                    if(isset($_POST['numerofilmachine2'][$i])){
                        $numerofinString = explode("/", htmlspecialchars($_POST['numerofilmachine2'][$i]));
                        $numerofilmachine=$numerofinString[0];  
                        $diametre=$numerofinString[1];

                        // Voir si FM est fini
                        if(isset($_POST['finirfm'][$i])){     
                            $insertUser=$db->prepare("INSERT INTO `trefilageconsommation` (`idtrefilageconsommation`, `numerofilmachine`, `nombrerouleaux`, `actif`, `poidstotal`, `idfichetrefilage`, `diametre`, `finirfm`) 
                            VALUES (NULL, ?, ?, '1', ?, ?, ?, 1);");
                            $insertUser->execute(array($numerofilmachine,$nombrerouleauxconsommation,$poidstotalconsommation,$idficheTrefilageMax,$diametreconsommation));
                            ...
                            $insertUser=$db->prepare("INSERT INTO `trefilageconsommation` (`idtrefilageconsommation`, `numerofilmachine`, `nombrerouleaux`, `actif`, `poidstotal`, `idfichetrefilage`, `diametre`) 
                            VALUES (NULL, ?, ?, '1', ?, ?, ?);");
                            $insertUser->execute(array($numerofilmachine,$nombrerouleauxconsommation,$poidstotalconsommation,$idficheTrefilageMax,$diametreconsommation));
                        }
                    }
            ...
            // Productions
                for ($i = 0; $i < count($_POST['nombrerouleauxproduction']); $i++){   
                    ...
                    $insertUser=$db->prepare("INSERT INTO `trefilageproduction` (`idtrefilageproduction`, `nombrerouleauxproduction`, `poidstotalproduction`, `actif`,`idfichetrefilage`,`diametre`) 
                    VALUES (NULL, ?, ?, '1', ?, ?);");
                    $insertUser->execute(array($nombrerouleauxproduction,$poidstotalproduction,$idficheTrefilageMax,$diametre));
                }
            //
                                    ...
                                    <div class="modal-body">
                                        <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                            <div class="row">
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control mb-3" id="numerofilmachine2" name="numerofilmachine2[]">
                                                                                ...
                                                                                ?>   
                                                                                    <option id="numbobine" value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur'].'/'.$stock['poidsdeclare']; ?>"><?php echo $stock['numbobine'] ?></option>                                                                                     
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            ...
                                                                            <div class="col-md-10" style="display:none" id="d1">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="poidstotalconsommation" type="number" step="0.01" name="poidstotalconsommation[]" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="diametreconsommation" type="number" step="0.01" name="diametreconsommation[]" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                        ...
                                                                        <script>
                                                                            $(document).ready(function(){
                                                                                $('#numerofilmachine2').change(function(){
                                                                                    //Selected value
                                                                                    var inputValue = $(this).val();
                                                                                    var myArray = inputValue.split('/');
                                                                                    document.getElementById("diametreconsommation").value = myArray[1];
                                                                                    document.getElementById("poidstotalconsommation").value = myArray[2];
                                                                                });
                                                                            });
                                                                        </script>
                                                                        <td style="background-color:#CFFEDA;" class="text-center"> 
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="validationDefault04" type="number" step="0.01" name="diametreproduction[]" value="" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control mb-3" id="numerofilmachine2" name="numerofilmachine2[]" style="<?php if(isset($_POST['numerofilmachine1'][$i])){ echo "display:none"; } ?>> 
                                                                                <option value="<?php if(isset($_POST['numerofilmachine2'][$i])){ echo $_POST['numerofilmachine2'][$i]; } ?>" ><?php if(isset($_POST['numerofilmachine2'][$i])){$numerofinString = explode("/", $_POST['numerofilmachine2'][$i]); echo $numerofinString[0];} ?></option> 
                                                                                <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option id="numbobine" value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur'].'/'.$stock['poidsdeclare']; ?>"> <?php echo $stock['numbobine']; ?></option>                                                                                     
                                                                            ...
                                                                            <div class="col-md-10" style="<?php if(isset($_POST['numerofilmachine2'][$i])){ echo "display:none"; } ?>" id="d1">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="<?php if(isset($_POST['numerofilmachine1'][$i])){ echo $_POST['numerofilmachine1'][$i]; } ?>">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="poidstotalconsommation" type="number" step="0.01" name="poidstotalconsommation[]" value="<?php echo $_POST['poidstotalconsommation'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="diametreconsommation" type="number" step="0.01" name="diametreconsommation[]" value="<?php echo $_POST['diametreconsommation'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="validationDefault04" type="number" step="0.01" name="diametreproduction[]" value="<?php echo $_POST['diametreproduction'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;" class="text-center"> 
                                                ...
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeFilMachine != "erreurProblemeFilMachine"  && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                    <div class="col-md-2 mr-5 mt-5 mb-5">
                                                        <div class="mb-1 text-start">
