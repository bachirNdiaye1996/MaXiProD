                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        ...
                                                        <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="modifierFicheTrefilage.php?idsupfiche=<?= $trefilage['idfichetrefilage'] ?>&dateCreation=<?= $trefilage['dateCreation'] ?>&quart=<?= $trefilage['quart']; ?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage']; ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                        <?php }?>
                                                        <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
