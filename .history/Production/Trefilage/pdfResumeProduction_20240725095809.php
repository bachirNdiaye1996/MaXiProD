    ...
    /** Trefilage Q1 */
        ...
        foreach($productionTref as $productionTr => $Key){
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT * FROM `trefilageproduction`, `trefilagerevision` where `actif`=1 and trefilagerevision.idfichetrefilage=$idFicheTrefilage ORDER BY `idtrefilageconsommation` DESC;";
