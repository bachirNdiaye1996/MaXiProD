                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6 ">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold text-primary" for="nom">Nom du peseur</label>
                                                                                                    <input class="form-control" type="text" name="nompeseur" value="" id="example-date-input4" placeholder="Taper le nom du peseur">
                                                                                                </div>
                                                                                            </div> 
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold text-primary" for="nom">Nom du chef de quart</label>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold text-primary" for="prenom" >Nom du chef d'équipe</label>
