...
// Fin
    ...
    //Pour quart 1
        if($resultProdRevisionQ1){
            // Objectif
            $pdf->SetMargins(40,25,25);
            $pdf->SetFont('Arial','B',9);
            $pdf->Cell(194,10,'',0,1);
            $pdf->SetTextColor(50,60,100);
            $pdf->Cell(105,8,utf8_decode("QUART I"),0,1,'C');
            ...
            $pdf->Cell(35,5,utf8_decode('Réalisation (%)'),1,0,'C');
            $pdf->Cell(35,5,utf8_decode('Production (KG)'),1,1,'C');
            ...
            foreach($resultProdRevisionQ1 as $shipping => $values){    
                ...
                $pdf->Cell(35,5,utf8_decode(round($values['poidstotalproduction']/$values['objectifminimal'] * 100 ,2)),1,0,'C');
    ...
    //Pour quart 2
        if($resultProdRevisionQ2){
            ...
            $pdf->Cell(194,10,'',0,1);
            $pdf->SetTextColor(50,60,100);
            $pdf->Cell(105,8,utf8_decode("QUART II"),0,1,'C');
            $pdf->SetFont('Arial','B',7);
    ...
    //Pour quart 3
        if($resultProdRevisionQ3){
            ...
            $pdf->Cell(194,10,'',0,1);
            $pdf->SetTextColor(50,60,100);
            $pdf->Cell(105,8,utf8_decode("QUART III"),0,1,'C');
            $pdf->SetFont('Arial','B',7);
    ...
    //Pour Les totaux
        ...
        $pdf->Cell(194,10,'',0,1);
        $pdf->SetTextColor(50,60,100);
        $pdf->Cell(100,8,utf8_decode("TOTAL"),0,1,'C');
        $pdf->SetFont('Arial','B',7);
        ...
        $pdf->Cell(50,5,utf8_decode('Pourcentage de réalisation (%)'),1,1,'C');


        $pdf->SetTextColor(223,53,23);
        $pdf->Cell(40,5,utf8_decode($TotalPrevision),1,0,'C');
        $pdf->Cell(40,5,utf8_decode($TotalProduction),1,0,'C');
        $pdf->Cell(50,5,utf8_decode(round($TotalProduction/$TotalPrevision * 100 ,2)),1,1,'C');
