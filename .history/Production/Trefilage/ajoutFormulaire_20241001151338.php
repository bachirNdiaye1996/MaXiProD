                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control" id="numerofilmachine2" name="numerofilmachine[]">
                                                                                <option></option> 
                                                                                <?php
                                                                            ...
                                                                            <div class="col-md-10" style="display:none" id="d1">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="<?php echo $rowConsommation['numerofilmachine']; ?>" name="" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                <option id="numerobobine">Retour</option>
                                                                            </select> 
                                                                            <div class="col-md-10" style="display:none" id="d1">
                                                                                <div class="mb-1 text-start">
