    ...
    if($ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && $ProblemeFilMachine != "erreurProblemeFilMachine" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
        ...
        // Consommations
            for ($i = 0; $i < count($_POST['numerofilmachine']); $i++){ 
                ...
                $diametre = htmlspecialchars("diametreconsommation");
        ...
        // Productions
            for ($i = 0; $i < count($_POST['nombrerouleauxproduction']); $i++){   
                ...
                $diametre = htmlspecialchars("diametreproduction");
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control" id="numerofilmachine2" name="numerofilmachine[]">
                                                                                ...
                                                                                ?>   
                                                                                    <option value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur']'/'.$stock['poidstotal']; ?>"> <?php echo $stock['numbobine'] ?></option>                                                                                     
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </select> 
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control" id="numerofilmachine2" name="numerofilmachine[]"> 
                                                                            <option value="<?php echo $_POST['numerofilmachine'][$i] ?>" ><?php print_r($_POST['numerofilmachine'][$i]); $numerofinString = explode("/", $_POST['numerofilmachine'][$i]); echo $numerofinString[0]; ?></option> 
                                                                            <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur']; ?>"> <?php echo $stock['numbobine']; ?></option>                                                                                     
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </select> 
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="validationDefault04" type="number" step="0.01" name="diametreconsommation[]" value="<?php echo $_POST['diametreconsommation'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA ;">
