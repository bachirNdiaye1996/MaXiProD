                                                        ...
                                                        $('#suprimerFiche<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Supprimer la fiche",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'suppressionFiche.php?idsupficheDresseuse=<?= $trefilage['idfichetrefilage'] ?>&dateCreation=<?= $trefilage['dateCreation'] ?>&quart=<?= $trefilage['quart']; ?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage']?>',
                                                                            //data: str,
