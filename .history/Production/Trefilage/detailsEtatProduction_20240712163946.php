                        ...
                        <div class="card position-relative">
                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    ?>
                                        <div class="">
                                            <a href="" class=""><p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-dark" style="">Dresseuse 1</p></a>
                                        </div>
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-4 col-lg-5" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr> 
                                                        <th>Machine</th>
                                                        <th>Opérateurs</th>      
