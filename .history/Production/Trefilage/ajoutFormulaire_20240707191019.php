...
<meta charset="utf-8">
    ...
    <script>
        $(document).ready(() => { 
            ...
            $('#dynamicLigne').on('click', '.removeROW', function () {
    ...
    <script type="text/javascript"> 
        $(document).ready(function(){  
            ...
            $('#addLigneRev').click(function(){           
            //alert('ok');           
            i++;           
            $('#dynamicLigneRev').append(`
...
<body id="page-top">
    ...
    <script src="../../indexPage/js/demo/datatables-demo.js"></script>
            ...
            $('#addLigneCons').click(function(){           
            //alert('ok');           
            i++;           
            $('#dynamicLigneCons').append(`
            <tr id="row'+i+'" class="rowClass">
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
            ...
            $('#addLigneProd').click(function(){           
            //alert('ok');           
            i++;           
            $('#dynamicLigneProd').append(`
            <tr id="row'+i+'" class="rowClass">
                <td style="background-color:#CFFEDA ;">
                    <div class="col-md-10">
                        <div class="mb-1 text-start">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="modal-dialog-centered">
                                <div class="modal-content col-lg-12">
                                    <div class="modal-header col-lg-12 bg-primary" >
                                        <h5 class="modal-title" id="myExtraLargeModalLabel" style="color:white; text-align: center;">Ajout planing et relevés de production de la section Tréfilage</h5>
                                    </div>
                                    <div class="modal-body">
                                        <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                            <div class="row">
                                                <?php if($valideFiche != "erreurFiche" && $ProblemeArret != "erreurProblemeArret" && $ProblemeFilMachine != "erreurProblemeFilMachine" && $ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){ // Lorsqu'il y a pas de erreur ?> 
                                                            ...
                                                            <tbody id="dynamicLigneRev">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        </td><td style="background-color:#CFFEDA ;">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control designa" type="number" step="0.01" name="Proddiametre[]" id="Proddiametre" value="" required>
                                                                                </div>
                                                    ...
                                                    <div class="col-lg-5 ">
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            <thead>
                                                                <tr>       
                                                                    <th>Numéro rouleaux fil machine</th>
                                                                    <th>Nombre rouleaux</th>
                                                                    <th>Poids Total</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="dynamicLigneCons">
                                                                <?php
                                                                    //$i=0;
                                                                    //for ($i = 0; $i <= $NombreLigne; $i++){
                                                                        //$i++;
                                                        ...
                                                        <div class="col-md-7  d-flex gap-2">
                                                            <div class="mb-5 text-start d-flex gap-2 pt-4">
                                                                <input class="btn btn-success  w-lg bouton mr-3" name="ChangerNombreLigne" id="addLigne" type="button" value="Ajouter une ligne">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            <thead>
                                                                <tr>       
                                                                    ...
                                                                    <th>Poids Total</th>
                                                                    <th>Explication</th>
                                                                    <th>Supprimer Production</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="dynamicLigneProd">
                                                                <?php
                                                                    //$i=0;
                                                                    //for ($i = 0; $i <= $NombreLigne; $i++){
                                                                        //$i++;
