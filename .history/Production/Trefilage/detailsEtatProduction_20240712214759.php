                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 10%;"><span class="mr-4"><span class="mr-4">Productivité prévue : <?php echo $PoidsObjectifMinimal; ?> (KG)</span> <?php  ?></p>
