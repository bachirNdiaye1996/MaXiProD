...
<?php   
    ...
    $sql = "SELECT * FROM `trefilageconsommation` where `actif`=1 and `idfichetrefilage`=$idlogfichetrefilage ORDER BY `idtrefilageconsommation` DESC;";
    ...
    $sql = "SELECT * FROM `fichetrefilage` where `idfichetrefilage`=$idfichetrefilage";
