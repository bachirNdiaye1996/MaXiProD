...
*/
    ...
    //Pour quart 1
        ...
        $pdf->Cell(40,5,utf8_decode('Total production (KG)'),1,1,'C');
        ...
        foreach($resultProdRevisionQ1 as $shipping => $values){ 
            $TotalProductionQ1 += $values['poidstotalproduction'];  
            $TotalPrevisionQ1 += $values['objectifminimal'];            
            $pdf->Cell(35,5,utf8_decode($shipping),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['objectifminimal']),1,0,'C');
            $pdf->Cell(35,5,utf8_decode($values['poidstotalproduction']),1,1,'C');
            $pdf->Cell(40,5,utf8_decode($TotalPrevisionQ1),1,0,'C');
            $pdf->Cell(40,5,utf8_decode($TotalProductionQ1),1,1,'C');
        }
