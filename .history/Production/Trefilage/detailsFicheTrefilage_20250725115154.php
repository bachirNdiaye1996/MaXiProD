                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 8%;"><span class="mr-4">Opérateurs : </span> <?php echo $Trefilage['controleur1']." */* ".$Trefilage['controleur2']?></p>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="background-color:#4e73df ; color:white;"><?php if($consom['finirfm']==1){ echo "Finie";}else{ echo "Entamée";} ?></td>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['diametre'] ?></td>
