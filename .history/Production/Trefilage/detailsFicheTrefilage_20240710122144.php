...
$idfichetrefilage = $_GET['idfichetrfilage'];  // On recupére l'ID de la réception par get
$idficheparquarttrefilage = $_GET['idficheparquarttrefilage'];  // On recupére l'ID de la réception par get
$TotalPoids = 0;
$TotalBarres = 0;

//** Debut select de la production (révision)
...
//** Debut select de la production
    $sql = "SELECT * FROM `fichetrefilage` where `idfichetrefilage`=$idfichetrfilage";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-end justify-content-end mb-4 mr-3">
                        <a href="pdfFicheDresseuse.php?idfichedresseuse=<?php echo $_GET['idfichedresseuse']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <a href="detailsEtatProduction.php?dateCreation=<?= $Trefilage['dateCreation'] ?>"><p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION <?php echo $Trefilage['machine']; ?></p></a>
                                <div class="mb-4">
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 10%;"><span class="mr-4">Date : </span> <?php echo $Trefilage['dateCreation']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-4">Début quart : </span> <?php echo $Trefilage['heuredepartquart']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;"><span class="mr-4">Fin quart : </span> <?php echo $Trefilage['heurefinquart']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 8%;"><span class="mr-4">Contrôleurs : </span> <?php echo $Trefilage['controleur1']." */* ".$Trefilage['controleur2']?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Quart : </span> <?php echo $Trefilage['quart']; ?></p>
                                </div>
                                <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 30%;"><span class="mr-4">Compteur Horaire Début : </span> <?php echo $Trefilage['compteurdebut']; ; ?></p>
                                <p class="m-0 mt-3  h5 ml-3" style="color: white;"><span class="mr-5">Compteur Horaire Fin : </span> <?php echo $Trefilage['compteurfin']; ; ?></p>
                            </div>
                            <div class="row m-1 mb-3 col-lg-12">
                                <div class="table-responsive col-lg-12">
                                    ...
                                    <!-- Page Loader -->
                                    <div class="">
                                        <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-primary" style="">Révisions</p>
                                    </div>
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                $TotalArretH=0;
                                                foreach($productionRevision as $prodrevision){
                                                    $i++;
                                                    //if($article['status'] == 'termine'){
                                            ?>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['matierepremier'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['produit'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['objectifminimal'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['diametrefilensorti'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['librifiant'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['destinationrouleaux'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $prodrevision['poidsrouleauxdestination'] ?></td>
                                                </tr>
                                ...
                                <div class="table-responsive col-lg-7">
                                    ...
                                    <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information<?php echo $i; ?>" title="Voir details du produit" class="link-offset-2 link-underline"><?= $consom['numerofilmachine'] ?></a></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $consom['nombrerouleaux'] ?></td>
                                                    <td style="background-color:#4e73df ; color:white;"><?= $consom['poidstotal'] ?></td>
                                                </tr>
                                                <!-- Pour le sweetAlert approuveTransfert !--> 
                            ...
                            <div class="table-responsive col-lg-10 mt-5">
                                <div class="">
                                    <p class="m-0 font-weight-bold text-center h4 text-uppercase mt-5 mb-3 text-primary" style="">Productions</p>
                                </div>
                                <table class="table table-bordered m-0" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>       
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td style="background-color:#4e73df ; color:white;"><a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information<?php echo $i; ?>" title="Voir details du produit" class="link-offset-2 link-underline"><?= $prod['proddiametre'] ?></a></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodnumerofin'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodnbBarreColis'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodnbcolis'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodnbbarrerestant'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodlongueurbarre'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= ($prod['prodnbBarreColis']*$prod['prodnbcolis'])+$prod['prodnbbarrerestant']  ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['prodpoids'] ?></td>
                                                <td style="background-color:#4e73df ; color:white;"><?= $prod['proddechet'] ?></td>
                                            </tr>
                                            <!-- Pour le sweetAlert approuveTransfert !--> 
                                            <div class="modal fade " id="Information<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-4"><span class="mr-4">Total arret :</span> <?php  $TotalArretHReel = explode(":",date("H:i",$TotalArretH) ); echo ($TotalArretHReel[0]-1)." Heures ".$TotalArretHReel[1]." minutes"; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;" ><span class="mr-4">Total poids produit : </span> <?php echo $TotalPoids; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;" ><span class="mr-4">Total barres produites : </span> <?php echo $TotalBarres; ?></p>
                                <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 10%;" ><span class="mr-4">Vitesse : </span> <?php echo $Trefilage['vitesse']; ?></p>
                            </div>
                            <p class="m-0 mb-3 h5 mt-3 ml-3 d-inline" style="color: white; padding-right: 51.5%;"></p>
                            <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Observations (Fin) : </span> <?php echo $Trefilage['observationfin']; ?></p>
                            <?php
                                if(((strtotime($Trefilage['heurefinquart']) - strtotime($Trefilage['heuredepartquart'])) > 0)){
                                    $TotalHeureTravaille =  (strtotime($Trefilage['heurefinquart']) - strtotime($Trefilage['heuredepartquart']));
                                }else{
                                    $TotalHeureTravaille =  (-strtotime($Trefilage['heurefinquart']) + strtotime($Trefilage['heuredepartquart']));
                                }
                            ?>
                    ...
                    <div class="col-md-8 align-items-center mt-5 mb-5">
                        <div class="d-flex gap-2 pt-4">
                                <a href="ficheDresseuse.php" class="btn btn-danger w-lg bouton ml-3"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
                        </div>
                    </div> 
                </div> 
            </div><!-- div Content -->
