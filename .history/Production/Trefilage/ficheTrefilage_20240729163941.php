    ...
    if(isset($_POST['approuveProdRectifie'])){
        if(!empty($_POST['motifRectifier'])){
            ...
            <body> 
                <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                    <p align='center' style='margin-top:20px;'>
                        ...
                        <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou de supprimer une fiche de production de la machine $machine (quart $quart) du $dateCreation de code de production : <strong>TREF-$idfichetrefilage</strong></p>
            ...
            foreach($UserMails as $user => $item){
                envoie_mail("Gestion de production réctification",$item['email'],"Demande de réctification de la fiche de code TREF-$idfichetrefilage",$messageD);
            }
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        ...
                                                        <?php if(($trefilage['accepteprodmodif'] == 0) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='admin'){ ?>
                                                            <a href="javascript:void(0);" class="accepteProdmodifmod<?= $i ?> px-2" class="px-2" title="Permettre au chef de quart de modifier ou de suprimer cette fiche">
