...
//** Debut select de la production
    $sql = "SELECT * FROM `logfichetrefilage` where `idfichetrefilage`=$idfichetrefilage ORDER BY `idlogfichetrefilage` DESC";
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailslogFicheTrefilage.php?idlogfichetrefilage=<?= $trefilage['idlogfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&dateCreation=<?= $trefilage['dateCreation'] ?>&idfichetrefilage=<?php echo $_GET['idfichetrefilage'];?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>" class="link-offset-2 link-underline"><?php echo "FICH-".$trefilage['idlogfichetrefilage']; ?></a>
                                                    </td>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $trefilage['machine'] ?>
                                                    </td>
                                                    <td style="<?php if($trefilage['couleurhistoriqueSup'] == 1){ echo "background-color:#FF5335"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?= $trefilage['user'] ?>
                                    ...
                                    <a href="historiqueFicheTrefilage.php?idficheparquarttrefilage=<?= $_GET['idficheparquarttrefilage'] ?>&quart=<?= $_GET['quart'] ?>&dateCreation=<?= $_GET['dateCreation'] ?>" class="btn btn-danger w-lg bouton m-5"><i class="fa fa-angle-double-left mr-2"></i>Retour</a>
