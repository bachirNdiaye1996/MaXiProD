                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="javascript:void(0);" data-toggle="modal" data-target=".ajouterproductionTrefilage" class="btn btn-success  w-lg bouton m-4"><i class="fa fa-plus me-1"></i>Ajouter une production</a>
                                            <?php
                                                } 
                                            ?>
                                            <!-- Pour la rectification des receptions !-->
