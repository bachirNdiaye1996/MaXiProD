                                ...
                                ?>
                                        ...
                                        ?>
                                            <div class="row">
                                                <!-- Révisions -->
                                                <div class="col-lg-6">
                                                    <h5 class="modal-title mb-3 mt-3 text-center font-weight-bold text-primary" id="myExtraLargeModalLabel">Prévisions</h5>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    <td style="background-color:#4e73df ; color:white;">
                                                                        <a style="text-decoration: none; font-family: arial; font-size: 16px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationQ1<?= $i ?>" title="Voir details supplémentaires" class="link-offset-2 link-underline mb-5"><?= $productionTref['machine'] ?></a>
                                                                    </td>
                                                                ...
                                                                <!-- Pour les details !--> 
                                                                <div class="modal fade " id="InformationQ1<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                                    <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                                        <div class="modal-content">
                                                                            <div class="card">
                                                                                <div class="card-header bg-primary text-center">
                                                                                    <h5 class="modal-title" id="fileModalLabel" style="color:white">Details de la production de la machine <?php echo $productionTref['machine']; ?> :</h5>
                                                                                </div>
                                                                                <div class="card-body">
                                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Opérateur 1 : </span><?php echo $productionTref['controleur1']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5 style="color:blue;"></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <?php if($productionTref['controleur2']){ ?>
                                                                                            <div class="form-group row">
                                                                                                <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Opérateur 2 : </span><?php echo $productionTref['controleur2']; ?></h5></label>
                                                                                                <div class="col-sm-4">
                                                                                                    <h5 style="color:blue;"></h5>
                                                                                                </div>
                                                                                            </div>
                                                                                        <?php } ?>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-8 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Date d'enregistrement : </span><?php echo $productionTref['dateajout']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-8 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Saisisseur : </span><?php echo $productionTref['user']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Compteur début : </span><?php echo $productionTref['compteurdebut']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Compteur fin : </span><?php echo $productionTref['compteurfin']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Horaire : </span><?php echo $productionTref['heuredepartquart']." / ".$productionTref['heurefinquart']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-8 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Vitesse : </span><?php echo $productionTref['vitesse']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-8 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Explications : </span><?php echo $productionTref['observationfin']; ?></h5></label>
                                                                                            <div class="col-sm-4">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                foreach($ProdConsommationQ1 as $prodConsommation => $Key){
                                                                    //echo $prodRevision;
                                                                    //print_r($Key[$prodRevision]['matierepremier']);
                                                                    $PoidsConsommeTotalQ1 += (int)$Key['poidstotal'];
                                                                    //$RebusTotal += $consommationC1Q1['dechet']; 
                                                                    $i++;
                                                            ?>
                                                                <tr>
                                                                            ...
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="col-lg-12 mt-5 mb-5">
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            <label for="staticEmail" class="col-sm-4 col-form-label"><h5><span class="mr-3" style="color: #199AF3">Récepteur : </span> <?php echo $Reception['nomrecepteur']; ?></h5></label>
                                                                                            <div class="col-sm-6">
                                                                                                <h5></h5>
                                                                                            </div>
                                                                                        </div>
                                    ...
                                    <div class="col-lg-12  py-3 bg-primary">
                                        <div class="mb-4 mt-3">
                                            ...
                                            ?>
                                            <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ1/(float)$ficheParQuart['nombrepersonne'],2); ?></span> <?php  ?></p>
                                            ...
                                            <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ1/(float)$ficheParQuart['nombrepersonne'],2); ?></p>
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;">
                                                                    <a style="text-decoration: none; font-family: arial; font-size: 16px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationQ2<?= $i ?>" title="Voir details supplémentaires" class="link-offset-2 link-underline mb-5"><?= $productionTref['machine'] ?></a>
                                                                </td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionTref['controleur1'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['matierepremier'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['produit'] ?></td>
                                                            ...
                                                            <!-- Pour les details !--> 
                                                            <div class="modal fade " id="InformationQ2<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                                    <div class="modal-content">
                                                                        <div class="card">
                                                                            <div class="card-header bg-primary text-center">
                                ...
                                <div class="col-lg-12  py-3 bg-primary">
                                    <div class="mb-4 mt-3">
                                        <?php 
                                            ...
                                            //print_r($ficheParQuart);
                                        ?>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ2/(float)$ficheParQuart['nombrepersonne'],2); ?></span> <?php  ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Nombre de personne : </span> <?php echo $ficheParQuart['nombrepersonne']; ?></p>
                                        <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ2/(float)$ficheParQuart['nombrepersonne'],2); ?></p>
                            ...
                            ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i=0;
                                                            foreach($ProdRevisionQ3 as $prodRevision => $Key){
                                                                $i++;
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                //$PoidsConsommeTotal += $consommationC1Q1['piodstotal'];
                                                                ...
                                                                $PoidsObjectifMinimalQ3 += $Key['objectifminimal'];
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;">
                                                                    <a style="text-decoration: none; font-family: arial; font-size: 16px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationQ3<?= $i ?>" title="Voir details supplémentaires" class="link-offset-2 link-underline mb-5"><?= $productionTref['machine'] ?></a>
                                                                </td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $productionTref['controleur1'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['matierepremier'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['produit'] ?></td>
                                                            ...
                                                            <!-- Pour les details !--> 
                                                            <div class="modal fade " id="InformationQ3<?php echo $i; ?>" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true" >
                                                                <div class="modal-dialog modal-xl modal-dialog-centered" style="width=750px">
                                                                    <div class="modal-content">
                                                                        <div class="card">
                                                                            <div class="card-header bg-primary text-center">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i = 0;
                                                            foreach($ProdConsommationQ3 as $prodConsommation => $Key){
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                $PoidsConsommeTotalQ3 += $Key['poidstotal'];
                                                                //$RebusTotal += $consommationC1Q1['dechet']; 
                                                                $i++;
                                                        ?>
                                                            <tr>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($ProdProductionQ3 as $prodProduction => $Key){
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                $PoidsProduitTotalQ3 += $Key['poidstotalproduction'];
                                                                //$RebusTotal += $consommationC1Q1['dechet'];
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $Key['nombrerouleauxproduction'] ?></td>
                                ...
                                <div class="col-lg-12  py-3 bg-primary">
                                    <div class="mb-4 mt-3">
                                        <?php 
                                            //** Debut select de la production (Pour cranteuse 1)
                                                $sql = "SELECT * FROM `ficheparquarttrefilage` where `actif`=1 and `datecreation`='$dateFichetrefilage' and `quart`='3';";
                                            ...
                                            //print_r($ficheParQuart);
                                        ?>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ3/(float)$ficheParQuart['nombrepersonne'],2); ?></span> <?php  ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Nombre de personne : </span> <?php echo $ficheParQuart['nombrepersonne']; ?></p>
                                        <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ3/(float)$ficheParQuart['nombrepersonne'],2); ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total produit (KG) : </span> <?php echo $PoidsProduitTotalQ3; ?></p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total consommé (KG) : </span> <?php  echo $PoidsConsommeTotalQ3; ?></p>
                                        <p class="mt-5 mb-3 h5 " style="color: white;"><span class=""></span></p>
                                        <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Peseur : </span> <?php echo $ficheParQuart['nompeseur']; ?></p>
                                        <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Chef d'équipe : </span> <?php echo $ficheParQuart['nomchefequipe']; ?></p>
                                        <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Chef de section : </span> <?php echo $ficheParQuart['nomchefsection']; ?></p>
