                    ...
                    <div class="col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3 bg-primary">
                                <a href="detailsEtatProduction.php?dateCreation=<?= $Cranteuseq1['dateCreation'] ?>"><p class="m-0 font-weight-bold text-center h2 text-uppercase mt-2 mb-5" style="color: white;">FICHE DE PRODUCTION <?php echo $Cranteuseq1['machine']; ?></p></a>
                                <div class="mb-4">
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 10%;"><span class="mr-4">Date : </span> <?php echo $Cranteuseq1['dateCreation']; ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-4">Début quart : </span> <?php echo $Cranteuseq1['heuredepartquart']; ?></p>
                                    ...
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 8%;"><span class="mr-4">Contrôleurs : </span> <?php echo $Cranteuseq1['controleur1']." */* ".$Cranteuseq1['controleur2']?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;"><span class="mr-4">Quart : </span> <?php echo $Cranteuseq1['quart']; ?></p>
                                </div>
