...
if(isset($_POST['ajouterproductionTrefilage'])){
        ...
        <body> 
            <div id='email-wrap' style='background: #3F5EFB; border-radius: 10px;'><br><br>
                <p align='center' style='margin-top:20px;'>
                    ...
                    <p align='center' style='color:white'>$_SESSION[nomcomplet] vous demande l'autorisation de modifier ou de supprimer une fiche de production de la machine $machine (quart $quart) du $dateCreation de code de production : <strong>DRES-$fichetrefilage</strong></p>
        ...
        foreach($UserMails as $user => $item){
            envoie_mail("Gestion de production réctification",$item['email'],"Demande de réctification de la fiche de code TREF-$idfichedresseuse",$messageD);
        }

        $ValideFiche="reussi";
            
        header("location: ficheTrefilage.php?");
        exit;
    }else{
}
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="ficheTrefilage.php?idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>&quart=<?= $trefilage['quart'] ?>" class="link-offset-2 link-underline"><?php echo "TREF-".$trefilage['idficheparquarttrefilage']; ?></a>
                                                    </td>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 text-start">
                                                                                                    ...
                                                                                                    <input class="form-control designa" type="date" id="validationDefault02" value="" name="datecreation" id="example"  placeholder="" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6 ">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    ...
                                                                                                    <input class="form-control" type="text" name="nomchefquart" id="validationDefault01" value="" id="example-date-input4" placeholder="Taper le nom du chef de quart" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label font-weight-bold text-primary" for="3" >Nom du chef d'équipe</label>
                                                                                                    <input class="form-control designa" type="text" id="validationDefault02" value="" name="nomchefequipe" id="example"  placeholder="Taper le nom du chef d'équipe" required>
                                                                                                </div>
                                                                                            </div> 
                                                                                        </div>
                                                                                    </form>  
