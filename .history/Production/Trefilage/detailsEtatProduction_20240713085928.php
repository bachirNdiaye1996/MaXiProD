                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-1">
                            <img src="../../image/trefilet.jpg" class="img-fluid" alt="" style="border-radius: 50%; margin:20px; opacity: 0.7;" width="200">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-footer py-3 mt-5 bg-primary">
                            <div class="mb-4 mt-3">
                                ...
                                <p class="mt-5 mb-3 h5 " style="color: white;"><span class="mr-5">Peseur : </span> <?php ; ?> (KG)</p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef d'équipe : </span> <?php ; ?> (KG)</p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef de section : </span> <?php ; ?> (KG)</p>
                                <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-5">Chef de quart : </span> <?php ; ?> (KG)</p>
                            </div>
                        </div>
