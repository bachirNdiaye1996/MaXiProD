                                                    ...
                                                    <div class="col-md-2 mr-4 mt-3 mb-5">
                                                        <div class="mb-1 text-start">
                                                            ...
                                                            <select class="form-control" name="machine">
                                                                ...
                                                                <option class="togg2">TR4-2</option>
                                                                <option class="togg2">TR5</option>
                                                                <option class="togg2">TR6-1</option>
                                                                <option class="togg2">TR6-2</option>
                                                                <option class="togg2">TR7-2</option>
                                                                <option class="togg2">TR8</option>
                                                                <option class="togg2">TR10</option>
                                                            </select>                                                
                                                        </div>
                                                    </div>
