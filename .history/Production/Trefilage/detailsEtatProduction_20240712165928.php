                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            foreach($ProdConsommationQ1 as $prodRevision => $Key){
                                                                //echo $prodRevision;
                                                                //print_r($Key[$prodRevision]['matierepremier']);
                                                                //$PoidsConsommeTotal += $consommationC1Q1['piodstotal'];
                                                                //$RebusTotal += $consommationC1Q1['dechet']; 
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $prodProduction['machine'] ?></td>
                                                                <td style="background-color:#4e73df ; color:white;"><?= $prodProduction['controleur1'] ?></td>
                                                            </tr>
                                                        <!-- Pour le sweetAlert approuveTransfert !--> 
                                                        <?php
                                                            }
