                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td style="background-color:#4e73df ; color:white;">
                                                                    <a style="text-decoration: none; font-family: arial; font-size: 16px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#InformationMatiere" title="Voir les details du produit" class="link-offset-2 link-underline mb-5"><?= $Key['numerofilmachine'] ?></a>
                                                                </td>
