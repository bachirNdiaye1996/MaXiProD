                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color:#CFFEDA">
                                                        <?php if(($trefilage['couleurhistoriquemodif'] == 1) && ($_SESSION['niveau']=='admin' || $_SESSION['niveau']=='chefquart')){ ?>
                                                            <a href="logFicheTrefilage.php?idfichetrefilage=<?= $trefilage['idfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&dateCreation=<?= $trefilage['dateCreation'] ?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>" class=" px-2 text-danger" title="Voir l'historique de cette fiche de production"><i class="fas fa-history"></i></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            <?php
