                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-md-8 align-items-center mt-5">
                                        <div class="d-flex gap-2 pt-4">
                                            ...
                                            ?>
                                                <a href="javascript:void(0);" data-toggle="modal" data-target=".ajouterproductionTrefilage" class="btn btn-success  w-lg bouton ml-4"><i class="fa fa-plus me-1"></i>Ajouter une production</a>
                                            <?php
                                                } 
                                            ?>
                                            <!-- Pour la rectification des receptions !-->
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="#" method="POST" enctype="multipart/form-data" class="row g-3">
                                                                <div class="row">
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="" name="quart">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="" name="datecreation">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="" name="nompeseur">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="" name="nomchefquart">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="">
                                                                        <div class="">
                                                                            <input class="" type="text" value="" name="nomchefequipe">
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                <div class="">
