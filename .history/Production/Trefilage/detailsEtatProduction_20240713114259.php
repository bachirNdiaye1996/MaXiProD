                            ...
                            <div class="row m-1 mb-3 col-lg-12">
                                ...
                                <div class="col-lg-12  py-3 mt-5 bg-primary">
                                    <div class="mb-4 mt-3">
                                        ...
                                        ?>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ1/(int)$ficheParQuart['nombrepersonne'],2); ?> (KG)</span> <?php  ?></p>
                                        ...
                                        <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ1/(int)$ficheParQuart['nombrepersonne'],2); ?> (KG)</p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total produit : </span> <?php echo $PoidsProduitTotalQ1; ?> (KG)</p>
                                        <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total consommé : </span> <?php  echo $PoidsConsommeTotalQ1; ?> (KG)</p>
                            ...
                            <div class="col-lg-12  py-3 mt-5 bg-primary">
                                <div class="mb-4 mt-3">
                                    <?php 
                                        ...
                                        //print_r($ficheParQuart);
                                    ?>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white;  padding-right: 3%;"><span class="mr-4"><span class="mr-4">Productivité prévue (KG / pers) : </span><?php echo round($PoidsObjectifMinimalQ2/(int)$ficheParQuart['nombrepersonne'],2); ?> (KG)</span> <?php  ?></p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Nombre de personne : </span> <?php echo $ficheParQuart['nombrepersonne']; ?></p>
                                    <p class="mt-4 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Productivité réelle (KG / pers) : </span> <?php echo round($PoidsProduitTotalQ2/(int)$ficheParQuart['nombrepersonne'],2); ?> (KG)</p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total produit : </span> <?php echo $PoidsProduitTotalQ2; ?> (KG)</p>
                                    <p class="m-0 mb-3 h5 d-inline" style="color: white; padding-right: 3%;"><span class="mr-2">Poids total consommé : </span> <?php  echo $PoidsConsommeTotalQ2; ?> (KG)</p>
                                    <p class="mt-5 mb-3 h5 " style="color: white;"><span class=""></span></p>
                                    <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Peseur : </span> <?php echo $ficheParQuart['nompeseur']; ?></p>
                                    <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Chef d'équipe : </span> <?php echo $ficheParQuart['nomchefequipe']; ?></p>
                                    <p class="mt-5 mb-3 h5 d-inline" style="color: white; padding-right: 5%;"><span class="mr-3">Chef de section : </span> <?php echo $ficheParQuart['nomchefsection']; ?></p>
