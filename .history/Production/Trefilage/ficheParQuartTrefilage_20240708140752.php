                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Quart</label>
                                                                                                    <input class="form-control" type="number" name="quart" id="validationDefault01" value="" id="example-date-input4" placeholder="Taper le quart de la production" required>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 text-start">
                                                                                                    <label class="form-label fw-bold" for="prenom" >Date production</label>
                                                                                            ...
                                                                                            <div class="col-md-6 ">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Nom du peseur</label>
                                                                                                    <input class="form-control" type="text" name="nompeseur" value="" id="example-date-input4" placeholder="Taper le nom du peseur">
                                                                                                </div>
                                                                                            </div> 
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold" for="nom">Nom du chef de quart</label>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-6 mt-5 text-start">
                                                                                                    <label class="form-label fw-bold" for="prenom" >Nom du chef d'équipe</label>
