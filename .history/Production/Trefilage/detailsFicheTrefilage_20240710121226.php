...
$idfichetrfilage = $_GET['idfichetrfilage'];  // On recupére l'ID de la réception par get
...
//** Debut select de la production (révision)
    $sql = "SELECT * FROM `trefilagerevision` where `actif`=1 and `idfichetrefilage`=$idfichetrfilage ORDER BY `idtrefilagerevision` DESC;";
...
//** Debut select de la production (consommation)
    $sql = "SELECT * FROM `dresseuseconsommation` where `actif`=1 and `idfichetrfilage`=$idfichetrfilage ORDER BY `idtrefilageconsommation` DESC;";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="background-color:#4e73df ; color:white;"><?= $consom['heuremontagebobine'] ?></td>
                                                </tr>
                                                <!-- Pour le sweetAlert approuveTransfert !--> 
