    ...
    /** Cranteuse1 Q1 */
        ...
        foreach($productionTref as $productionTr => $Key){
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT FROM `trefilageconsommation` where `actif`=1 and `fichetrefilage`=$idFicheTrefilage ORDER BY `idfichetrefilage` DESC;";
            ...
            //** Debut select de la production (consommation)
                $sql = "SELECT FROM `trefilageproduction` where `actif`=1 and `fichetrefilage`=$idFicheTrefilage;";
