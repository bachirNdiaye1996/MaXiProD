...
/** Quart 1 */
    /** Cranteuse1 Q1 */
        ...
        foreach($productionTref as $productionTr => $Key){
            ...
            array_push($Prod, $consommationsC1Q1);

            //** Debut select de la production (consommation)
                $sql = "SELECT * FROM `trefilagerevision` where `actif`=1 and `idfichetrefilage`=$idFicheTrefilage ORDER BY `idtrefilageconsommation` DESC;";
