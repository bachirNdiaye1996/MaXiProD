                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($dresseuse['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsFicheTrefilage.php?idfichetrfilage=<?= $dresseuse['idfichetrefilage'] ?>&quart=<?= $dresseuse['quart'] ?>" class="link-offset-2 link-underline"><?php echo "TREF-".$dresseuse['idfichetrefilage']; ?></a>
                                                    </td>
