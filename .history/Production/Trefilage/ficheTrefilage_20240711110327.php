                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsFicheTrefilage.php?idfichetrfilage=<?= $trefilage['idfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>&idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>" class="link-offset-2 link-underline"><?php echo "TREF-".$trefilage['idfichetrefilage']; ?></a>
                                                    </td>
                                                    ...
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#CFFEDA"; ?><?php }?>;">
                                                        <?php if($trefilage['actifapprouvprod'] == 0 && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="javascript:void(0);" data-toggle="modal" data-target=".approuveProdRectifie<?= $i ?>" class="px-2" title="Demander l'autorisation de modifier ou de suprimer cette fiche au prêt du DSI <?php echo ' --> DRES-'.$trefilage['idfichetrefilage']; ?>">
                                                        ...
                                                        <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                            <a href="modifierFicheDresseuse.php?idsupfiche=<?= $trefilage['idfichetrefilage'] ?>&quart=<?= $trefilage['quart'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                        <?php }?>
                                                        <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
