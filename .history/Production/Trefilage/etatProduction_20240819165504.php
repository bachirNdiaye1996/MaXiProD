                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-1">
                            <img src="../../image/trefilet.jpg" class="img-fluid" alt="" style="border-radius: 50%; margin:20px;" width="200">
                        </div>
                    </div>
                    <!-- DataTales Example -->
                    <!-- Fade In Utility -->
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="background-color:#CFFEDA; text-align: center;" class="codeReception">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsEtatProduction.php?dateCreation=<?= $trefilage['dateCreation'] ?>" class="link-offset-2 link-underline"><?php echo "EtatProd-".$i; ?></a>
                                                    </td>
                                                    ...
                                                    <?php if($_SESSION['niveau'] == 'admin'){ ?>
                                                        <td style="background-color:#CFFEDA;">
                                                            ...
                                                            <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
                                                                <a href="modifierFicheCranteuse.php?idsupfiche=<?= $trefilage['idfichecranteuseq1'] ?>&idcranteuseq1=<?= $_GET['idcranteuseq1'] ?>&quart=<?= $_GET['quart'] ?>" title="Modifier la fiche"><i class="far fa-edit"></i></a>
                                                            <?php }?>
                                                            <?php if(($trefilage['accepteprodmodif'] == 1) && ($trefilage['actifapprouvprod'] == 1) && $_SESSION['niveau']=='chefquart'){ ?>
