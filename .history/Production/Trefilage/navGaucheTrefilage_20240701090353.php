    ...
    <?php if($_SESSION['niveau'] != 'pontbascule'){ ?>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilitiesDresseuse" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Les informations :</h6>
                    <a class="collapse-item" href="./ficheDresseuse.php">Fiches Productions</a>
                    <a class="collapse-item" href="./etatProduction.php">Etats Productions</a>
                    <a class="collapse-item" href="./historiqueDresseuse.php">Historiques</a>
                </div>
            </div>
        </li>
