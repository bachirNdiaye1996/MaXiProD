...
$idfichetrefilage = $_GET['dateCreation'];  // On recupére l'ID de la réception par get

/** Quart 1 */
    /** Cranteuse1 Q1 */
        //** Debut select de la production (Pour cranteuse 1)
            $sql = "SELECT * FROM `fichetrefilage` where `actif`=1 and `dateCreation`='$idfichecranteuseq1' and `machine`='cranteuse 1' and `quart`='1';";
