                                        ...
                                        <div class="row">
                                            <table class="table table-bordered mb-2 ml-3 mr-4 col-lg-3" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['diametre'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['dechet'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['piodstotal'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['diametre'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['dechet'] ?></td>
                                                            <td style="background-color:#4e73df ; color:white;"><?= $prodRevisionQ1['dechet'] ?></td>
