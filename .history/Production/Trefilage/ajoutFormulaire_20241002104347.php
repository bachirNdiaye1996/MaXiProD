<?php
    ...
    if($ProblemeCompteur != "erreurProblemeCompteur" && $ProblemeQuart != "erreurProblemeQuart" && $ProblemeFilMachine != "erreurProblemeFilMachine" && ($ProblemeFicheExist != "erreurProblemeFicheExist")){            
        ...
        // Consommations
            for ($i = 0; $i < count($_POST['numerofilmachine2']); $i++){ 
                $numerofinString = explode("/", htmlspecialchars($_POST['numerofilmachine'][$i]));
                ...
                if(isset($_POST['numerofilmachine1'][$i])){
                    ...
                    $insertUser=$db->prepare("UPDATE `trefilageconsommation` SET `numerofilmachine`=?, `poidstotal`=? where `idtrefilageconsommation`=?;");
                    $insertUser->execute(array($numerofilmachine,$poidstotalconsommation,$idtrefilageconsommation));
                }
                ...
                if(isset($_POST['numerofilmachine2'][$i])){
                    ...
                    if(isset($_POST['finirfm'][$i])){     
                        ...
                        VALUES (NULL, ?, ?, '1', ?, ?, ?);");
                        $insertUser->execute(array($numerofilmachine,$nombrerouleauxconsommation,$poidstotalconsommation,$idficheTrefilageMax,$diametre));
                                                                    ...
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            ...
                                                                            <div class="col-md-10" style="display:none" id="d1">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="" name="" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                        ...
                                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                                            ...
                                                            <tbody id="dynamicaddConsommations">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA;" id="d2">
                                                                            <select class="form-control" id="numerofilmachine2" name="numerofilmachine2[]"> 
                                                                            <option value="<?php echo $_POST['numerofilmachine'][$i] ?>" ><?php $numerofinString = explode("/", $_POST['numerofilmachine'][$i]); echo $numerofinString[0]; ?></option> 
                                                                            <?php
                                                                                    foreach($stockCranteuse as $stock){
                                                                                ?>   
                                                                                    <option id="numbobine" value="<?php echo $stock['numbobine'].'/'.$stock['epaisseur'].'/'.$stock['poidsdeclare']; ?>"> <?php echo $stock['numbobine']; ?></option>                                                                                     
