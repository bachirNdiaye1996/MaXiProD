                                                                    ...
                                                                    <tr class="rowClass">
                                                                        <td style="background-color:#CFFEDA" id="d2">
                                                                            ...
                                                                            <div class="col-md-10" style="display:none" id="d1">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="<?php echo $rowConsommation['numerofilmachine']; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="background-color:#CFFEDA;">
                                                                ...
                                                                ?>
                                                                    <tr class="rowClass">
                                                                        ...
                                                                        <td style="background-color:#CFFEDA;" style="display:none" id="d1">
                                                                            <div class="col-md-10">
                                                                                <div class="mb-1 text-start">
                                                                                    <input class="form-control" id="numerofilmachine1" type="number" step="0.01" value="<?php echo $_POST['numerofilmachine'][$i]; ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </td>   
                                                                        <td style="background-color:#CFFEDA;">
