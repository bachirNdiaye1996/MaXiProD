...
//** Debut select de la production
    $sql = "SELECT * FROM `receptionmachine` where `actif`=1 ORDER BY `idreceptionmachine` DESC";
    ...
    // On récupère les valeurs dans un tableau associatif
    $receptionMachine = $query->fetchAll();
                    ...
                    <div class="mt-5 mb-3 col-lg-12">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Liste des réceptions dans les sections cranteuse et dresseuse</h6>
                            </div>
                            <div class="row m-2">
