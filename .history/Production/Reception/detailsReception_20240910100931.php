                                                                    ...
                                                                    <div class="card-body">
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $$receptionmachinedetailsmachine['idreception'] ?>" name="idreceptionDemandeRectifier">
                                                                                    </div>
                                                                                </div> 
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $$receptionmachinedetailsmachine['idmatiere'] ?>" name="idmatiereDemandeRectifier">
                                                                                    </div>
                                                                                </div> 
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $$receptionmachinedetailsmachine['epaisseur'] ?>" name="epaisseur">
                                                                                    </div>
                                                                                </div>
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $$receptionmachinedetailsmachine['nbbobine'] ?>" name="nombrebobine">
                                                                                    </div>
                                                                                </div>
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $$receptionmachinedetailsmachine['lieutransfert'] ?>" name="lieutransfert">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
                                                            ...
                                                            $('.suprimerReception<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Suprimer la réception",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'supressionReception.php?idsupreceptionDetail=<?= $$receptionmachinedetailsmachine['idmatiere'] ?>&idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&epaisseur=<?= $$receptionmachinedetailsmachine['epaisseur'] ?>&nombrebobine=<?= $$receptionmachinedetailsmachine['nbbobine'] ?>&lieutransfert=<?= $$receptionmachinedetailsmachine['lieutransfert'] ?>',
                                                                                //data: str,
                                                            ...
                                                            $('.acceptereceptionmod<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Permettre la modification",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'approuveReception.php?idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&idmatiereDemandeAccepter=<?= $$receptionmachinedetailsmachine['idmatiere'] ?>&epaisseur=<?= $$receptionmachinedetailsmachine['epaisseur'] ?>&nombrebobine=<?= $$receptionmachinedetailsmachine['nbbobine'] ?>&lieutransfert=<?= $$receptionmachinedetailsmachine['lieutransfert'] ?>',
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
