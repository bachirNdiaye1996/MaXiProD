                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-6 text-start">
                                                    ...
                                                    <input class="form-control" type="number" name="numbobine" id="validationDefault01" value="<?php echo $row['numbobine'];?>" id="example-date-input4" placeholder="Taper le nombre de bobine" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
