...
//** Debut select de la production
    ...
    $Receptionmachinedetailsmachinedetailsmachinedetails = $query->fetchAll();
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                    $i=0;
                                                    foreach($Receptionmachinedetailsmachinedetailsmachinedetails as $receptionmachinedetailsmachinedetailsmachinedetails){
                                                        $i++;
                                                        //if($article['status'] == 'termine'){
                                                ?>
                                                    <tr>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information" title="Voir détails" class="link-offset-2 link-underline"><?php echo "REC-0".$receptionmachinedetailsmachinedetailsmachinedetails['idreception']."-BOB-0".$receptionmachinedetailsmachinedetailsmachinedetails['idreceptionmachinedetails'] ?></a>
                                                        </td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['epaisseur'] ?> </td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['poidsdeclare'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['poidspese'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['etatbobine'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['lieutransfert'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetailsmachinedetails['dateajout'] ?></td>
                                                        <td style="text-align: center;"> 
                                                            <?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 0 && $_SESSION['niveau']=='chefquart'){ ?>
                                                            ...
                                                            <?php }?>
                                                            <?php if($receptionmachinedetailsmachinedetailsmachinedetails['acceptereceptionmodif'] == 1 && $_SESSION['niveau']=='admin'){ ?>
                                                            ...
                                                            <?php }?>
                                                            <?php if(($receptionmachinedetailsmachinedetailsmachinedetails['acceptereceptionmodif'] == 0) && ($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1) && ($_SESSION['niveau']=='chefquart')){ ?>
                                                                <a href="modifierReception.php?idreception=<?= $_GET['idreception'] ?>&idmatiereModifSimp=<?= $receptionmachinedetailsmachinedetailsmachinedetails['idmatiere'] ?>&epaisseur=<?= $receptionmachinedetailsmachinedetailsmachinedetails['epaisseur'] ?>&lieutransfert=<?= $receptionmachinedetailsmachinedetailsmachinedetails['lieutransfert'] ?>" class="px-2" title="Modifier la réception">
                                                                <i class="far fa-edit"></i></a>
                                                            <?php }?>
                                                            <?php if(($receptionmachinedetailsmachinedetailsmachinedetails['acceptereceptionmodif'] == 0) && ($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 1) && ($_SESSION['niveau']=='pontbascule')){ ?>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachinedetails['idreception'] ?>" name="idreceptionDemandeRectifier">
                                                                                    </div>
                                                                                </div> 
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachinedetails['idmatiere'] ?>" name="idmatiereDemandeRectifier">
                                                                                    </div>
                                                                                </div> 
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachinedetails['epaisseur'] ?>" name="epaisseur">
                                                                                    </div>
                                                                                </div>
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachinedetails['nbbobine'] ?>" name="nombrebobine">
                                                                                    </div>
                                                                                </div>
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachinedetails['lieutransfert'] ?>" name="lieutransfert">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
                                                            ...
                                                            $('.suprimerReception<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Suprimer la réception",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'supressionReception.php?idsupreceptionDetail=<?= $receptionmachinedetailsmachinedetails['idmatiere'] ?>&idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&epaisseur=<?= $receptionmachinedetailsmachinedetails['epaisseur'] ?>&nombrebobine=<?= $receptionmachinedetailsmachinedetails['nbbobine'] ?>&lieutransfert=<?= $receptionmachinedetailsmachinedetails['lieutransfert'] ?>',
                                                                                //data: str,
                                                            ...
                                                            $('.acceptereceptionmod<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Permettre la modification",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'approuveReception.php?idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&idmatiereDemandeAccepter=<?= $receptionmachinedetailsmachinedetails['idmatiere'] ?>&epaisseur=<?= $receptionmachinedetailsmachinedetails['epaisseur'] ?>&nombrebobine=<?= $receptionmachinedetailsmachinedetails['nbbobine'] ?>&lieutransfert=<?= $receptionmachinedetailsmachinedetails['lieutransfert'] ?>',
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
                                                        ...
                                                        $('.approuverReception<?= $i ?>').click(function(e) {
                                                            ...
                                                            confirmButtonText: "Approuver la réception",
                                                                ...
                                                                if (result.isConfirmed) {                                                                                                                  
                                                                    $.ajax({
                                                                            type: "POST",
                                                                            url: 'approuveReception.php?idappreception=<?= $receptionmachinedetailsmachinedetails['idmatiere']?>',
                                                                            //data: str,
                                                                            success: function( response ) {
                                                                                Swal.fire({
                                                                                    text: 'Réception approuvée avec succes!',
