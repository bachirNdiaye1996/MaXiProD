...
if(isset($_POST['approuveReceptionRectifie'])){
    if(!empty($_POST['motifRectifier'])){
        ...
        $lieutransfert=htmlspecialchars($_POST['machinereception']);
        $motifRectifier=htmlspecialchars($_POST['motifRectifier']);

        //if($resultMatiereArrive){
            $sql1 = "UPDATE `receptionmachinedetails` set `actifapprouvreception`=1 where idreceptionmachinedetails=$idmatiereDemandeRectifier";
            $db->query($sql1);
    
            //Pour enlever la couleur rouge
            $sql1 = "UPDATE `receptionmachinedetails` set `acceptereceptionmodif`=1 where idreceptionmachinedetails=$idmatiereDemandeRectifier";
            $db->query($sql1);
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class=" invisible">
                                                                                    <div class="">
                                                                                        <input class="form-control" type="text" value="<?= $receptionmachinedetailsmachine['lieutransfert'] ?>" name="machinereception">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="invisible">
