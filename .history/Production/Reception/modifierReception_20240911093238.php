                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-6 mt-3 text-start">
                                                    <label class="form-label fw-bold" for="nom">Machine de réception</label>
                                                    <select class="form-control" name="lieutransfert" value="<?php echo $row['lieutransfert'];?>">
                                                        <option <?php if ( $row['lieutransfert']=='Machine Tréfilage') {echo "selected='selected'";} ?> >Metal1</option>
                                                        <option <?php if ( $row['lieutransfert']=='Machine Cranteuse') {echo "selected='selected'";} ?> >Niambour</option>
                                                    </select>                                                  
                                                </div>
                                            </div>
