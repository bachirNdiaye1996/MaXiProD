...
//** Debut select de la production
    ...
    $Receptionmachinedetailsmachinedetails = $query->fetchAll();
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information" title="Voir détails" class="link-offset-2 link-underline"><?php echo "REC-0".$receptionmachinedetailsmachinedetails['idreception']."-BOB-0".$receptionmachinedetailsmachinedetails['idreceptionmachinedetails'] ?></a>
                                                        </td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['epaisseur'] ?> </td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['poidsdeclare'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['poidspese'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['etatbobine'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['lieutransfert'] ?></td>
                                                        <td style="<?php if($receptionmachinedetailsmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>"><?= $receptionmachinedetailsmachinedetails['dateajout'] ?></td>
                                                        <td style="text-align: center;"> 
                                                            ...
                                                            <?php if(($receptionmachinedetails['acceptereceptionmodif'] == 0) && ($receptionmachinedetails['actifapprouvreception'] == 1) && ($_SESSION['niveau']=='pontbascule')){ ?>
                                                                <a href="modifierReception.php?idreception=<?= $_GET['idreception'] ?>&idmatiereModifSimp=<?= $receptionmachinedetails['idmatiere'] ?>&epaisseur=<?= $receptionmachinedetails['epaisseur'] ?>&lieutransfert=<?= $receptionmachinedetails['lieutransfert'] ?>" class="px-2" title="Modifier la réception">
