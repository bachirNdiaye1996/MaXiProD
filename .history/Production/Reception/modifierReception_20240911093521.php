                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="mb-6 mt-3 text-start">
                                                    ...
                                                    <input class="form-control" type="date" name="datereception" value="<?php echo $row['datereception'];?>" id="example-date-input4" placeholder="Taper le poids pesé">
                                                </div>
                                            </div> 
                                            <div class="col-md-6 ">
                                                <div class="mb-6 mt-3 text-start">
                                                    <label class="form-label fw-bold" for="nom">DF</label>
                                                    <input class="form-control" type="number" name="df" value="<?php echo $row['df'];?>" id="example-date-input4" placeholder="Taper le poids pesé">
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                                <div class="mb-6 mt-3 text-start">
