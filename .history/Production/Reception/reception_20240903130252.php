                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($trefilage['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="ficheTrefilage.php?idficheparquarttrefilage=<?= $trefilage['idficheparquarttrefilage'] ?>&dateCreation=<?= $trefilage['datecreation'] ?>" class="link-offset-2 link-underline"><?php echo "RECM-".$trefilage['idreceptionmachine']; ?></a>
                                                    </td>
