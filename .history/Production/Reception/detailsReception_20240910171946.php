                                                            ...
                                                            $('.suprimerReception<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Suprimer la réception",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'supressionReception.php?idsupreceptionDetail=<?= $receptionmachinedetailsmachine['idreceptionmachinedetails'] ?>&idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&epaisseur=<?= $receptionmachinedetailsmachine['epaisseur'] ?>',
                                                                                //data: str,
