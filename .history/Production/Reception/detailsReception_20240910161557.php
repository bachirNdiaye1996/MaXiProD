                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <!-- Pour le sweetAlert Suprimer transfert !-->
                                                    <script>
                                                        console.log("aprouveReception.php?idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&idmatiereDemandeAccepter=<?= $receptionmachinedetailsmachine['idreceptionmachinedetails'] ?>&epaisseur=<?= $receptionmachinedetailsmachine['epaisseur'] ?>&lieutransfert=<?= $receptionmachinedetailsmachine['lieutransfert'] ?>");
                                                        $(document).ready( function(){
                                                            $('.acceptereceptionmod<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Permettre la modification",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'aprouveReception.php?idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&idmatiereDemandeAccepter=<?= $receptionmachinedetailsmachine['idreceptionmachinedetails'] ?>&epaisseur=<?= $receptionmachinedetailsmachine['epaisseur'] ?>&lieutransfert=<?= $receptionmachinedetailsmachine['lieutransfert'] ?>',
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
