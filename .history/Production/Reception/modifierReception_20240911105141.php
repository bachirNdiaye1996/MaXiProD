...
//La partie de recupe de l'id et script pour modifier
    ...
    if($_SERVER["REQUEST_METHOD"]=='GET'){
        ...
        $sql = "select * from receptionmachinedetails where idreceptionmachinedetails=$id";
        $result = $db->query($sql);
        $row = $result->fetch();
        while(!$row){
            header("location: detailsReception.php?idreception=$_GET[idreception]");
        ...
        if(isset($_POST['modifierReception'])){
            ...
            $sql = "UPDATE `receptionmachinedetails` SET `poidspese` = '$poidspese', `numbobine` = '$numbobine', `etatbobine` = '$etatbobine', `datereception` = '$datereception', `df` = '$df', `epaisseur` = '$epaisseur',`lieutransfert` = '$lieutransfert',`poidsdeclare` = '$poidsdeclare'
            , `df` = '$df', `couleurhistorique` = '2', `actifapprouvreception`=0 WHERE `idreceptionmachinedetails` = ?;";
            //$result = $db->query($sql); 
            $sth = $db->prepare($sql);    
                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-6 text-start">
                                                    <label class="form-label fw-bold" for="nom">Numéro du FM</label>
                                                    <input class="form-control" type="number" name="numbobine" id="validationDefault01" value="<?php echo $row['numbobine'];?>" id="example-date-input4" placeholder="Taper le numéro du FM" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-6 mt-5 text-start">
                                                    ...
                                                    <select class="form-control" name="lieutransfert" value="<?php echo $row['lieutransfert'];?>">
                                                        <option <?php if ( $row['lieutransfert']=='Machine Tréfilage') {echo "selected='selected'";} ?> >Machine Tréfilage</option>
                                                        <option <?php if ( $row['lieutransfert']=='Machine Cranteuse') {echo "selected='selected'";} ?> >Machine Cranteuse</option>
                                                    </select>                                                  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="mb-6 mt-5 text-start">
                                                    ...
                                                    <input class="form-control" type="date" name="datereception" value="<?php echo $row['datereception'];?>" id="example-date-input4" placeholder="">
                                                </div>
                                            </div> 
                                            <div class="col-md-6 ">
                                                <div class="mb-6 mt-5 text-start">
                                                    <label class="form-label fw-bold" for="nom">DF</label>
                                                    <input class="form-control" type="number" name="df" value="<?php echo $row['df'];?>" id="example-date-input4" placeholder="Taper le DF">
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                                <div class="mb-6 mt-5 text-start">
