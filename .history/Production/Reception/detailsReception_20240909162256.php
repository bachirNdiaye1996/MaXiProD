                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="<?php if($receptionmachinedetails['actifapprouvreception'] == 1){ echo 'background-color:#D72708 ; color:white;';}else{echo 'background-color:#4e73df ; color:white;';}?>">
                                                            <a style="text-decoration: none; font-family: arial; font-size: 20px; color:white;" href="javascript:void(0);" data-toggle="modal" data-target="#Information" title="Voir détails" class="link-offset-2 link-underline"><?php echo "REC-0".$receptionmachinedetails['idreception']."-BOB-0".$receptionmachinedetails['receptionmachinedetails'] ?></a>
                                                        </td>
