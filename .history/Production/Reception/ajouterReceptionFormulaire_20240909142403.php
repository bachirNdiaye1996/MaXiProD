                       ...
                       /* //Rechercher le nombre de piéces sur le lieu d'arrive 
                        ...
                        /*if($resultMatiereArrive){
                            ...
                            // Ajouter le nombre de bobine dans le lieu de reception
                                $insertUser=$db->prepare("INSERT INTO `receptionmachinedetails` (`idreceptionmachinedetails`, `epaisseur`, `poidsdeclare`, `poidspese`, `dateajout`, `user`,`nbbobine`,`lieutransfert`, `idreception`, `etatbobine`,`nbbobineactuel`) 
