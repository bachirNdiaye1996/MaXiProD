                                                            ...
                                                            $('.acceptereceptionmod<?= $i ?>').click(function(e) {
                                                                ...
                                                                confirmButtonText: "Permettre la modification",
                                                                    ...
                                                                    if (result.isConfirmed) {                                                                                                                  
                                                                        $.ajax({
                                                                                type: "POST",
                                                                                url: 'approuveReception.php?idreceptionDemandeAccepter=<?= $_GET['idreception'] ?>&idmatiereDemandeAccepter=<?= $receptionmachinedetailsmachine['idreceptionmachinedetails'] ?>&epaisseur=<?= $receptionmachinedetailsmachine['epaisseur'] ?>&nombrebobine=<?= $receptionmachinedetailsmachine['nbbobine'] ?>&lieutransfert=<?= $receptionmachinedetailsmachine['lieutransfert'] ?>',
                                                                                //data: str,
                                                                                success: function( response ) {
                                                                                    Swal.fire({
