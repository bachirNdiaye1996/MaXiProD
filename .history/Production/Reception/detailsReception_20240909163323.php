                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;"> 
                                                            <?php if($receptionmachinedetailsmachinedetailsmachinedetails['actifapprouvreception'] == 0 && $_SESSION['niveau']=='pontbascule'){ ?>
                                        ...
                                        ?>
                                            <div class="col-md-8 align-items-center">
                                                <div class="d-flex gap-2 pt-4">
                                                    ...
                                                    ?>
                                                        <a href="ajouterReceptionFormulaire.php?idreception=<?= $_GET['idreceptionmachine'] ?>" class="btn btn-success w-lg bouton"><i class="fa fa-plus me-1"></i>Ajouter une reception</a>
                                                    <?php
                                                        }
                                                    ?>
