                                            ...
                                            ?>
                                                <tr>
                                                    <td style="<?php if($receptionmachine['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsReception.php?idreceptionmachine=<?= $receptionmachine['idreception'] ?>&dateCreation=<?= $receptionmachine['datecreation'] ?>" class="link-offset-2 link-underline"><?php echo "RECM-".$receptionmachine['idreceptionmachine']; ?></a>
                                                    </td>
