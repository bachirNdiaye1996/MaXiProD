                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                foreach($Receptionmachine as $receptionmachine){
                                                    $i++;
                                                    //if($article['status'] == 'termine'){<p><a class="" href="#">Underline opacity 0</a></p>
                                            ?>
                                                <tr>
                                                    <td style="<?php if($receptionmachine['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>; text-align: center;" class="">
                                                        <a style="text-decoration: none; font-family: arial; font-size: 20px;" href="detailsReception.php?idreceptionmachine=<?= $receptionmachine['idreceptionmachine'] ?>&dateCreation=<?= $receptionmachine['datecreation'] ?>" class="link-offset-2 link-underline"><?php echo "RECM-".$receptionmachine['idreceptionmachine']; ?></a>
                                                    </td>
                                                    <td style="<?php if($receptionmachine['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>;">
                                                        <?= $receptionmachine['nompeseur'] ?>
                                                    </td>
                                                    <td style="<?php if($receptionmachine['actifapprouvprod'] == 0){ echo "background-color:#CFFEDA"; ?> <?php }else{ echo "background-color:#FF5335"; ?><?php }?>;">
                                                        <?= $receptionmachine['dateCreation'] ?>
                                                    </td>
                                                </tr>
                                            <?php
                                                }
